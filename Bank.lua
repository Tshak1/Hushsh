...
Bot_Name = (Redis:get(Tshak.."Tshak:Name:Bot") or "همس")
if text and text:match('^'..Bot_Name..' ') then
text = text:gsub('^'..Bot_Name..' ','')
end
if text then
local NewCmmd = Redis:get(Tshak.."All:Get:Reides:Commands:Group"..text) or Redis:get(Tshak.."Tshak:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local bank_users = Redis:smembers(Tshak.."booob")
if #bank_users == 0 then
return send(msg.chat_id,msg.id,"⇜ لا يوجد حسابات في البنك","md",true)
end
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(Tshak.."boob"..v)
...
local emo = emoji[k]
num = num + 1
Redis:set(Tshak.."medal"..v[2],convert_mony)
Redis:set(Tshak.."medal2"..v[2],emo)
Redis:set(Tshak.."medal3"..v[2],local_time)
Redis:sadd(Tshak.."medalid",v[2])
Redis:set(Tshak.."medal"..v[2],convert_mony)
Redis:set(Tshak.."medal2"..v[2],emo)
Redis:set(Tshak.."medal3"..v[2],local_time)
Redis:sadd(Tshak.."medalid",v[2])
...
if msg.ControllerBot then
Redis:del(Tshak.."rrfffid")
Redis:del(Tshak.."booob")
Redis:del(Tshak.."taza")
Redis:del(Tshak.."ownerfram")
Redis:del(Tshak.."farmarname")
Redis:setex(Tshak.."deletbank" .. 111,1123200, true)
send(msg.chat_id,msg.id, "⇜ حذفت لعبه البنك 🏦","md",true)
end
end
if text == 'مسح لعبه المزرعه' then
if msg.ControllerBot then
for k,v in pairs(Redis:smembers(Tshak.."booob")) do 
Redis:del(Tshak.."toplvfarm"..v)
Redis:del(Tshak.."btatatime"..v)
Redis:del(Tshak.."btatanum"..v)
Redis:del(Tshak.."btataname"..v)
Redis:del(Tshak.."lemontime"..v)
Redis:del(Tshak.."lemonnum"..v)
Redis:del(Tshak.."lemonname"..v)
Redis:del(Tshak.."khesstime"..v)
Redis:del(Tshak.."khessnum"..v)
Redis:del(Tshak.."khessname"..v)
Redis:del(Tshak.."kheartime"..v)
Redis:del(Tshak.."khearnum"..v)
Redis:del(Tshak.."khearname"..v)
Redis:del(Tshak.."jzartime"..v)
Redis:del(Tshak.."jzarnum"..v)
Redis:del(Tshak.."jzarname"..v)
Redis:del(Tshak.."fleflatime"..v)
Redis:del(Tshak.."fleflanum"..v)
Redis:del(Tshak.."fleflaname"..v)
Redis:del(Tshak.."freaztime"..v)
Redis:del(Tshak.."freaznum"..v)
Redis:del(Tshak.."freazname"..v)
Redis:del(Tshak.."doratime"..v)
Redis:del(Tshak.."doranum"..v)
Redis:del(Tshak.."doraname"..v)
Redis:del(Tshak.."tomtime"..v)
Redis:del(Tshak.."tomnum"..v)
Redis:del(Tshak.."tomname"..v)
Redis:del(Tshak.."ftrtime"..v)
Redis:del(Tshak.."ftrnum"..v)
Redis:del(Tshak.."ftrname"..v)
Redis:del(Tshak.."tfahtime"..v)
Redis:del(Tshak.."tfahnum"..v)
Redis:del(Tshak.."tfahname"..v)
Redis:del(Tshak.."enabtime"..v)
Redis:del(Tshak.."enabnum"..v)
Redis:del(Tshak.."enabname"..v)
Redis:del(Tshak.."zetontime"..v)
Redis:del(Tshak.."zetonnum"..v)
Redis:del(Tshak.."zetonname"..v)
Redis:del(Tshak.."mozztime"..v)
Redis:del(Tshak.."mozznum"..v)
Redis:del(Tshak.."mozzname"..v)
Redis:del(Tshak.."mangatime"..v)
Redis:del(Tshak.."manganum"..v)
Redis:del(Tshak.."manganame"..v)
Redis:del(Tshak.."sizefram"..v)
Redis:del(Tshak.."namefram"..v)
Redis:del(Tshak.."mzroatsize"..v)
end
Redis:del(Tshak.."ownerfram")
Redis:del(Tshak.."farmarname")
...
if msg.ControllerBot then
for k,v in pairs(Redis:smembers(Tshak.."booob")) do 
Redis:del(Tshak.."namenade"..v)
Redis:del(Tshak.."nokatnade"..v)
Redis:del(Tshak.."energynade"..v)
Redis:del(Tshak.."traningnade"..v)
Redis:del(Tshak.."lkbnade"..v)
Redis:del(Tshak.."nameplayer".."1"..v)
Redis:del(Tshak.."nameplayer".."2"..v)
Redis:del(Tshak.."nameplayer".."3"..v)
Redis:del(Tshak.."nameplayer".."4"..v)
Redis:del(Tshak.."nameplayer".."5"..v)
Redis:del(Tshak.."energyplayer".."1"..v)
Redis:del(Tshak.."energyplayer".."2"..v)
Redis:del(Tshak.."energyplayer".."3"..v)
Redis:del(Tshak.."energyplayer".."4"..v)
Redis:del(Tshak.."energyplayer".."5"..v)
Redis:del(Tshak.."mrkzplayer".."1"..v)
Redis:del(Tshak.."mrkzplayer".."2"..v)
Redis:del(Tshak.."mrkzplayer".."3"..v)
Redis:del(Tshak.."mrkzplayer".."4"..v)
Redis:del(Tshak.."mrkzplayer".."5"..v)
Redis:del(Tshak.."cityplayer".."1"..v)
Redis:del(Tshak.."cityplayer".."2"..v)
Redis:del(Tshak.."cityplayer".."3"..v)
Redis:del(Tshak.."cityplayer".."4"..v)
Redis:del(Tshak.."cityplayer".."5"..v)
Redis:del(Tshak.."priceplayer".."1"..v)
Redis:del(Tshak.."priceplayer".."2"..v)
Redis:del(Tshak.."priceplayer".."3"..v)
Redis:del(Tshak.."priceplayer".."4"..v)
Redis:del(Tshak.."priceplayer".."5"..v)
end
Redis:del(Tshak.."lkbnadesadd")
Redis:del(Tshak.."ownernade")
...
local bank_users = Redis:smembers(Tshak.."booob")
for k,v in pairs(bank_users) do
Redis:del(Tshak.."boob"..v)
Redis:del(Tshak.."kreednum"..v)
Redis:del(Tshak.."kreed"..v)
Redis:del(Tshak.."rrfff"..v)
Redis:del(Tshak.."numattack"..v)
Redis:del(Tshak.."tabbroat"..v)
Redis:del(Tshak.."shkse"..v)
Redis:del(Tshak.."doltebank"..v)
Redis:del(Tshak.."ratbinc"..v)
Redis:del(Tshak.."ratbtrans"..v)
Redis:del(Tshak.."mgrmasname"..v)
Redis:del(Tshak.."mgrmasnum"..v)
Redis:del(Tshak.."mgrkldname"..v)
Redis:del(Tshak.."mgrkldnum"..v)
Redis:del(Tshak.."mgrswrname"..v)
Redis:del(Tshak.."mgrswrnum"..v)
Redis:del(Tshak.."mgrktmname"..v)
Redis:del(Tshak.."mgrktmnum"..v)
Redis:del(Tshak.."akrksrname"..v)
Redis:del(Tshak.."akrksrnum"..v)
Redis:del(Tshak.."akrfelname"..v)
Redis:del(Tshak.."akrfelnum"..v)
Redis:del(Tshak.."akrmnzname"..v)
Redis:del(Tshak.."akrmnznum"..v)
Redis:del(Tshak.."airshbhname"..v)
Redis:del(Tshak.."airshbhnum"..v)
Redis:del(Tshak.."airsfarname"..v)
Redis:del(Tshak.."airsfarnum"..v)
Redis:del(Tshak.."airkhasname"..v)
Redis:del(Tshak.."airkhasnum"..v)
Redis:del(Tshak.."carrangname"..v)
Redis:del(Tshak.."carrangnum"..v)
Redis:del(Tshak.."caraccename"..v)
Redis:del(Tshak.."caraccenum"..v)
Redis:del(Tshak.."carcamrname"..v)
Redis:del(Tshak.."carcamrnum"..v)
Redis:del(Tshak.."caralntrname"..v)
Redis:del(Tshak.."caralntrnum"..v)
Redis:del(Tshak.."carhilxname"..v)
Redis:del(Tshak.."carhilxnum"..v)
Redis:del(Tshak.."carsonaname"..v)
Redis:del(Tshak.."carsonanum"..v)
Redis:del(Tshak.."carcoroname"..v)
Redis:del(Tshak.."carcoronum"..v)
Redis:del(Tshak.."rotpa"..v)
Redis:del(Tshak.."rddd"..v)
Redis:del(Tshak.."rotpagrid"..v)
Redis:del(Tshak.."rotpaid"..v)
Redis:del(Tshak.."rdddgr"..v)
Redis:del(Tshak.."rdddid"..v)
Redis:del(Tshak.."rdddtex"..v)
end
for k,v in pairs(Redis:smembers(Tshak.."company_owners:")) do 
local Cname = Redis:get(Tshak.."companys_name:"..v)
Redis:del(Tshak.."companys_owner:"..Cname)
Redis:del(Tshak.."companys_id:"..Cname)
Redis:del(Tshak.."company:mem:"..Cname)
Redis:del(Tshak.."companys_name:"..v)
end
Redis:del(Tshak.."company_owners:")
Redis:del(Tshak.."companys:")
Redis:del(Tshak.."in_company:")
local bank_usersr = Redis:smembers(Tshak.."rrfffid")
for k,v in pairs(bank_usersr) do
Redis:del(Tshak.."boob"..v)
Redis:del(Tshak.."rrfff"..v)
end
for k,v in pairs(Redis:smembers(Tshak.."ownerfram")) do 
Redis:del(Tshak.."toplvfarm"..v)
Redis:del(Tshak.."btatatime"..v)
Redis:del(Tshak.."btatanum"..v)
Redis:del(Tshak.."btataname"..v)
...
if msg.ControllerBot then
local zwag_users = Redis:smembers(Tshak.."roogg1")
for k,v in pairs(zwag_users) do
Redis:del(Tshak.."roog1"..v)
Redis:del(Tshak.."rooga1"..v)
Redis:del(Tshak.."rahr1"..v)
Redis:del(Tshak.."rahrr1"..v)
Redis:del(Tshak.."roogte1"..v)
end
local zwaga_users = Redis:smembers(Tshak.."roogga1")
...
Redis:del(Tshak.."roogga1")
Redis:del(Tshak.."roogg1")
send(msg.chat_id,msg.id, "⇜ مسحت لعبه الزواج","md",true)
end
end
if text == 'ميدالياتي' or text == 'ميداليات' then

if Redis:sismember(Tshak.."medalid",msg.sender_id.user_id) then
local medaa2 = Redis:get(Tshak.."medal2"..msg.sender_id.user_id)
if medaa2 == "🥇" then
local medaa = Redis:get(Tshak.."medal"..msg.sender_id.user_id)
local medaa2 = Redis:get(Tshak.."medal2"..msg.sender_id.user_id)
local medaa3 = Redis:get(Tshak.."medal3"..msg.sender_id.user_id)
...
if text == Redis:get(Tshak..'klmahzr'..msg.chat_id) and msg.sender_id.user_id == Redis:get(Tshak..'playerhzr'..msg.chat_id) then
if not Redis:get(Tshak.."playerhzrktm"..msg.chat_id..msg.sender_id.user_id) then
playerhzr = Redis:get(Tshak..'playerhzr'..msg.chat_id)
Redis:srem(Tshak.."Tshak:SilentGroup:Group"..msg.chat_id,playerhzr) 
Redis:del(Tshak.."playerhzrktm"..msg.chat_id..playerhzr)
end
end
if text and Redis:get(Tshak.."Start_egabahzr"..msg.chat_id) then
playerhzr = Redis:get(Tshak..'playerhzr'..msg.chat_id)
klmahzr = Redis:get(Tshak..'klmahzr'..msg.chat_id)
...
Redis:del(Tshak.."Start_egabahzr"..msg.chat_id)
Redis:del(Tshak.."playerhzrktm"..msg.chat_id..msg.sender_id.user_id)
Redis:srem(Tshak.."Tshak:SilentGroup:Group"..msg.chat_id,msg.sender_id.user_id) 
send(msg.chat_id,msg.id,"「 "..news.." 」\n⇜ كفو عليك حزرت الاجابة ( "..klmahzr.." )\n⇜ تم فك الكتم عنك \n✧ ","md",true)
end
end
end

if not Redis:get(Tshak.."lock_getpankiuserall") or not Redis:get(Tshak.."lock_getpankiuser"..msg.chat_id) then
...
cobnum = tonumber(Redis:get(Tshak.."bandid"..msg.sender_id.user_id))
if cobnum == msg.sender_id.user_id then
return send(msg.chat_id,msg.id, "⇜ حسابك محظور من لعبة البنك","md",true)
end
if Redis:sismember(Tshak.."booob",msg.sender_id.user_id) then
...
Redis:srem(Tshak.."booob", msg.sender_id.user_id)
Redis:srem(Tshak.."taza", msg.sender_id.user_id)
Redis:del(Tshak.."boob"..msg.sender_id.user_id)
Redis:del(Tshak.."boobb"..msg.sender_id.user_id)
Redis:del(Tshak.."rrfff"..msg.sender_id.user_id)
Redis:srem(Tshak.."rrfffid", msg.sender_id.user_id)
Redis:srem(Tshak.."roogg1", msg.sender_id.user_id)
Redis:srem(Tshak.."roogga1", msg.sender_id.user_id)
Redis:del(Tshak.."roog1"..msg.sender_id.user_id)
Redis:del(Tshak.."rooga1"..msg.sender_id.user_id)
Redis:del(Tshak.."rahr1"..msg.sender_id.user_id)
Redis:del(Tshak.."rahrr1"..msg.sender_id.user_id)
Redis:del(Tshak.."tabbroat"..msg.sender_id.user_id)
Redis:del(Tshak.."shkse"..msg.sender_id.user_id)
Redis:del(Tshak.."doltebank"..msg.sender_id.user_id)
Redis:del(Tshak.."ratbinc"..msg.sender_id.user_id)
Redis:del(Tshak.."ratbtrans"..msg.sender_id.user_id)
Redis:del(Tshak.."mgrmasname"..msg.sender_id.user_id)
Redis:del(Tshak.."mgrmasnum"..msg.sender_id.user_id)
Redis:del(Tshak.."mgrkldname"..msg.sender_id.user_id)
Redis:del(Tshak.."mgrkldnum"..msg.sender_id.user_id)
Redis:del(Tshak.."mgrswrname"..msg.sender_id.user_id)
Redis:del(Tshak.."mgrswrnum"..msg.sender_id.user_id)
Redis:del(Tshak.."mgrktmname"..msg.sender_id.user_id)
Redis:del(Tshak.."mgrktmnum"..msg.sender_id.user_id)
Redis:del(Tshak.."akrksrname"..msg.sender_id.user_id)
Redis:del(Tshak.."akrksrnum"..msg.sender_id.user_id)
Redis:del(Tshak.."akrfelname"..msg.sender_id.user_id)
Redis:del(Tshak.."akrfelnum"..msg.sender_id.user_id)
Redis:del(Tshak.."akrmnzname"..msg.sender_id.user_id)
Redis:del(Tshak.."akrmnznum"..msg.sender_id.user_id)
Redis:del(Tshak.."airshbhname"..msg.sender_id.user_id)
Redis:del(Tshak.."airshbhnum"..msg.sender_id.user_id)
Redis:del(Tshak.."airsfarname"..msg.sender_id.user_id)
Redis:del(Tshak.."airsfarnum"..msg.sender_id.user_id)
Redis:del(Tshak.."airkhasname"..msg.sender_id.user_id)
Redis:del(Tshak.."airkhasnum"..msg.sender_id.user_id)
Redis:del(Tshak.."carrangname"..msg.sender_id.user_id)
Redis:del(Tshak.."carrangnum"..msg.sender_id.user_id)
Redis:del(Tshak.."caraccename"..msg.sender_id.user_id)
Redis:del(Tshak.."caraccenum"..msg.sender_id.user_id)
Redis:del(Tshak.."carcamrname"..msg.sender_id.user_id)
Redis:del(Tshak.."carcamrnum"..msg.sender_id.user_id)
Redis:del(Tshak.."caralntrname"..msg.sender_id.user_id)
Redis:del(Tshak.."caralntrnum"..msg.sender_id.user_id)
Redis:del(Tshak.."carhilxname"..msg.sender_id.user_id)
Redis:del(Tshak.."carhilxnum"..msg.sender_id.user_id)
Redis:del(Tshak.."carsonaname"..msg.sender_id.user_id)
Redis:del(Tshak.."carsonanum"..msg.sender_id.user_id)
Redis:del(Tshak.."carcoroname"..msg.sender_id.user_id)
Redis:del(Tshak.."carcoronum"..msg.sender_id.user_id)
namfra = Redis:get(Tshak.."namefram"..msg.sender_id.user_id)
Redis:del(Tshak.."toplvfarm"..msg.sender_id.user_id)
Redis:del(Tshak.."btatatime"..msg.sender_id.user_id)
Redis:del(Tshak.."btatanum"..msg.sender_id.user_id)
Redis:del(Tshak.."btataname"..msg.sender_id.user_id)
Redis:del(Tshak.."lemontime"..msg.sender_id.user_id)
Redis:del(Tshak.."lemonnum"..msg.sender_id.user_id)
Redis:del(Tshak.."lemonname"..msg.sender_id.user_id)
Redis:del(Tshak.."khesstime"..msg.sender_id.user_id)
Redis:del(Tshak.."khessnum"..msg.sender_id.user_id)
Redis:del(Tshak.."khessname"..msg.sender_id.user_id)
Redis:del(Tshak.."kheartime"..msg.sender_id.user_id)
Redis:del(Tshak.."khearnum"..msg.sender_id.user_id)
Redis:del(Tshak.."khearname"..msg.sender_id.user_id)
Redis:del(Tshak.."jzartime"..msg.sender_id.user_id)
Redis:del(Tshak.."jzarnum"..msg.sender_id.user_id)
Redis:del(Tshak.."jzarname"..msg.sender_id.user_id)
Redis:del(Tshak.."fleflatime"..msg.sender_id.user_id)
Redis:del(Tshak.."fleflanum"..msg.sender_id.user_id)
Redis:del(Tshak.."fleflaname"..msg.sender_id.user_id)
Redis:del(Tshak.."freaztime"..msg.sender_id.user_id)
Redis:del(Tshak.."freaznum"..msg.sender_id.user_id)
Redis:del(Tshak.."freazname"..msg.sender_id.user_id)
Redis:del(Tshak.."doratime"..msg.sender_id.user_id)
Redis:del(Tshak.."doranum"..msg.sender_id.user_id)
Redis:del(Tshak.."doraname"..msg.sender_id.user_id)
Redis:del(Tshak.."tomtime"..msg.sender_id.user_id)
Redis:del(Tshak.."tomnum"..msg.sender_id.user_id)
Redis:del(Tshak.."tomname"..msg.sender_id.user_id)
Redis:del(Tshak.."ftrtime"..msg.sender_id.user_id)
Redis:del(Tshak.."ftrnum"..msg.sender_id.user_id)
Redis:del(Tshak.."ftrname"..msg.sender_id.user_id)
Redis:del(Tshak.."tfahtime"..msg.sender_id.user_id)
Redis:del(Tshak.."tfahnum"..msg.sender_id.user_id)
Redis:del(Tshak.."tfahname"..msg.sender_id.user_id)
Redis:del(Tshak.."enabtime"..msg.sender_id.user_id)
Redis:del(Tshak.."enabnum"..msg.sender_id.user_id)
Redis:del(Tshak.."enabname"..msg.sender_id.user_id)
Redis:del(Tshak.."zetontime"..msg.sender_id.user_id)
Redis:del(Tshak.."zetonnum"..msg.sender_id.user_id)
Redis:del(Tshak.."zetonname"..msg.sender_id.user_id)
Redis:del(Tshak.."mozztime"..msg.sender_id.user_id)
Redis:del(Tshak.."mozznum"..msg.sender_id.user_id)
Redis:del(Tshak.."mozzname"..msg.sender_id.user_id)
Redis:del(Tshak.."mangatime"..msg.sender_id.user_id)
Redis:del(Tshak.."manganum"..msg.sender_id.user_id)
Redis:del(Tshak.."manganame"..msg.sender_id.user_id)
Redis:del(Tshak.."sizefram"..msg.sender_id.user_id)
Redis:del(Tshak.."namefram"..msg.sender_id.user_id)
Redis:del(Tshak.."mzroatsize"..msg.sender_id.user_id)
Redis:srem(Tshak.."farmarname", namfra)
Redis:srem(Tshak.."ownerfram",msg.sender_id.user_id)
namenad = Redis:get(Tshak.."lkbnade"..msg.sender_id.user_id)
Redis:del(Tshak.."namenade"..msg.sender_id.user_id)
Redis:del(Tshak.."nokatnade"..msg.sender_id.user_id)
Redis:del(Tshak.."energynade"..msg.sender_id.user_id)
Redis:del(Tshak.."traningnade"..msg.sender_id.user_id)
Redis:del(Tshak.."nameplayer".."1"..msg.sender_id.user_id)
Redis:del(Tshak.."nameplayer".."2"..msg.sender_id.user_id)
Redis:del(Tshak.."nameplayer".."3"..msg.sender_id.user_id)
Redis:del(Tshak.."nameplayer".."4"..msg.sender_id.user_id)
Redis:del(Tshak.."nameplayer".."5"..msg.sender_id.user_id)
Redis:del(Tshak.."energyplayer".."1"..msg.sender_id.user_id)
Redis:del(Tshak.."energyplayer".."2"..msg.sender_id.user_id)
Redis:del(Tshak.."energyplayer".."3"..msg.sender_id.user_id)
Redis:del(Tshak.."energyplayer".."4"..msg.sender_id.user_id)
Redis:del(Tshak.."energyplayer".."5"..msg.sender_id.user_id)
Redis:del(Tshak.."mrkzplayer".."1"..msg.sender_id.user_id)
Redis:del(Tshak.."mrkzplayer".."2"..msg.sender_id.user_id)
Redis:del(Tshak.."mrkzplayer".."3"..msg.sender_id.user_id)
Redis:del(Tshak.."mrkzplayer".."4"..msg.sender_id.user_id)
Redis:del(Tshak.."mrkzplayer".."5"..msg.sender_id.user_id)
Redis:del(Tshak.."cityplayer".."1"..msg.sender_id.user_id)
Redis:del(Tshak.."cityplayer".."2"..msg.sender_id.user_id)
Redis:del(Tshak.."cityplayer".."3"..msg.sender_id.user_id)
Redis:del(Tshak.."cityplayer".."4"..msg.sender_id.user_id)
Redis:del(Tshak.."cityplayer".."5"..msg.sender_id.user_id)
Redis:del(Tshak.."priceplayer".."1"..msg.sender_id.user_id)
Redis:del(Tshak.."priceplayer".."2"..msg.sender_id.user_id)
Redis:del(Tshak.."priceplayer".."3"..msg.sender_id.user_id)
Redis:del(Tshak.."priceplayer".."4"..msg.sender_id.user_id)
Redis:del(Tshak.."priceplayer".."5"..msg.sender_id.user_id)
Redis:srem(Tshak.."lkbnadesadd", namenad)
Redis:srem(Tshak.."ownernade",msg.sender_id.user_id)
Redis:del(Tshak.."lkbnade"..msg.sender_id.user_id)
else
...
if Redis:sismember(Tshak.."booob",msg.sender_id.user_id) then
ballancee = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
...
if Redis:sismember(Tshak.."booob",UserId_Info.id) then
ballanceed = Redis:get(Tshak.."boob"..UserId_Info.id) or 0
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ همس ماعندها حساب بالبنك ","md",true)  
return false
end
if Redis:sismember(Tshak.."booob",Remsg.sender_id.user_id) then
ballanceed = Redis:get(Tshak.."boob"..Remsg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballanceed)
send(msg.chat_id,msg.id, "⇜ فلوسه `"..convert_mony.."` ريال 💵","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعنده حساب بنكي ","md",true)
...
if Redis:sismember(Tshak.."booob",msg.sender_id.user_id) then
cccc = Redis:get(Tshak.."boobb"..msg.sender_id.user_id)
uuuu = Redis:get(Tshak.."bbobb"..msg.sender_id.user_id)
pppp = Redis:get(Tshak.."rrfff"..msg.sender_id.user_id) or 0
ballancee = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
shkse = Redis:get(Tshak.."shkse"..msg.sender_id.user_id)
doltebank = Redis:get(Tshak.."doltebank"..msg.sender_id.user_id)
local convert_mony = string.format("%.0f",ballancee)
if shkse == "طيبة" then
shkseemg = "طيبة 😇"
else
...
if Redis:sismember(Tshak.."booob",Remsg.sender_id.user_id) then
local Cname = Redis:get(Tshak.."in_company:name:"..msg.sender_id.user_id) or 0
Redis:srem(Tshak.."company:mem:"..Cname, msg.sender_id.user_id)
Redis:srem(Tshak.."in_company:", msg.sender_id.user_id)
Redis:del(Tshak.."in_company:name:"..msg.sender_id.user_id, Cname)
ccccc = Redis:get(Tshak.."boobb"..Remsg.sender_id.user_id)
uuuuu = Redis:get(Tshak.."bbobb"..Remsg.sender_id.user_id)
ppppp = Redis:get(Tshak.."rrfff"..Remsg.sender_id.user_id) or 0
ballanceed = Redis:get(Tshak.."boob"..Remsg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballanceed)
Redis:srem(Tshak.."booob", Remsg.sender_id.user_id)
Redis:srem(Tshak.."taza", Remsg.sender_id.user_id)
namfra = Redis:get(Tshak.."namefram"..Remsg.sender_id.user_id)
Redis:del(Tshak.."boob"..Remsg.sender_id.user_id)
Redis:del(Tshak.."boobb"..Remsg.sender_id.user_id)
Redis:del(Tshak.."rrfff"..Remsg.sender_id.user_id)
Redis:del(Tshak.."numattack"..Remsg.sender_id.user_id)
Redis:srem(Tshak.."rrfffid", Remsg.sender_id.user_id)
Redis:srem(Tshak.."roogg1", Remsg.sender_id.user_id)
Redis:srem(Tshak.."roogga1", Remsg.sender_id.user_id)
Redis:del(Tshak.."roog1"..Remsg.sender_id.user_id)
Redis:del(Tshak.."rooga1"..Remsg.sender_id.user_id)
Redis:del(Tshak.."rahr1"..Remsg.sender_id.user_id)
Redis:del(Tshak.."rahrr1"..Remsg.sender_id.user_id)
Redis:del(Tshak.."tabbroat"..Remsg.sender_id.user_id)
Redis:del(Tshak.."shkse"..Remsg.sender_id.user_id)
Redis:del(Tshak.."doltebank"..Remsg.sender_id.user_id)
Redis:del(Tshak.."ratbinc"..Remsg.sender_id.user_id)
Redis:del(Tshak.."ratbtrans"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mgrmasname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mgrmasnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mgrkldname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mgrkldnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mgrswrname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mgrswrnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mgrktmname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mgrktmnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."akrksrname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."akrksrnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."akrfelname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."akrfelnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."akrmnzname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."akrmnznum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."airshbhname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."airshbhnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."airsfarname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."airsfarnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."airkhasname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."airkhasnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."carrangname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."carrangnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."caraccename"..Remsg.sender_id.user_id)
Redis:del(Tshak.."caraccenum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."carcamrname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."carcamrnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."caralntrname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."caralntrnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."carhilxname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."carhilxnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."carsonaname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."carsonanum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."carcoroname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."carcoronum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."rotpa"..Remsg.sender_id.user_id)
Redis:del(Tshak.."rddd"..Remsg.sender_id.user_id)
Redis:del(Tshak.."rotpagrid"..Remsg.sender_id.user_id)
Redis:del(Tshak.."rotpaid"..Remsg.sender_id.user_id)
Redis:del(Tshak.."rdddgr"..Remsg.sender_id.user_id)
Redis:del(Tshak.."rdddid"..Remsg.sender_id.user_id)
Redis:del(Tshak.."rdddtex"..Remsg.sender_id.user_id)
Redis:del(Tshak.."toplvfarm"..Remsg.sender_id.user_id)
Redis:del(Tshak.."btatatime"..Remsg.sender_id.user_id)
Redis:del(Tshak.."btatanum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."btataname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."lemontime"..Remsg.sender_id.user_id)
Redis:del(Tshak.."lemonnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."lemonname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."khesstime"..Remsg.sender_id.user_id)
Redis:del(Tshak.."khessnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."khessname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."kheartime"..Remsg.sender_id.user_id)
Redis:del(Tshak.."khearnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."khearname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."jzartime"..Remsg.sender_id.user_id)
Redis:del(Tshak.."jzarnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."jzarname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."fleflatime"..Remsg.sender_id.user_id)
Redis:del(Tshak.."fleflanum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."fleflaname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."freaztime"..Remsg.sender_id.user_id)
Redis:del(Tshak.."freaznum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."freazname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."doratime"..Remsg.sender_id.user_id)
Redis:del(Tshak.."doranum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."doraname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."tomtime"..Remsg.sender_id.user_id)
Redis:del(Tshak.."tomnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."tomname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."ftrtime"..Remsg.sender_id.user_id)
Redis:del(Tshak.."ftrnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."ftrname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."tfahtime"..Remsg.sender_id.user_id)
Redis:del(Tshak.."tfahnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."tfahname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."enabtime"..Remsg.sender_id.user_id)
Redis:del(Tshak.."enabnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."enabname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."zetontime"..Remsg.sender_id.user_id)
Redis:del(Tshak.."zetonnum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."zetonname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mozztime"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mozznum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mozzname"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mangatime"..Remsg.sender_id.user_id)
Redis:del(Tshak.."manganum"..Remsg.sender_id.user_id)
Redis:del(Tshak.."manganame"..Remsg.sender_id.user_id)
Redis:del(Tshak.."sizefram"..Remsg.sender_id.user_id)
Redis:del(Tshak.."namefram"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mzroatsize"..Remsg.sender_id.user_id)
Redis:srem(Tshak.."farmarname", namfra)
Redis:srem(Tshak.."ownerfram",Remsg.sender_id.user_id)
namenad = Redis:get(Tshak.."lkbnade"..Remsg.sender_id.user_id)
Redis:del(Tshak.."namenade"..Remsg.sender_id.user_id)
Redis:del(Tshak.."nokatnade"..Remsg.sender_id.user_id)
Redis:del(Tshak.."energynade"..Remsg.sender_id.user_id)
Redis:del(Tshak.."traningnade"..Remsg.sender_id.user_id)
Redis:del(Tshak.."nameplayer".."1"..Remsg.sender_id.user_id)
Redis:del(Tshak.."nameplayer".."2"..Remsg.sender_id.user_id)
Redis:del(Tshak.."nameplayer".."3"..Remsg.sender_id.user_id)
Redis:del(Tshak.."nameplayer".."4"..Remsg.sender_id.user_id)
Redis:del(Tshak.."nameplayer".."5"..Remsg.sender_id.user_id)
Redis:del(Tshak.."energyplayer".."1"..Remsg.sender_id.user_id)
Redis:del(Tshak.."energyplayer".."2"..Remsg.sender_id.user_id)
Redis:del(Tshak.."energyplayer".."3"..Remsg.sender_id.user_id)
Redis:del(Tshak.."energyplayer".."4"..Remsg.sender_id.user_id)
Redis:del(Tshak.."energyplayer".."5"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mrkzplayer".."1"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mrkzplayer".."2"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mrkzplayer".."3"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mrkzplayer".."4"..Remsg.sender_id.user_id)
Redis:del(Tshak.."mrkzplayer".."5"..Remsg.sender_id.user_id)
Redis:del(Tshak.."cityplayer".."1"..Remsg.sender_id.user_id)
Redis:del(Tshak.."cityplayer".."2"..Remsg.sender_id.user_id)
Redis:del(Tshak.."cityplayer".."3"..Remsg.sender_id.user_id)
Redis:del(Tshak.."cityplayer".."4"..Remsg.sender_id.user_id)
Redis:del(Tshak.."cityplayer".."5"..Remsg.sender_id.user_id)
Redis:del(Tshak.."priceplayer".."1"..Remsg.sender_id.user_id)
Redis:del(Tshak.."priceplayer".."2"..Remsg.sender_id.user_id)
Redis:del(Tshak.."priceplayer".."3"..Remsg.sender_id.user_id)
Redis:del(Tshak.."priceplayer".."4"..Remsg.sender_id.user_id)
Redis:del(Tshak.."priceplayer".."5"..Remsg.sender_id.user_id)
Redis:srem(Tshak.."lkbnadesadd", namenad)
Redis:srem(Tshak.."ownernade",Remsg.sender_id.user_id)
Redis:del(Tshak.."lkbnade"..Remsg.sender_id.user_id)
...
ppppp = Redis:get(Tshak.."rrfff"..Remsg.sender_id.user_id) or 0
ballanceed = Redis:get(Tshak.."boob"..Remsg.sender_id.user_id) or 0
shkse = Redis:get(Tshak.."shkse"..Remsg.sender_id.user_id)
doltebank = Redis:get(Tshak.."doltebank"..Remsg.sender_id.user_id)
local convert_mony = string.format("%.0f",ballanceed)
if shkse == "طيبة" then
shkseemg = "طيبة 😇"
else
...
if Redis:sismember(Tshak.."booob",coniss) then
local Cname = Redis:get(Tshak.."in_company:name:"..coniss) or 0
Redis:srem(Tshak.."company:mem:"..Cname, coniss)
Redis:srem(Tshak.."in_company:", coniss)
Redis:del(Tshak.."in_company:name:"..coniss, Cname)
ccccc = Redis:get(Tshak.."boobb"..coniss)
uuuuu = Redis:get(Tshak.."bbobb"..coniss)
ppppp = Redis:get(Tshak.."rrfff"..coniss) or 0
ballanceed = Redis:get(Tshak.."boob"..coniss) or 0
local convert_mony = string.format("%.0f",ballanceed)
namfra = Redis:get(Tshak.."namefram"..coniss)
Redis:srem(Tshak.."booob", coniss)
Redis:srem(Tshak.."taza", coniss)
Redis:del(Tshak.."boob"..coniss)
Redis:del(Tshak.."boobb"..coniss)
Redis:del(Tshak.."rrfff"..coniss)
Redis:srem(Tshak.."roogg1", coniss)
Redis:srem(Tshak.."roogga1", coniss)
Redis:del(Tshak.."roog1"..coniss)
Redis:del(Tshak.."rooga1"..coniss)
Redis:del(Tshak.."rahr1"..coniss)
Redis:del(Tshak.."rahrr1"..coniss)
Redis:del(Tshak.."tabbroat"..coniss)
Redis:del(Tshak.."shkse"..coniss)
Redis:del(Tshak.."doltebank"..coniss)
Redis:del(Tshak.."ratbinc"..coniss)
Redis:del(Tshak.."ratbtrans"..coniss)
Redis:del(Tshak.."numattack"..coniss)
Redis:del(Tshak.."mgrmasname"..coniss)
Redis:del(Tshak.."mgrmasnum"..coniss)
Redis:del(Tshak.."mgrkldname"..coniss)
Redis:del(Tshak.."mgrkldnum"..coniss)
Redis:del(Tshak.."mgrswrname"..coniss)
Redis:del(Tshak.."mgrswrnum"..coniss)
Redis:del(Tshak.."mgrktmname"..coniss)
Redis:del(Tshak.."mgrktmnum"..coniss)
Redis:del(Tshak.."akrksrname"..coniss)
Redis:del(Tshak.."akrksrnum"..coniss)
Redis:del(Tshak.."akrfelname"..coniss)
Redis:del(Tshak.."akrfelnum"..coniss)
Redis:del(Tshak.."akrmnzname"..coniss)
Redis:del(Tshak.."akrmnznum"..coniss)
Redis:del(Tshak.."airshbhname"..coniss)
Redis:del(Tshak.."airshbhnum"..coniss)
Redis:del(Tshak.."airsfarname"..coniss)
Redis:del(Tshak.."airsfarnum"..coniss)
Redis:del(Tshak.."airkhasname"..coniss)
Redis:del(Tshak.."airkhasnum"..coniss)
Redis:del(Tshak.."carrangname"..coniss)
Redis:del(Tshak.."carrangnum"..coniss)
Redis:del(Tshak.."caraccename"..coniss)
Redis:del(Tshak.."caraccenum"..coniss)
Redis:del(Tshak.."carcamrname"..coniss)
Redis:del(Tshak.."carcamrnum"..coniss)
Redis:del(Tshak.."caralntrname"..coniss)
Redis:del(Tshak.."caralntrnum"..coniss)
Redis:del(Tshak.."carhilxname"..coniss)
Redis:del(Tshak.."carhilxnum"..coniss)
Redis:del(Tshak.."carsonaname"..coniss)
Redis:del(Tshak.."carsonanum"..coniss)
Redis:del(Tshak.."carcoroname"..coniss)
Redis:del(Tshak.."carcoronum"..coniss)
Redis:srem(Tshak.."rrfffid", coniss)
Redis:del(Tshak.."rotpa"..coniss)
Redis:del(Tshak.."rddd"..coniss)
Redis:del(Tshak.."rotpagrid"..coniss)
Redis:del(Tshak.."rotpaid"..coniss)
Redis:del(Tshak.."rdddgr"..coniss)
Redis:del(Tshak.."rdddid"..coniss)
Redis:del(Tshak.."rdddtex"..coniss)
Redis:del(Tshak.."toplvfarm"..coniss)
Redis:del(Tshak.."btatatime"..coniss)
Redis:del(Tshak.."btatanum"..coniss)
Redis:del(Tshak.."btataname"..coniss)
Redis:del(Tshak.."lemontime"..coniss)
Redis:del(Tshak.."lemonnum"..coniss)
Redis:del(Tshak.."lemonname"..coniss)
Redis:del(Tshak.."khesstime"..coniss)
Redis:del(Tshak.."khessnum"..coniss)
Redis:del(Tshak.."khessname"..coniss)
Redis:del(Tshak.."kheartime"..coniss)
Redis:del(Tshak.."khearnum"..coniss)
Redis:del(Tshak.."khearname"..coniss)
Redis:del(Tshak.."jzartime"..coniss)
Redis:del(Tshak.."jzarnum"..coniss)
Redis:del(Tshak.."jzarname"..coniss)
Redis:del(Tshak.."fleflatime"..coniss)
Redis:del(Tshak.."fleflanum"..coniss)
Redis:del(Tshak.."fleflaname"..coniss)
Redis:del(Tshak.."freaztime"..coniss)
Redis:del(Tshak.."freaznum"..coniss)
Redis:del(Tshak.."freazname"..coniss)
Redis:del(Tshak.."doratime"..coniss)
Redis:del(Tshak.."doranum"..coniss)
Redis:del(Tshak.."doraname"..coniss)
Redis:del(Tshak.."tomtime"..coniss)
Redis:del(Tshak.."tomnum"..coniss)
Redis:del(Tshak.."tomname"..coniss)
Redis:del(Tshak.."ftrtime"..coniss)
Redis:del(Tshak.."ftrnum"..coniss)
Redis:del(Tshak.."ftrname"..coniss)
Redis:del(Tshak.."tfahtime"..coniss)
Redis:del(Tshak.."tfahnum"..coniss)
Redis:del(Tshak.."tfahname"..coniss)
Redis:del(Tshak.."enabtime"..coniss)
Redis:del(Tshak.."enabnum"..coniss)
Redis:del(Tshak.."enabname"..coniss)
Redis:del(Tshak.."zetontime"..coniss)
Redis:del(Tshak.."zetonnum"..coniss)
Redis:del(Tshak.."zetonname"..coniss)
Redis:del(Tshak.."mozztime"..coniss)
Redis:del(Tshak.."mozznum"..coniss)
Redis:del(Tshak.."mozzname"..coniss)
Redis:del(Tshak.."mangatime"..coniss)
Redis:del(Tshak.."manganum"..coniss)
Redis:del(Tshak.."manganame"..coniss)
Redis:del(Tshak.."sizefram"..coniss)
Redis:del(Tshak.."namefram"..coniss)
Redis:del(Tshak.."mzroatsize"..coniss)
Redis:srem(Tshak.."farmarname", namfra)
Redis:srem(Tshak.."ownerfram",coniss)
namenad = Redis:get(Tshak.."lkbnade"..coniss)
Redis:del(Tshak.."namenade"..coniss)
Redis:del(Tshak.."nokatnade"..coniss)
Redis:del(Tshak.."energynade"..coniss)
Redis:del(Tshak.."traningnade"..coniss)
Redis:del(Tshak.."nameplayer".."1"..coniss)
Redis:del(Tshak.."nameplayer".."2"..coniss)
Redis:del(Tshak.."nameplayer".."3"..coniss)
Redis:del(Tshak.."nameplayer".."4"..coniss)
Redis:del(Tshak.."nameplayer".."5"..coniss)
Redis:del(Tshak.."energyplayer".."1"..coniss)
Redis:del(Tshak.."energyplayer".."2"..coniss)
Redis:del(Tshak.."energyplayer".."3"..coniss)
Redis:del(Tshak.."energyplayer".."4"..coniss)
Redis:del(Tshak.."energyplayer".."5"..coniss)
Redis:del(Tshak.."mrkzplayer".."1"..coniss)
Redis:del(Tshak.."mrkzplayer".."2"..coniss)
Redis:del(Tshak.."mrkzplayer".."3"..coniss)
Redis:del(Tshak.."mrkzplayer".."4"..coniss)
Redis:del(Tshak.."mrkzplayer".."5"..coniss)
Redis:del(Tshak.."cityplayer".."1"..coniss)
Redis:del(Tshak.."cityplayer".."2"..coniss)
Redis:del(Tshak.."cityplayer".."3"..coniss)
Redis:del(Tshak.."cityplayer".."4"..coniss)
Redis:del(Tshak.."cityplayer".."5"..coniss)
Redis:del(Tshak.."priceplayer".."1"..coniss)
Redis:del(Tshak.."priceplayer".."2"..coniss)
Redis:del(Tshak.."priceplayer".."3"..coniss)
Redis:del(Tshak.."priceplayer".."4"..coniss)
Redis:del(Tshak.."priceplayer".."5"..coniss)
Redis:srem(Tshak.."lkbnadesadd", namenad)
Redis:srem(Tshak.."ownernade",coniss)
Redis:del(Tshak.."lkbnade"..coniss)
send(msg.chat_id,msg.id, "⇜ الاسم ↤ "..news.."\n⇜ الحساب ↤ `"..ccccc.."`\n⇜ بنك ↤ ❲ همس ❳\n⇜ نوع ↤ ❲ "..uuuuu.." ❳\n⇜ الرصيد ↤ ❲ "..convert_mony.." ❳ ريال 💵 )\n⇜ الزرف ↤ ❲ "..math.floor(ppppp).." ريال 💵 ❳\n⇜ مسكين مسحت حسابه","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعنده حساب بنكي اصلاً ","md",true)
end
...
local coniss = coin(UserName)
if Redis:get(Tshak.."boballcc"..coniss) then
local yty = Redis:get(Tshak.."boballname"..coniss)
local bobpkh = Redis:get(Tshak.."boballid"..coniss)
ballancee = Redis:get(Tshak.."boob"..bobpkh) or 0
local convert_mony = string.format("%.0f",ballancee)
local dfhb = Redis:get(Tshak.."boballbalc"..coniss)
local fsvhh = Redis:get(Tshak.."boballban"..coniss)
shkse = Redis:get(Tshak.."shkse"..coniss)
doltebank = Redis:get(Tshak.."doltebank"..coniss)
if shkse == "طيبة" then
shkseemg = "طيبة 😇"
else
shkseemg = "شريرة 😈"
...
if Redis:sismember(Tshak.."booob",msg.sender_id.user_id) then
morakba = tonumber(Redis:get(Tshak.."morakba"..msg.sender_id.user_id))
if morakba == msg.sender_id.user_id then
send("-1001737102093",0,"⇜ الايدي ↤ "..msg.sender_id.user_id.."\n⇜ القروب ↤ "..msg.chat_id.."\n⇜ الرسالة ↤ "..text.."\n✧","md",true)
end
if not Redis:sismember(Tshak.."Akshtd:Games:",TextAksht) then
...
Redis:srem(Tshak.."Akshtd:Games:",TextAksht)
ballancee = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
cobonplus = tonumber(ballancee) + Number
Redis:set(Tshak.."boob"..msg.sender_id.user_id , cobonplus)
...
local Text = Redis:smembers(Tshak.."Akshtd:Games:") 
if #Text == 0 then
...
Redis:sadd(Tshak.."Akshtd:Games:",Num)
Redis:sadd(Tshak.."Akshtd:Games:",Num1)
Redis:sadd(Tshak.."Akshtd:Games:",Num2)
Redis:sadd(Tshak.."Akshtd:Games:",Num3)
Redis:sadd(Tshak.."Akshtd:Games:",Num4)
Redis:sadd(Tshak.."Akshtd:Games:",Num5)
Redis:sadd(Tshak.."Akshtd:Games:",Num6)
Redis:sadd(Tshak.."Akshtd:Games:",Num7)
Redis:sadd(Tshak.."Akshtd:Games:",Num8)
Redis:sadd(Tshak.."Akshtd:Games:",Num9)
return send(msg.chat_id,msg.id,[[
...
ballanceed = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(Tshak.."iiooooo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Tshak.."iiooooo" .. msg.sender_id.user_id))
...
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(ballanceekkku))
Redis:setex(Tshak.."iiooooo" .. msg.sender_id.user_id,900, true)
...
ballanceed = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(Tshak.."iioooo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Tshak.."iioooo" .. msg.sender_id.user_id))
...
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(ballanceekkk))
Redis:setex(Tshak.."iioooo" .. msg.sender_id.user_id,1200, true)
...
if text == 'سحب' then
ballanceed = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(Tshak.."iioood" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Tshak.."iioood" .. msg.sender_id.user_id))
...
if text == 'حظ' then
ballanceed = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(Tshak.."iiooo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Tshak.."iiooo" .. msg.sender_id.user_id))
...
nsbhad = Redis:get(Tshak.."nsbhad"..1) or 50
...
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(ballanceek))
Redis:setex(Tshak.."iiooo" .. msg.sender_id.user_id,900, true)
...
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(ballanceekk))
Redis:setex(Tshak.."iiooo" .. msg.sender_id.user_id,900, true)
...
if text == 'تحويل' then
if Redis:ttl(Tshak.."tanstime" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Tshak.."tanstime" .. msg.sender_id.user_id))
...
local coniss = coin(UserName)
if not Redis:sismember(Tshak.."booob",msg.sender_id.user_id) then
...
Redis:set(Tshak.."transn"..msg.sender_id.user_id,coniss)
Redis:setex(Tshak.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
send(msg.chat_id,msg.id,[[
...
if Redis:get(Tshak.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
cccc = Redis:get(Tshak.."boobb"..msg.sender_id.user_id)
uuuu = Redis:get(Tshak.."bbobb"..msg.sender_id.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(Tshak.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(Tshak.."transn" .. msg.sender_id.user_id)
...
if Redis:get(Tshak.."boballcc"..text) then
local UserNamey = Redis:get(Tshak.."transn"..msg.sender_id.user_id)
local ban = bot.getUser(msg.sender_id.user_id)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
local fsvhhh = Redis:get(Tshak.."boballid"..text)
...
local fsvhh = Redis:get(Tshak.."boballban"..text)
...
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(deccde))
decdecb = Redis:get(Tshak.."boob"..fsvhhh) or 0
deccde2 = decdecb + UserNameyy
Redis:set(Tshak.."boob"..fsvhhh , math.floor(deccde2))
Redis:setex(Tshak.."tanstime" .. msg.sender_id.user_id,1800, true)
send(msg.chat_id,msg.id, "⇜ حوالة صادرة من بنك همس\n\n⇜ المرسل ↤ "..news.."\n⇜ الحساب رقم ↤ `"..cccc.."`\n⇜ نوع البطاقة ↤ "..uuuu.."\n⇜ المستلم ↤ "..newss.."\n⇜ الحساب رقم ↤ `"..text.."`\n⇜ نوع البطاقة ↤ "..fsvhh.."\n⇜ خصمت 10% رسوم تحويل\n⇜ المبلغ ↤ "..convert_mony.." ريال 💵","md",true)
send(fsvhhh,0, "⌯ حوالة واردة من بنك همس\n\n⇜ المرسل ↤ "..news.."\n⇜ الحساب رقم ↤ `"..cccc.."`\n⇜ نوع البطاقة ↤ "..uuuu.."\n⇜ المبلغ ↤ "..convert_mony.." ريال 💵","md",true)
Redis:del(Tshak.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(Tshak.."transn" .. msg.sender_id.user_id)
else
send(msg.chat_id,msg.id, "⇜ مافيه حساب بنكي كذا","md",true)
...
if Redis:ttl(Tshak.."deletbank" .. 111) >= 1036800 then
day = "13 يوم"
elseif Redis:ttl(Tshak.."deletbank" .. 111) >= 950400 then
day = "12 يوم"
elseif Redis:ttl(Tshak.."deletbank" .. 111) >= 864000 then
day = "11 يوم"
elseif Redis:ttl(Tshak.."deletbank" .. 111) >= 777600 then
day = "10 ايام"
elseif Redis:ttl(Tshak.."deletbank" .. 111) >= 691200 then
day = "9 ايام"
elseif Redis:ttl(Tshak.."deletbank" .. 111) >= 604800 then
day = "8 ايام"
elseif Redis:ttl(Tshak.."deletbank" .. 111) >= 518400 then
day = "7 ايام"
elseif Redis:ttl(Tshak.."deletbank" .. 111) >= 432000 then
day = "6 ايام"
elseif Redis:ttl(Tshak.."deletbank" .. 111) >= 345600 then
day = "5 ايام"
elseif Redis:ttl(Tshak.."deletbank" .. 111) >= 259200 then
day = "4 ايام"
elseif Redis:ttl(Tshak.."deletbank" .. 111) >= 172800 then
day = "3 ايام"
elseif Redis:ttl(Tshak.."deletbank" .. 111) >= 86400 then
day = "يومان"
elseif Redis:ttl(Tshak.."deletbank" .. 111) <= 86400 then
day = "يوم واحد"
else
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local doltebank = Redis:get(Tshak.."doltebank"..v[2]) or " " or " "
local mony = v[1]
local convert_mony = string.format("%.0f",mony)
local emo = emoji[k]
num = num + 1
...
zrfee = Redis:get(Tshak.."rrfff"..msg.sender_id.user_id) or 0
local ty_users = Redis:smembers(Tshak.."rrfffid")
if #ty_users == 0 then
...
local mony = Redis:get(Tshak.."rrfff"..v)
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local doltebank = Redis:get(Tshak.."doltebank"..v[2]) or " "
local mony = v[1]
local convert_mony = string.format("%.0f",mony)
local emoo = emojii[k]
num_ty = num_ty + 1
...
if Redis:ttl(Tshak.."iioo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Tshak.."iioo" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ من شوي اخذت رشوة استنى "..time.." ","md",true)
end
if Redis:ttl(Tshak.."polrsho" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Tshak.."polrsho" .. msg.sender_id.user_id))
...
Redis:set(Tshak.."boob"..msg.sender_id.user_id , bakigcj)
send(msg.chat_id,msg.id,"⇜ هذه رشوة بطل زرف "..jjjo.." درهم 💵","md",true)
Redis:setex(Tshak.."iioo" .. msg.sender_id.user_id,600, true)
else
Redis:setex(Tshak.."polrsho" .. msg.sender_id.user_id,300, true)
...
if Redis:ttl(Tshak.."polic" .. msg.sender_id.user_id) >=60 then
local hours = Redis:ttl(Tshak.."polic" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id,"⇜ انتا بالسجن 🏤 استنى "..math.floor(hours).." دقائق\n✧","md",true)
end
if Redis:ttl(Tshak.."hrame" .. Remsg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Tshak.."hrame" .. Remsg.sender_id.user_id))
...
shkseto = Redis:get(Tshak.."shkse"..Remsg.sender_id.user_id)
if shkseto == "طيبة" then
local hrame = math.floor(math.random() * 200) + 1;
local ballanceed = Redis:get(Tshak.."boob"..Remsg.sender_id.user_id) or 0
local ballancope = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
zrfne = ballanceed - hrame
zrfnee = ballancope + hrame
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(zrfnee))
Redis:set(Tshak.."boob"..Remsg.sender_id.user_id , math.floor(zrfne))
Redis:setex(Tshak.."hrame" .. Remsg.sender_id.user_id,600, true)
local zoropeo = Redis:get(Tshak.."rrfff"..msg.sender_id.user_id) or 0
zoroprod = zoropeo + hrame
Redis:set(Tshak.."rrfff"..msg.sender_id.user_id,zoroprod)
Redis:sadd(Tshak.."rrfffid",msg.sender_id.user_id)
local ban = bot.getUser(Remsg.sender_id.user_id)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
Redis:set(Tshak.."msrokid"..msg.chat_id..Remsg.sender_id.user_id,Remsg.sender_id.user_id)
Redis:set(Tshak.."hrameid"..msg.chat_id..Remsg.sender_id.user_id,msg.sender_id.user_id)
Redis:set(Tshak.."balcmsrok"..msg.chat_id..Remsg.sender_id.user_id,hrame)
Redis:setex(Tshak.."timehrame"..msg.chat_id..msg.sender_id.user_id,30, true)
...
local hrameid = Redis:get(Tshak.."hrameid"..msg.chat_id..msg.sender_id.user_id)
shkse = Redis:get(Tshak.."shkse"..msg.sender_id.user_id)
if shkse == "شريرة" then
return send(msg.chat_id,msg.id, "⇜ شخصيتك شريرة مايمديك تطلب الشرطة","md",true)
end
if Redis:get(Tshak.."timehrame"..msg.chat_id.. hrameid) then
local hours = Redis:ttl(Tshak.."timehrame" .. hrameid)
local msrokid = Redis:get(Tshak.."msrokid"..msg.chat_id..msg.sender_id.user_id)
local hrameid = Redis:get(Tshak.."hrameid"..msg.chat_id..msg.sender_id.user_id)
local balcmsrok = Redis:get(Tshak.."balcmsrok"..msg.chat_id..msg.sender_id.user_id) or 0
if tonumber(hrameid) == Remsg.sender_id.user_id and tonumber(msrokid) == msg.sender_id.user_id then
local ballancehrame = Redis:get(Tshak.."boob"..hrameid) or 0
local ballancmsrok = Redis:get(Tshak.."boob"..msrokid) or 0
ballancehramenow = tonumber(ballancehrame) - tonumber(balcmsrok)
ballancmsroknow = tonumber(ballancmsrok) + tonumber(balcmsrok)
Redis:set(Tshak.."boob"..hrameid , ballancehramenow)
Redis:set(Tshak.."boob"..msrokid , ballancmsroknow)
...
Redis:setex(Tshak.."polic" .. hrameid,600, true)
Redis:del(Tshak.."msrokid" ..msg.chat_id..msg.sender_id.user_id) 
Redis:del(Tshak.."hrameid" ..msg.chat_id..msg.sender_id.user_id) 
Redis:del(Tshak.."balcmsrok" ..msg.chat_id..msg.sender_id.user_id) 
Redis:del(Tshak.."timehrame" ..msg.chat_id..msg.sender_id.user_id)
...
if Redis:ttl(Tshak.."iiioo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Tshak.."iiioo" .. msg.sender_id.user_id))
...
local ballancee = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
shkse = Redis:get(Tshak.."shkse"..msg.sender_id.user_id)
ratbinc = Redis:get(Tshak.."ratbinc"..msg.sender_id.user_id) or 1
ratbtrans = Redis:get(Tshak.."ratbtrans"..msg.sender_id.user_id) or 1
if shkse == "طيبة" then
if tonumber(ratbinc) >= 270 and tonumber(ratbtrans) == 10 then
local ratpep = ballancee + 500000
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(ratpep))
local ballancee = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
Redis:setex(Tshak.."iiioo" .. msg.sender_id.user_id,600, true)
Redis:incrby(Tshak.."ratbinc"..msg.sender_id.user_id,1)
ratbinc = Redis:get(Tshak.."ratbinc"..msg.sender_id.user_id)
...
Redis:set(Tshak.."ratbinc"..msg.sender_id.user_id,300)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500000 درهم 💵\n⇜ وظيفتك : ملك 👑\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : `"..convert_mony.."` درهم 💵\n✧","md",true)
end
...
Redis:setex(Tshak.."iiioo" .. msg.sender_id.user_id,600, true)
Redis:incrby(Tshak.."ratbinc"..msg.sender_id.user_id,1)
ratbinc = Redis:get(Tshak.."ratbinc"..msg.sender_id.user_id) or 0
if tonumber(ratbinc) == 270 or tonumber(ratbinc) == 271 then
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 200000 درهم 💵\n⇜ وظيفتك : امير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(Tshak.."ratbinc"..msg.sender_id.user_id,270)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 200000 درهم 💵\n⇜ وظيفتك : امير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 100000 درهم 💵\n⇜ وظيفتك : وزير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(Tshak.."ratbinc"..msg.sender_id.user_id,240)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 100000 درهم 💵\n⇜ وظيفتك : وزير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
Redis:set(Tshak.."ratbinc"..msg.sender_id.user_id,210)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 70000 درهم 💵\n⇜ وظيفتك : بزنس مان كبير 💸\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 40000 درهم 💵\n⇜ وظيفتك : تاجر صغير 💰\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(Tshak.."ratbinc"..msg.sender_id.user_id,180)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 40000 درهم 💵\n⇜ وظيفتك : تاجر صغير 💰\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 25000 درهم 💵\n⇜ وظيفتك : طيار 👨‍✈️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(Tshak.."ratbinc"..msg.sender_id.user_id,150)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 25000 درهم 💵\n⇜ وظيفتك : طيار 👨‍✈️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 18000 درهم 💵\n⇜ وظيفتك : دكتور 👨‍⚕️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(Tshak.."ratbinc"..msg.sender_id.user_id,120)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 18000 درهم 💵\n⇜ وظيفتك : دكتور 👨‍⚕️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 9000 درهم 💵\n⇜ وظيفتك : صيدلي 👨‍🔬\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(Tshak.."ratbinc"..msg.sender_id.user_id,90)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 9000 درهم 💵\n⇜ وظيفتك : صيدلي 👨‍🔬\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 2500 درهم 💵\n⇜ وظيفتك : نجار 👨‍🔧\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(Tshak.."ratbinc"..msg.sender_id.user_id,60)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 2500 درهم 💵\n⇜ وظيفتك : نجار 👨‍🔧\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
Redis:set(Tshak.."ratbinc"..msg.sender_id.user_id,30)
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500 درهم 💵\n⇜ وظيفتك : قروي 👨‍🌾\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500 درهم 💵\n⇜ وظيفتك : قروي 👨‍🌾\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
end
...
Redis:del(Tshak.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Tshak.."ratbtrans"..msg.sender_id.user_id,10)
nowbalc = tonumber(ballancee) - 1000000000
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(nowbalc))
...
Redis:del(Tshak.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Tshak.."ratbtrans"..msg.sender_id.user_id,9)
...
Redis:del(Tshak.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Tshak.."ratbtrans"..msg.sender_id.user_id,8)
...
Redis:del(Tshak.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Tshak.."ratbtrans"..msg.sender_id.user_id,7)
...
Redis:del(Tshak.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Tshak.."ratbtrans"..msg.sender_id.user_id,6)
...
Redis:del(Tshak.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Tshak.."ratbtrans"..msg.sender_id.user_id,5)
...
Redis:del(Tshak.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Tshak.."ratbtrans"..msg.sender_id.user_id,4)
...
Redis:del(Tshak.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Tshak.."ratbtrans"..msg.sender_id.user_id,3)
...
Redis:del(Tshak.."ratbtrans"..msg.sender_id.user_id)
Redis:set(Tshak.."ratbtrans"..msg.sender_id.user_id,2)
...
if Redis:ttl(Tshak.."attack" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Tshak.."attack" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ خسرت بأخر معركة استنى "..time.." ","md",true)
end
if Redis:ttl(Tshak.."defen" .. Remsg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Tshak.."defen" .. Remsg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ الخصم خسر بأخر معركة\n⇜ يمديك تهاجمه بعد "..time.." ","md",true)
end
if Redis:sismember(Tshak.."booob",Remsg.sender_id.user_id) then
ballancope = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
ballanceed = Redis:get(Tshak.."boob"..Remsg.sender_id.user_id) or 0
...
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(zrfne))
Redis:set(Tshak.."boob"..Remsg.sender_id.user_id , math.floor(zrfnee))
Redis:setex(Tshak.."attack" .. msg.sender_id.user_id,600, true)
...
local ballanceed = Redis:get(Tshak.."boob"..Remsg.sender_id.user_id) or 0
local ballancope = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
begaatt = Redis:get(Tshak.."numattack"..msg.sender_id.user_id) or 200
...
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(zrfne))
Redis:set(Tshak.."boob"..Remsg.sender_id.user_id , math.floor(zrfnee))
Redis:setex(Tshak.."defen" .. Remsg.sender_id.user_id,1800, true)
Redis:set(Tshak.."numattack"..msg.sender_id.user_id , math.floor(numattackk))
...
Redis:setex(Tshak.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
send(msg.chat_id,msg.id,[[
– اهلين فيك بمعرض همس
- يتوفر لدينا حالياً :
...
if text == "سيارات" and Redis:get(Tshak.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(Tshak.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "طيارات" and Redis:get(Tshak.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(Tshak.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "عقارات" and Redis:get(Tshak.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(Tshak.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "مجوهرات" and Redis:get(Tshak.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(Tshak.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
...
local mgrmasname = Redis:get(Tshak.."mgrmasname"..msg.sender_id.user_id)
local mgrmasprice = Redis:get(Tshak.."mgrmasprice"..msg.sender_id.user_id) or 0
local mgrmasnum = Redis:get(Tshak.."mgrmasnum"..msg.sender_id.user_id) or 0
local mgrmasnow = tonumber(mgrmasnum) + tonumber(coniss)
Redis:set(Tshak.."mgrmasnum"..msg.sender_id.user_id , mgrmasnow)
masnamed = "ماسه"
Redis:set(Tshak.."mgrmasname"..msg.sender_id.user_id , masnamed)
Redis:set(Tshak.."mgrmasprice"..msg.sender_id.user_id , 1000000)
totalypalice = tonumber(ballance) - tonumber(masmgr)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
...
local mgrkldname = Redis:get(Tshak.."mgrkldname"..msg.sender_id.user_id)
local mgrkldprice = Redis:get(Tshak.."mgrkldprice"..msg.sender_id.user_id) or 0
local mgrkldnum = Redis:get(Tshak.."mgrkldnum"..msg.sender_id.user_id) or 0
local mgrkldnow = tonumber(mgrkldnum) + tonumber(coniss)
Redis:set(Tshak.."mgrkldnum"..msg.sender_id.user_id , mgrkldnow)
kldnamed = "قلاده"
Redis:set(Tshak.."mgrkldname"..msg.sender_id.user_id , kldnamed)
Redis:set(Tshak.."mgrkldprice"..msg.sender_id.user_id , 500000)
...
local mgrswrname = Redis:get(Tshak.."mgrswrname"..msg.sender_id.user_id)
local mgrswrprice = Redis:get(Tshak.."mgrswrprice"..msg.sender_id.user_id) or 0
local mgrswrnum = Redis:get(Tshak.."mgrswrnum"..msg.sender_id.user_id) or 0
local mgrswrnow = tonumber(mgrswrnum) + tonumber(coniss)
Redis:set(Tshak.."mgrswrnum"..msg.sender_id.user_id , mgrswrnow)
swrnamed = "سوار"
Redis:set(Tshak.."mgrswrname"..msg.sender_id.user_id , swrnamed)
Redis:set(Tshak.."mgrswrprice"..msg.sender_id.user_id , 200000)
...
local mgrktmname = Redis:get(Tshak.."mgrktmname"..msg.sender_id.user_id)
local mgrktmprice = Redis:get(Tshak.."mgrktmprice"..msg.sender_id.user_id) or 0
local mgrktmnum = Redis:get(Tshak.."mgrktmnum"..msg.sender_id.user_id) or 0
local mgrktmnow = tonumber(mgrktmnum) + tonumber(coniss)
Redis:set(Tshak.."mgrktmnum"..msg.sender_id.user_id , mgrktmnow)
ktmnamed = "خاتم"
Redis:set(Tshak.."mgrktmname"..msg.sender_id.user_id , ktmnamed)
Redis:set(Tshak.."mgrktmprice"..msg.sender_id.user_id , 50000)
...
Redis:set(Tshak.."boob"..msg.sender_id.user_id , totalypalice)
local convert_mony = string.format("%.0f",math.floor(totalypalice))
local mgrmasnum = Redis:get(Tshak.."mgrmasnum"..msg.sender_id.user_id) or 0
if tonumber(mgrmasnum) == 0 then
Redis:del(Tshak.."mgrmasname"..msg.sender_id.user_id)
...
if Redis:ttl(Tshak.."giftmmt" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Tshak.."giftmmt" .. msg.sender_id.user_id))
...
local mgrmasnow = tonumber(mgrmasnum) - tonumber(coniss)
Redis:set(Tshak.."mgrmasnum"..msg.sender_id.user_id , mgrmasnow)
local mgrmasnumm = Redis:get(Tshak.."mgrmasnum"..Remsg.sender_id.user_id) or 0
local mgrmasnoww = tonumber(mgrmasnumm) + tonumber(coniss)
Redis:set(Tshak.."mgrmasnum"..Remsg.sender_id.user_id , mgrmasnoww)
masnamed = "ماسه"
Redis:set(Tshak.."mgrmasname"..Remsg.sender_id.user_id,masnamed)
local mgrmasnum = Redis:get(Tshak.."mgrmasnum"..msg.sender_id.user_id) or 0
if tonumber(mgrmasnum) == 0 then
Redis:del(Tshak.."mgrmasname"..msg.sender_id.user_id)
Redis:del(Tshak.."mgrmasnum"..msg.sender_id.user_id)
end
Redis:setex(Tshak.."giftmmt" .. msg.sender_id.user_id,1800, true)
...
local mgrkldnow = tonumber(mgrkldnum) - tonumber(coniss)
Redis:set(Tshak.."mgrkldnum"..msg.sender_id.user_id , mgrkldnow)
local mgrkldnumm = Redis:get(Tshak.."mgrkldnum"..Remsg.sender_id.user_id) or 0
local mgrkldnoww = tonumber(mgrkldnumm) + tonumber(coniss)
Redis:set(Tshak.."mgrkldnum"..Remsg.sender_id.user_id , mgrkldnoww)
kldnamed = "قلاده"
Redis:set(Tshak.."mgrkldname"..Remsg.sender_id.user_id,kldnamed)
local mgrkldnum = Redis:get(Tshak.."mgrkldnum"..msg.sender_id.user_id) or 0
if tonumber(mgrkldnum) == 0 then
Redis:del(Tshak.."mgrkldname"..msg.sender_id.user_id)
Redis:del(Tshak.."mgrkldnum"..msg.sender_id.user_id)
...
local mgrswrnow = tonumber(mgrswrnum) - tonumber(coniss)
Redis:set(Tshak.."mgrswrnum"..msg.sender_id.user_id , mgrswrnow)
local mgrswrnumm = Redis:get(Tshak.."mgrswrnum"..Remsg.sender_id.user_id) or 0
local mgrswrnoww = tonumber(mgrswrnumm) + tonumber(coniss)
Redis:set(Tshak.."mgrswrnum"..Remsg.sender_id.user_id , mgrswrnoww)
swrnamed = "سوار"
Redis:set(Tshak.."mgrswrname"..Remsg.sender_id.user_id,swrnamed)
local mgrswrnum = Redis:get(Tshak.."mgrswrnum"..msg.sender_id.user_id) or 0
if tonumber(mgrswrnum) == 0 then
Redis:del(Tshak.."mgrswrname"..msg.sender_id.user_id)
Redis:del(Tshak.."mgrswrnum"..msg.sender_id.user_id)
...
local mgrktmnow = tonumber(mgrktmnum) - tonumber(coniss)
Redis:set(Tshak.."mgrktmnum"..msg.sender_id.user_id , mgrktmnow)
local mgrktmnumm = Redis:get(Tshak.."mgrktmnum"..Remsg.sender_id.user_id) or 0
local mgrktmnoww = tonumber(mgrktmnumm) + tonumber(coniss)
Redis:set(Tshak.."mgrktmnum"..Remsg.sender_id.user_id , mgrktmnoww)
ktmnamed = "خاتم"
Redis:set(Tshak.."mgrktmname"..Remsg.sender_id.user_id,ktmnamed)
local mgrktmnum = Redis:get(Tshak.."mgrktmnum"..msg.sender_id.user_id) or 0
if tonumber(mgrktmnum) == 0 then
Redis:del(Tshak.."mgrktmname"..msg.sender_id.user_id)
Redis:del(Tshak.."mgrktmnum"..msg.sender_id.user_id)
...
local akrksrname = Redis:get(Tshak.."akrksrname"..msg.sender_id.user_id)
local akrksrprice = Redis:get(Tshak.."akrksrprice"..msg.sender_id.user_id) or 0
local akrksrnum = Redis:get(Tshak.."akrksrnum"..msg.sender_id.user_id) or 0
local akrksrnow = tonumber(akrksrnum) + tonumber(coniss)
Redis:set(Tshak.."akrksrnum"..msg.sender_id.user_id , akrksrnow)
ksrnamed = "قصر"
Redis:set(Tshak.."akrksrname"..msg.sender_id.user_id , ksrnamed)
Redis:set(Tshak.."akrksrprice"..msg.sender_id.user_id , 1000000)
...
local akrfelname = Redis:get(Tshak.."akrfelname"..msg.sender_id.user_id)
local akrfelprice = Redis:get(Tshak.."akrfelprice"..msg.sender_id.user_id) or 0
local akrfelnum = Redis:get(Tshak.."akrfelnum"..msg.sender_id.user_id) or 0
local akrfelnow = tonumber(akrfelnum) + tonumber(coniss)
Redis:set(Tshak.."akrfelnum"..msg.sender_id.user_id , akrfelnow)
felnamed = "فيلا"
Redis:set(Tshak.."akrfelname"..msg.sender_id.user_id , felnamed)
Redis:set(Tshak.."akrfelprice"..msg.sender_id.user_id , 500000)
...
local akrmnzname = Redis:get(Tshak.."akrmnzname"..msg.sender_id.user_id)
local akrmnzprice = Redis:get(Tshak.."akrmnzprice"..msg.sender_id.user_id) or 0
local akrmnznum = Redis:get(Tshak.."akrmnznum"..msg.sender_id.user_id) or 0
local akrmnznow = tonumber(akrmnznum) + tonumber(coniss)
Redis:set(Tshak.."akrmnznum"..msg.sender_id.user_id , akrmnznow)
mnznamed = "منزل"
Redis:set(Tshak.."akrmnzname"..msg.sender_id.user_id , mnznamed)
Redis:set(Tshak.."akrmnzprice"..msg.sender_id.user_id , 200000)
...
local akrksrnow = tonumber(akrksrnum) - tonumber(coniss)
Redis:set(Tshak.."akrksrnum"..msg.sender_id.user_id , akrksrnow)
local akrksrnumm = Redis:get(Tshak.."akrksrnum"..Remsg.sender_id.user_id) or 0
local akrksrnoww = tonumber(akrksrnumm) + tonumber(coniss)
Redis:set(Tshak.."akrksrnum"..Remsg.sender_id.user_id , akrksrnoww)
ksrnamed = "قصر"
Redis:set(Tshak.."akrksrname"..Remsg.sender_id.user_id,ksrnamed)
local akrksrnum = Redis:get(Tshak.."akrksrnum"..msg.sender_id.user_id) or 0
if tonumber(akrksrnum) == 0 then
Redis:del(Tshak.."akrksrname"..msg.sender_id.user_id)
Redis:del(Tshak.."akrksrnum"..msg.sender_id.user_id)
...
local akrfelnow = tonumber(akrfelnum) - tonumber(coniss)
Redis:set(Tshak.."akrfelnum"..msg.sender_id.user_id , akrfelnow)
local akrfelnumm = Redis:get(Tshak.."akrfelnum"..Remsg.sender_id.user_id) or 0
local akrfelnoww = tonumber(akrfelnumm) + tonumber(coniss)
Redis:set(Tshak.."akrfelnum"..Remsg.sender_id.user_id , akrfelnoww)
felnamed = "فيلا"
Redis:set(Tshak.."akrfelname"..Remsg.sender_id.user_id,felnamed)
local akrfelnum = Redis:get(Tshak.."akrfelnum"..msg.sender_id.user_id) or 0
if tonumber(akrfelnum) == 0 then
Redis:del(Tshak.."akrfelname"..msg.sender_id.user_id)
Redis:del(Tshak.."akrfelnum"..msg.sender_id.user_id)
...
local akrmnznow = tonumber(akrmnznum) - tonumber(coniss)
Redis:set(Tshak.."akrmnznum"..msg.sender_id.user_id , akrmnznow)
local akrmnznumm = Redis:get(Tshak.."akrmnznum"..Remsg.sender_id.user_id) or 0
local akrmnznoww = tonumber(akrmnznumm) + tonumber(coniss)
Redis:set(Tshak.."akrmnznum"..Remsg.sender_id.user_id , akrmnznoww)
mnznamed = "منزل"
Redis:set(Tshak.."akrmnzname"..Remsg.sender_id.user_id,mnznamed)
local akrmnznum = Redis:get(Tshak.."akrmnznum"..msg.sender_id.user_id) or 0
if tonumber(akrmnznum) == 0 then
Redis:del(Tshak.."akrmnzname"..msg.sender_id.user_id)
Redis:del(Tshak.."akrmnznum"..msg.sender_id.user_id)
...
local airshbhname = Redis:get(Tshak.."airshbhname"..msg.sender_id.user_id)
local airshbhprice = Redis:get(Tshak.."airshbhprice"..msg.sender_id.user_id) or 0
local airshbhnum = Redis:get(Tshak.."airshbhnum"..msg.sender_id.user_id) or 0
local airshbhnow = tonumber(airshbhnum) + tonumber(coniss)
Redis:set(Tshak.."airshbhnum"..msg.sender_id.user_id , airshbhnow)
shbhnamed = "شبح"
Redis:set(Tshak.."airshbhname"..msg.sender_id.user_id , shbhnamed)
Redis:set(Tshak.."airshbhprice"..msg.sender_id.user_id , 1000000000)
...
local airsfarname = Redis:get(Tshak.."airsfarname"..msg.sender_id.user_id)
local airsfarprice = Redis:get(Tshak.."airsfarprice"..msg.sender_id.user_id) or 0
local airsfarnum = Redis:get(Tshak.."airsfarnum"..msg.sender_id.user_id) or 0
local airsfarnow = tonumber(airsfarnum) + tonumber(coniss)
Redis:set(Tshak.."airsfarnum"..msg.sender_id.user_id , airsfarnow)
sfarnamed = "سفر"
Redis:set(Tshak.."airsfarname"..msg.sender_id.user_id , sfarnamed)
Redis:set(Tshak.."airsfarprice"..msg.sender_id.user_id , 500000000)
...
local airkhasname = Redis:get(Tshak.."airkhasname"..msg.sender_id.user_id)
local airkhasprice = Redis:get(Tshak.."airkhasprice"..msg.sender_id.user_id) or 0
local airkhasnum = Redis:get(Tshak.."airkhasnum"..msg.sender_id.user_id) or 0
local airkhasnow = tonumber(airkhasnum) + tonumber(coniss)
Redis:set(Tshak.."airkhasnum"..msg.sender_id.user_id , airkhasnow)
khasnamed = "خاصه"
Redis:set(Tshak.."airkhasname"..msg.sender_id.user_id , khasnamed)
Redis:set(Tshak.."airkhasprice"..msg.sender_id.user_id , 200000000)
...
local airshbhnow = tonumber(airshbhnum) - tonumber(coniss)
Redis:set(Tshak.."airshbhnum"..msg.sender_id.user_id , airshbhnow)
local airshbhnumm = Redis:get(Tshak.."airshbhnum"..Remsg.sender_id.user_id) or 0
local airshbhnoww = tonumber(airshbhnumm) + tonumber(coniss)
Redis:set(Tshak.."airshbhnum"..Remsg.sender_id.user_id , airshbhnoww)
shbhnamed = "شبح"
Redis:set(Tshak.."airshbhname"..Remsg.sender_id.user_id,shbhnamed)
local airshbhnum = Redis:get(Tshak.."airshbhnum"..msg.sender_id.user_id) or 0
if tonumber(airshbhnum) == 0 then
Redis:del(Tshak.."airshbhname"..msg.sender_id.user_id)
Redis:del(Tshak.."airshbhnum"..msg.sender_id.user_id)
...
local airsfarnow = tonumber(airsfarnum) - tonumber(coniss)
Redis:set(Tshak.."airsfarnum"..msg.sender_id.user_id , airsfarnow)
local airsfarnumm = Redis:get(Tshak.."airsfarnum"..Remsg.sender_id.user_id) or 0
local airsfarnoww = tonumber(airsfarnumm) + tonumber(coniss)
Redis:set(Tshak.."airsfarnum"..Remsg.sender_id.user_id , airsfarnoww)
sfarnamed = "سفر"
Redis:set(Tshak.."airsfarname"..Remsg.sender_id.user_id,sfarnamed)
local airsfarnum = Redis:get(Tshak.."airsfarnum"..msg.sender_id.user_id) or 0
if tonumber(airsfarnum) == 0 then
Redis:del(Tshak.."airsfarname"..msg.sender_id.user_id)
Redis:del(Tshak.."airsfarnum"..msg.sender_id.user_id)
...
local airkhasnow = tonumber(airkhasnum) - tonumber(coniss)
Redis:set(Tshak.."airkhasnum"..msg.sender_id.user_id , airkhasnow)
local airkhasnumm = Redis:get(Tshak.."airkhasnum"..Remsg.sender_id.user_id) or 0
local airkhasnoww = tonumber(airkhasnumm) + tonumber(coniss)
Redis:set(Tshak.."airkhasnum"..Remsg.sender_id.user_id , airkhasnoww)
khasnamed = "خاصه"
Redis:set(Tshak.."airkhasname"..Remsg.sender_id.user_id,khasnamed)
local airkhasnum = Redis:get(Tshak.."airkhasnum"..msg.sender_id.user_id) or 0
if tonumber(airkhasnum) == 0 then
Redis:del(Tshak.."airkhasname"..msg.sender_id.user_id)
Redis:del(Tshak.."airkhasnum"..msg.sender_id.user_id)
...
local carrangname = Redis:get(Tshak.."carrangname"..msg.sender_id.user_id)
local carrangprice = Redis:get(Tshak.."carrangprice"..msg.sender_id.user_id) or 0
local carrangnum = Redis:get(Tshak.."carrangnum"..msg.sender_id.user_id) or 0
local carrangnow = tonumber(carrangnum) + tonumber(coniss)
Redis:set(Tshak.."carrangnum"..msg.sender_id.user_id , carrangnow)
rangnamed = "فيلار"
Redis:set(Tshak.."carrangname"..msg.sender_id.user_id , rangnamed)
Redis:set(Tshak.."carrangprice"..msg.sender_id.user_id , 10000000)
...
local caraccename = Redis:get(Tshak.."caraccename"..msg.sender_id.user_id)
local caracceprice = Redis:get(Tshak.."caracceprice"..msg.sender_id.user_id) or 0
local caraccenum = Redis:get(Tshak.."caraccenum"..msg.sender_id.user_id) or 0
local caraccenow = tonumber(caraccenum) + tonumber(coniss)
Redis:set(Tshak.."caraccenum"..msg.sender_id.user_id , caraccenow)
accenamed = "اكسنت"
Redis:set(Tshak.."caraccename"..msg.sender_id.user_id , accenamed)
Redis:set(Tshak.."caracceprice"..msg.sender_id.user_id , 9000000)
...
local carcamrname = Redis:get(Tshak.."carcamrname"..msg.sender_id.user_id)
local carcamrprice = Redis:get(Tshak.."carcamrprice"..msg.sender_id.user_id) or 0
local carcamrnum = Redis:get(Tshak.."carcamrnum"..msg.sender_id.user_id) or 0
local carcamrnow = tonumber(carcamrnum) + tonumber(coniss)
Redis:set(Tshak.."carcamrnum"..msg.sender_id.user_id , carcamrnow)
camrnamed = "كامري"
Redis:set(Tshak.."carcamrname"..msg.sender_id.user_id , camrnamed)
Redis:set(Tshak.."carcamrprice"..msg.sender_id.user_id , 8000000)
...
local caralntrname = Redis:get(Tshak.."caralntrname"..msg.sender_id.user_id)
local caralntrprice = Redis:get(Tshak.."caralntrprice"..msg.sender_id.user_id) or 0
local caralntrnum = Redis:get(Tshak.."caralntrnum"..msg.sender_id.user_id) or 0
local caralntrnow = tonumber(caralntrnum) + tonumber(coniss)
Redis:set(Tshak.."caralntrnum"..msg.sender_id.user_id , caralntrnow)
alntrnamed = "النترا"
Redis:set(Tshak.."caralntrname"..msg.sender_id.user_id , alntrnamed)
Redis:set(Tshak.."caralntrprice"..msg.sender_id.user_id , 7000000)
...
local carhilxname = Redis:get(Tshak.."carhilxname"..msg.sender_id.user_id)
local carhilxprice = Redis:get(Tshak.."carhilxprice"..msg.sender_id.user_id) or 0
local carhilxnum = Redis:get(Tshak.."carhilxnum"..msg.sender_id.user_id) or 0
local carhilxnow = tonumber(carhilxnum) + tonumber(coniss)
Redis:set(Tshak.."carhilxnum"..msg.sender_id.user_id , carhilxnow)
hilxnamed = "هايلكس"
Redis:set(Tshak.."carhilxname"..msg.sender_id.user_id , hilxnamed)
Redis:set(Tshak.."carhilxprice"..msg.sender_id.user_id , 6000000)
...
local carsonaname = Redis:get(Tshak.."carsonaname"..msg.sender_id.user_id)
local carsonaprice = Redis:get(Tshak.."carsonaprice"..msg.sender_id.user_id) or 0
local carsonanum = Redis:get(Tshak.."carsonanum"..msg.sender_id.user_id) or 0
local carsonanow = tonumber(carsonanum) + tonumber(coniss)
Redis:set(Tshak.."carsonanum"..msg.sender_id.user_id , carsonanow)
sonanamed = "سوناتا"
Redis:set(Tshak.."carsonaname"..msg.sender_id.user_id , sonanamed)
Redis:set(Tshak.."carsonaprice"..msg.sender_id.user_id , 5000000)
...
local carcoroname = Redis:get(Tshak.."carcoroname"..msg.sender_id.user_id)
local carcoroprice = Redis:get(Tshak.."carcoroprice"..msg.sender_id.user_id) or 0
local carcoronum = Redis:get(Tshak.."carcoronum"..msg.sender_id.user_id) or 0
local carcoronow = tonumber(carcoronum) + tonumber(coniss)
Redis:set(Tshak.."carcoronum"..msg.sender_id.user_id , carcoronow)
coronamed = "كورولا"
Redis:set(Tshak.."carcoroname"..msg.sender_id.user_id , coronamed)
Redis:set(Tshak.."carcoroprice"..msg.sender_id.user_id , 4000000)
...
local carrangnow = tonumber(carrangnum) - tonumber(coniss)
Redis:set(Tshak.."carrangnum"..msg.sender_id.user_id , carrangnow)
local carrangnumm = Redis:get(Tshak.."carrangnum"..Remsg.sender_id.user_id) or 0
local carrangnoww = tonumber(carrangnumm) + tonumber(coniss)
Redis:set(Tshak.."carrangnum"..Remsg.sender_id.user_id , carrangnoww)
rangnamed = "فيلار"
Redis:set(Tshak.."carrangname"..Remsg.sender_id.user_id,rangnamed)
local carrangnum = Redis:get(Tshak.."carrangnum"..msg.sender_id.user_id) or 0
if tonumber(carrangnum) == 0 then
Redis:del(Tshak.."carrangname"..msg.sender_id.user_id)
Redis:del(Tshak.."carrangnum"..msg.sender_id.user_id)
...
local caraccenow = tonumber(caraccenum) - tonumber(coniss)
Redis:set(Tshak.."caraccenum"..msg.sender_id.user_id , caraccenow)
local caraccenumm = Redis:get(Tshak.."caraccenum"..Remsg.sender_id.user_id) or 0
local caraccenoww = tonumber(caraccenumm) + tonumber(coniss)
Redis:set(Tshak.."caraccenum"..Remsg.sender_id.user_id , caraccenoww)
accenamed = "اكسنت"
Redis:set(Tshak.."caraccename"..Remsg.sender_id.user_id,accenamed)
local caraccenum = Redis:get(Tshak.."caraccenum"..msg.sender_id.user_id) or 0
if tonumber(caraccenum) == 0 then
Redis:del(Tshak.."caraccename"..msg.sender_id.user_id)
Redis:del(Tshak.."caraccenum"..msg.sender_id.user_id)
...
local carcamrnow = tonumber(carcamrnum) - tonumber(coniss)
Redis:set(Tshak.."carcamrnum"..msg.sender_id.user_id , carcamrnow)
local carcamrnumm = Redis:get(Tshak.."carcamrnum"..Remsg.sender_id.user_id) or 0
local carcamrnoww = tonumber(carcamrnumm) + tonumber(coniss)
Redis:set(Tshak.."carcamrnum"..Remsg.sender_id.user_id , carcamrnoww)
camrnamed = "كامري"
Redis:set(Tshak.."carcamrname"..Remsg.sender_id.user_id,camrnamed)
local carcamrnum = Redis:get(Tshak.."carcamrnum"..msg.sender_id.user_id) or 0
if tonumber(carcamrnum) == 0 then
Redis:del(Tshak.."carcamrname"..msg.sender_id.user_id)
Redis:del(Tshak.."carcamrnum"..msg.sender_id.user_id)
...
local carhilxnow = tonumber(carhilxnum) - tonumber(coniss)
Redis:set(Tshak.."carhilxnum"..msg.sender_id.user_id , carhilxnow)
local carhilxnumm = Redis:get(Tshak.."carhilxnum"..Remsg.sender_id.user_id) or 0
local carhilxnoww = tonumber(carhilxnumm) + tonumber(coniss)
Redis:set(Tshak.."carhilxnum"..Remsg.sender_id.user_id , carhilxnoww)
hilxnamed = "هايلكس"
Redis:set(Tshak.."carhilxname"..Remsg.sender_id.user_id,hilxnamed)
local carhilxnum = Redis:get(Tshak.."carhilxnum"..msg.sender_id.user_id) or 0
if tonumber(carhilxnum) == 0 then
Redis:del(Tshak.."carhilxname"..msg.sender_id.user_id)
Redis:del(Tshak.."carhilxnum"..msg.sender_id.user_id)
...
local caralntrnow = tonumber(caralntrnum) - tonumber(coniss)
Redis:set(Tshak.."caralntrnum"..msg.sender_id.user_id , caralntrnow)
local caralntrnumm = Redis:get(Tshak.."caralntrnum"..Remsg.sender_id.user_id) or 0
local caralntrnoww = tonumber(caralntrnumm) + tonumber(coniss)
Redis:set(Tshak.."caralntrnum"..Remsg.sender_id.user_id , caralntrnoww)
alntrnamed = "النترا"
Redis:set(Tshak.."caralntrname"..Remsg.sender_id.user_id,alntrnamed)
local caralntrnum = Redis:get(Tshak.."caralntrnum"..msg.sender_id.user_id) or 0
if tonumber(caralntrnum) == 0 then
Redis:del(Tshak.."caralntrname"..msg.sender_id.user_id)
Redis:del(Tshak.."caralntrnum"..msg.sender_id.user_id)
...
local carsonanow = tonumber(carsonanum) - tonumber(coniss)
Redis:set(Tshak.."carsonanum"..msg.sender_id.user_id , carsonanow)
local carsonanumm = Redis:get(Tshak.."carsonanum"..Remsg.sender_id.user_id) or 0
local carsonanoww = tonumber(carsonanumm) + tonumber(coniss)
Redis:set(Tshak.."carsonanum"..Remsg.sender_id.user_id , carsonanoww)
sonanamed = "سوناتا"
Redis:set(Tshak.."carsonaname"..Remsg.sender_id.user_id,sonanamed)
local carsonanum = Redis:get(Tshak.."carsonanum"..msg.sender_id.user_id) or 0
if tonumber(carsonanum) == 0 then
Redis:del(Tshak.."carsonaname"..msg.sender_id.user_id)
Redis:del(Tshak.."carsonanum"..msg.sender_id.user_id)
...
local carcoronow = tonumber(carcoronum) - tonumber(coniss)
Redis:set(Tshak.."carcoronum"..msg.sender_id.user_id , carcoronow)
local carcoronumm = Redis:get(Tshak.."carcoronum"..Remsg.sender_id.user_id) or 0
local carcoronoww = tonumber(carcoronumm) + tonumber(coniss)
Redis:set(Tshak.."carcoronum"..Remsg.sender_id.user_id , carcoronoww)
coronamed = "كورولا"
Redis:set(Tshak.."carcoroname"..Remsg.sender_id.user_id,coronamed)
local carcoronum = Redis:get(Tshak.."carcoronum"..msg.sender_id.user_id) or 0
if tonumber(carcoronum) == 0 then
Redis:del(Tshak.."carcoroname"..msg.sender_id.user_id)
Redis:del(Tshak.."carcoronum"..msg.sender_id.user_id)
...
if Redis:get(Tshak.."zwag_request:"..msg.sender_id.user_id) then 
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ همس مو للزواج 🤣","md",true)  
return false
end
if Redis:get(Tshak.."roog1"..msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابك تراك متزوج !!","md",true)
return false
end
if Redis:get(Tshak.."rooga1"..msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابك تراك متزوج !!","md",true)
return false
end
if Redis:get(Tshak.."roog1"..Remsg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابعد بعيد لاتحوس وتدور حول المتزوجين","md",true)
return false
end
if Redis:get(Tshak.."rooga1"..Remsg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابعد بعيد لاتحوس وتدور حول المتزوجين","md",true)
return false
end
if Redis:sismember(Tshak.."booob",msg.sender_id.user_id) then
...
Redis:setex(Tshak.."zwag_request:"..msg.sender_id.user_id,60,true)
Redis:setex(Tshak.."zwag_request:"..Remsg.sender_id.user_id,60,true)
...
if msg.ControllerBot then
  ...
  zwag_list = {}
  for k,v in pairs(zwag_users) do
  local mahr = Redis:get(Tshak.."rahr1"..v)
  local zwga = Redis:get(Tshak.."rooga1"..v)
...
"30)"
  ...
  local zwga_name = bot.getUser(v[3]).first_name or Redis:get(Tshak..v[3].."first_name:") or "لا يوجد اسم"
...
kk = kk:gsub("#[%a%d_]+",'')
local doltebank = Redis:get(Tshak.."doltebank"..v[2]) or " "
local doltebankz = Redis:get(Tshak.."doltebank"..v[3]) or " "
local mony = v[1]
local convert_mony = string.format("%.0f",mony)
local emo = zwag_emoji[k]
znum = znum + 1
...
if Redis:sismember(Tshak.."roogg1",msg.sender_id.user_id) or Redis:sismember(Tshak.."roogga1",msg.sender_id.user_id) then
local zoog = Redis:get(Tshak.."roog1"..msg.sender_id.user_id)
local zooga = Redis:get(Tshak.."rooga1"..msg.sender_id.user_id)
local mahr = Redis:get(Tshak.."rahr1"..msg.sender_id.user_id)
...
if Redis:sismember(Tshak.."roogg1",Remsg.sender_id.user_id) or Redis:sismember(Tshak.."roogga1",Remsg.sender_id.user_id) then
if Redis:sismember(Tshak.."booob",msg.sender_id.user_id) then
ballancee = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
if tonumber(ballancee) < 100 then
return send(msg.chat_id,msg.id, "⇜ فلوسك ماتكفي \n✧","md",true)
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ همس مو متزوجه ","md",true)  
return false
end
local zoog = Redis:get(Tshak.."roog1"..Remsg.sender_id.user_id)
local zooga = Redis:get(Tshak.."rooga1"..Remsg.sender_id.user_id)
local mahr = Redis:get(Tshak.."rahr1"..Remsg.sender_id.user_id)
local bandd = bot.getUser(zoog)
if bandd.first_name then
neews = "["..bandd.first_name.."](tg://user?id="..bandd.id..")"
else
...
local convert_mony = string.format("%.0f",mahr)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(otheka))
...
local zoog = Redis:get(Tshak.."roog1"..msg.sender_id.user_id)
local zooga = tonumber(Redis:get(Tshak.."rooga1"..msg.sender_id.user_id))
...
Redis:del(Tshak.."rahr1"..msg.sender_id.user_id)
Redis:del(Tshak.."rahrr1"..msg.sender_id.user_id)
Redis:srem(Tshak.."roogg1", zooga)
Redis:srem(Tshak.."roogga1", zooga)
Redis:del(Tshak.."roog1"..zooga)
Redis:del(Tshak.."rooga1"..zooga)
Redis:del(Tshak.."rahr1"..zooga)
Redis:del(Tshak.."rahrr1"..zooga)
...
local mahrr = Redis:get(Tshak.."rahrr1"..msg.sender_id.user_id)
local bandd = bot.getUser(zoog)
if bandd.first_name then
neews = "["..bandd.first_name.."](tg://user?id="..bandd.id..")"
else
...
ballancee = Redis:get(Tshak.."boob"..zoog) or 0
kalea = ballancee + mahrr
Redis:set(Tshak.."boob"..zoog , kalea)
local convert_mony = string.format("%.0f",mahrr)
send(msg.chat_id,msg.id, "⇜ خلعت زوجك "..neews.."\n⇜ ورجعت له المهر ( "..convert_mony.." درهم 💵 )","md",true)
Redis:srem(Tshak.."roogg1", zoog)
Redis:srem(Tshak.."roogga1", zoog)
Redis:del(Tshak.."roog1"..zoog)
Redis:del(Tshak.."rooga1"..zoog)
Redis:del(Tshak.."rahr1"..zoog)
Redis:del(Tshak.."rahrr1"..zoog)
Redis:srem(Tshak.."roogg1", msg.sender_id.user_id)
Redis:srem(Tshak.."roogga1", msg.sender_id.user_id)
Redis:del(Tshak.."roog1"..msg.sender_id.user_id)
Redis:del(Tshak.."rooga1"..msg.sender_id.user_id)
...
Redis:del(Tshak..'List_rhan'..msg.chat_id)  
Redis:set(Tshak.."playerrhan"..msg.chat_id,msg.sender_id.user_id)
Redis:set(Tshak.."playercoins"..msg.chat_id..msg.sender_id.user_id,coniss)
Redis:set(Tshak.."raeahkam"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(Tshak..'List_rhan'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(Tshak.."Start_rhan"..msg.chat_id,3600,true)
Redis:set(Tshak.."allrhan"..msg.chat_id..12345 , coniss)
local ballancee = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
rehan = tonumber(ballancee) - tonumber(coniss)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , rehan)
return send(msg.chat_id,msg.id,"⇜ بدينا المراهنة وسجلت اسمك \n⇜ اللي بده يشارك يرسل ( انا والمبلغ ) .","md",true)
end
if text == 'نعم' and Redis:get(Tshak.."Witting_Startrhan"..msg.chat_id) then
rarahkam = Redis:get(Tshak.."raeahkam"..msg.chat_id)
if tonumber(rarahkam) == msg.sender_id.user_id then
local list = Redis:smembers(Tshak..'List_rhan'..msg.chat_id) 
if #list == 1 then 
...
benrahan = Redis:get(Tshak.."allrhan"..msg.chat_id..12345) or 0
local ballancee = Redis:get(Tshak.."boob"..UserName) or 0
rehane = tonumber(benrahan) / 100 * 25
rehan = tonumber(ballancee) + math.floor(rehane)
Redis:set(Tshak.."boob"..UserName , rehan)
local rhan_users = Redis:smembers(Tshak.."List_rhan"..msg.chat_id)
for k,v in pairs(rhan_users) do
Redis:del(Tshak..'playercoins'..msg.chat_id..v)
end
Redis:del(Tshak..'allrhan'..msg.chat_id..12345) 
Redis:del(Tshak..'playerrhan'..msg.chat_id) 
Redis:del(Tshak..'raeahkam'..msg.chat_id) 
Redis:del(Tshak..'List_rhan'..msg.chat_id) 
Redis:del(Tshak.."Witting_Startrhan"..msg.chat_id)
Redis:del(Tshak.."Start_rhan"..msg.chat_id)
local ballancee = Redis:get(Tshak.."boob"..UserName) or 0
...
local bank_users = Redis:smembers(Tshak.."ownernade")
if #bank_users == 0 then
...
mony_listd = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(Tshak.."nokatnade"..v) or 0
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local kk = Redis:get(Tshak.."lkbnade"..v[2])
kk = kk:gsub("🇾🇪️",'')
kk = kk:gsub("🇹🇳",'')
kk = kk:gsub("🇸🇾",'')
kk = kk:gsub("🇸🇩",'')
...
if Redis:sismember(Tshak.."booob",msg.sender_id.user_id) then
if Redis:get(Tshak.."namenade"..msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ لديك نادي مسبقاً ","md",true)
end
if Redis:sismember(Tshak.."lkbnadesadd", Cnamed) then
return send(msg.chat_id,msg.id, "⇜ الاسم موجود مسبقاً\n⇜ اختر اسم اخر\n✧","md",true)
end
Redis:set(Tshak.."lkbnade"..msg.sender_id.user_id, Cnamed)
...
Redis:del(Tshak.."priceplayer".."4"..msg.sender_id.user_id)
Redis:del(Tshak.."priceplayer".."5"..msg.sender_id.user_id)
Redis:srem(Tshak.."lkbnadesadd", namfra)
Redis:srem(Tshak.."ownernade",msg.sender_id.user_id)
Redis:del(Tshak.."lkbnade"..msg.sender_id.user_id)
...
if Redis:ttl(Tshak.."traningnade" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Tshak.."traningnade" .. msg.sender_id.user_id))
...
namenade = Redis:get(Tshak.."namenade"..msg.sender_id.user_id)
energynade = Redis:get(Tshak.."energynade"..msg.sender_id.user_id)
lkbnade = Redis:get(Tshak.."lkbnade"..msg.sender_id.user_id)
namenade = Redis:get(Tshak.."namenade"..msg.sender_id.user_id)
energyplayer1 = Redis:get(Tshak.."energyplayer".."1"..msg.sender_id.user_id)
energyplayer2 = Redis:get(Tshak.."energyplayer".."2"..msg.sender_id.user_id)
energyplayer3 = Redis:get(Tshak.."energyplayer".."3"..msg.sender_id.user_id)
energyplayer4 = Redis:get(Tshak.."energyplayer".."4"..msg.sender_id.user_id)
energyplayer5 = Redis:get(Tshak.."energyplayer".."5"..msg.sender_id.user_id)
if tonumber(energynade) < 151 then
Redis:incrby(Tshak.."energynade"..msg.sender_id.user_id,1)
end
if energyplayer1 then
if tonumber(energyplayer1) < 151 then
Redis:incrby(Tshak.."energyplayer".."1"..msg.sender_id.user_id,1)
end
end
if energyplayer2 then
if tonumber(energyplayer2) < 151 then
Redis:incrby(Tshak.."energyplayer".."2"..msg.sender_id.user_id,1)
end
end
if energyplayer3 then
if tonumber(energyplayer3) < 151 then
Redis:incrby(Tshak.."energyplayer".."3"..msg.sender_id.user_id,1)
end
end
if energyplayer4 then
if tonumber(energyplayer4) < 151 then
Redis:incrby(Tshak.."energyplayer".."4"..msg.sender_id.user_id,1)
end
end
if energyplayer5 then
if tonumber(energyplayer5) < 151 then
Redis:incrby(Tshak.."energyplayer".."5"..msg.sender_id.user_id,1)
end
end
energynade = Redis:get(Tshak.."energynade"..msg.sender_id.user_id)
Redis:setex(Tshak.."traningnade" .. msg.sender_id.user_id,1800, true)
...
Redis:setex(Tshak.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
...
if Redis:get(Tshak.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(Tshak.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
if text == "الغاء" or text == "الغاء الامر" then
return send(msg.chat_id,msg.id, "⇜ تم الغاء امر تغيير لقب النادي","md",true)
end
if Redis:sismember(Tshak.."lkbnadesadd", text) then
return send(msg.chat_id,msg.id, "⇜ الاسم موجود مسبقاً\n⇜ اختر اسم اخر\n✧","md",true)
end
namfra = Redis:get(Tshak.."lkbnade"..msg.sender_id.user_id)
Redis:srem(Tshak.."lkbnadesadd", namfra)
Redis:del(Tshak.."lkbnade"..msg.sender_id.user_id)
Redis:set(Tshak.."lkbnade"..msg.sender_id.user_id, text)
Redis:sadd(Tshak.."lkbnadesadd", text)
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
cccallcc = tonumber(ballance) - 25000
Redis:set(Tshak.."boob"..msg.sender_id.user_id,cccallcc)
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
...
nameplayer1 = Redis:get(Tshak.."nameplayer".."1"..msg.sender_id.user_id)
nameplayer2 = Redis:get(Tshak.."nameplayer".."2"..msg.sender_id.user_id)
nameplayer3 = Redis:get(Tshak.."nameplayer".."3"..msg.sender_id.user_id)
nameplayer4 = Redis:get(Tshak.."nameplayer".."4"..msg.sender_id.user_id)
nameplayer5 = Redis:get(Tshak.."nameplayer".."5"..msg.sender_id.user_id)
if nameplayer1 then
mrkzplayer1 = Redis:get(Tshak.."mrkzplayer".."1"..msg.sender_id.user_id)
cityplayer1 = Redis:get(Tshak.."cityplayer".."1"..msg.sender_id.user_id)
energyplayer1 = Redis:get(Tshak.."energyplayer".."1"..msg.sender_id.user_id)
priceplayer1 = Redis:get(Tshak.."priceplayer".."1"..msg.sender_id.user_id)
nameplayer1done = "⌯ اسم اللاعب : `"..nameplayer1.."`\n- مركزه : "..mrkzplayer1.."\n- طاقة اللاعب : "..energyplayer1.."\n- الجنسية : "..cityplayer1.."\n- السعر : "..priceplayer1.."\n\n"
else
nameplayer1done = ""
end
if nameplayer2 then
mrkzplayer2 = Redis:get(Tshak.."mrkzplayer".."2"..msg.sender_id.user_id)
cityplayer2 = Redis:get(Tshak.."cityplayer".."2"..msg.sender_id.user_id)
energyplayer2 = Redis:get(Tshak.."energyplayer".."2"..msg.sender_id.user_id)
priceplayer2 = Redis:get(Tshak.."priceplayer".."2"..msg.sender_id.user_id)
nameplayer2done = "⌯ اسم اللاعب : `"..nameplayer2.."`\n- مركزه : "..mrkzplayer2.."\n- طاقة اللاعب : "..energyplayer2.."\n- الجنسية : "..cityplayer2.."\n- السعر : "..priceplayer2.."\n\n"
else
nameplayer2done = ""
end
if nameplayer3 then
mrkzplayer3 = Redis:get(Tshak.."mrkzplayer".."3"..msg.sender_id.user_id)
cityplayer3 = Redis:get(Tshak.."cityplayer".."3"..msg.sender_id.user_id)
energyplayer3 = Redis:get(Tshak.."energyplayer".."3"..msg.sender_id.user_id)
priceplayer3 = Redis:get(Tshak.."priceplayer".."3"..msg.sender_id.user_id)
nameplayer3done = "⌯ اسم اللاعب : `"..nameplayer3.."`\n- مركزه : "..mrkzplayer3.."\n- طاقة اللاعب : "..energyplayer3.."\n- الجنسية : "..cityplayer3.."\n- السعر : "..priceplayer3.."\n\n"
else
nameplayer3done = ""
end
if nameplayer4 then
mrkzplayer4 = Redis:get(Tshak.."mrkzplayer".."4"..msg.sender_id.user_id)
cityplayer4 = Redis:get(Tshak.."cityplayer".."4"..msg.sender_id.user_id)
energyplayer4 = Redis:get(Tshak.."energyplayer".."4"..msg.sender_id.user_id)
priceplayer4 = Redis:get(Tshak.."priceplayer".."4"..msg.sender_id.user_id)
nameplayer4done = "⌯ اسم اللاعب : `"..nameplayer4.."`\n- مركزه : "..mrkzplayer4.."\n- طاقة اللاعب : "..energyplayer4.."\n- الجنسية : "..cityplayer4.."\n- السعر : "..priceplayer4.."\n\n"
else
nameplayer4done = ""
end
if nameplayer5 then
mrkzplayer5 = Redis:get(Tshak.."mrkzplayer".."5"..msg.sender_id.user_id)
cityplayer5 = Redis:get(Tshak.."cityplayer".."5"..msg.sender_id.user_id)
energyplayer5 = Redis:get(Tshak.."energyplayer".."5"..msg.sender_id.user_id)
priceplayer5 = Redis:get(Tshak.."priceplayer".."5"..msg.sender_id.user_id)
...
Redis:setex(Tshak.."shoplyname" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
...
if Redis:get(Tshak.."shoplyname" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(Tshak.."shoplyname" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
if text == "الغاء" or text == "الغاء الامر" then
...
Redis:set(Tshak.."boob"..msg.sender_id.user_id,pricetotaly)
Redis:del(Tshak.."nameplayer".."1"..msg.sender_id.user_id)
Redis:del(Tshak.."energyplayer".."1"..msg.sender_id.user_id)
Redis:del(Tshak.."mrkzplayer".."1"..msg.sender_id.user_id)
Redis:del(Tshak.."cityplayer".."1"..msg.sender_id.user_id)
...
energynade = Redis:get(Tshak.."energynade"..msg.sender_id.user_id)
lkbnade = Redis:get(Tshak.."lkbnade"..msg.sender_id.user_id)
nokatnade = Redis:get(Tshak.."nokatnade"..msg.sender_id.user_id) or 0
nameplayer1 = Redis:get(Tshak.."nameplayer".."1"..msg.sender_id.user_id)
nameplayer2 = Redis:get(Tshak.."nameplayer".."2"..msg.sender_id.user_id)
nameplayer3 = Redis:get(Tshak.."nameplayer".."3"..msg.sender_id.user_id)
nameplayer4 = Redis:get(Tshak.."nameplayer".."4"..msg.sender_id.user_id)
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ همس ماعندها نادي ","md",true)
return false
end
if not Redis:get(Tshak.."namenade" .. Remsg.sender_id.user_id) then
...
namenade = Redis:get(Tshak.."namenade"..Remsg.sender_id.user_id)
energynade = Redis:get(Tshak.."energynade"..Remsg.sender_id.user_id)
lkbnade = Redis:get(Tshak.."lkbnade"..Remsg.sender_id.user_id)
nokatnade = Redis:get(Tshak.."nokatnade"..Remsg.sender_id.user_id) or 0
nameplayer1 = Redis:get(Tshak.."nameplayer".."1"..Remsg.sender_id.user_id)
nameplayer2 = Redis:get(Tshak.."nameplayer".."2"..Remsg.sender_id.user_id)
nameplayer3 = Redis:get(Tshak.."nameplayer".."3"..Remsg.sender_id.user_id)
nameplayer4 = Redis:get(Tshak.."nameplayer".."4"..Remsg.sender_id.user_id)
nameplayer5 = Redis:get(Tshak.."nameplayer".."5"..Remsg.sender_id.user_id)
if nameplayer1 then
mrkzplayer1 = Redis:get(Tshak.."mrkzplayer".."1"..Remsg.sender_id.user_id)
cityplayer1 = Redis:get(Tshak.."cityplayer".."1"..Remsg.sender_id.user_id)
energyplayer1 = Redis:get(Tshak.."energyplayer".."1"..Remsg.sender_id.user_id)
nameplayer1done = "⌯ اسم اللاعب : "..nameplayer1.."\n- مركزه : "..mrkzplayer1.."\n- طاقة اللاعب : "..energyplayer1.."\n- الجنسية : "..cityplayer1.."\n\n"
else
nameplayer1done = ""
end
if nameplayer2 then
mrkzplayer2 = Redis:get(Tshak.."mrkzplayer".."2"..Remsg.sender_id.user_id)
cityplayer2 = Redis:get(Tshak.."cityplayer".."2"..Remsg.sender_id.user_id)
energyplayer2 = Redis:get(Tshak.."energyplayer".."2"..Remsg.sender_id.user_id)
nameplayer2done = "⌯ اسم اللاعب : "..nameplayer2.."\n- مركزه : "..mrkzplayer2.."\n- طاقة اللاعب : "..energyplayer2.."\n- الجنسية : "..cityplayer2.."\n\n"
else
nameplayer2done = ""
end
if nameplayer3 then
mrkzplayer3 = Redis:get(Tshak.."mrkzplayer".."3"..Remsg.sender_id.user_id)
cityplayer3 = Redis:get(Tshak.."cityplayer".."3"..Remsg.sender_id.user_id)
energyplayer3 = Redis:get(Tshak.."energyplayer".."3"..Remsg.sender_id.user_id)
nameplayer3done = "⌯ اسم اللاعب : "..nameplayer3.."\n- مركزه : "..mrkzplayer3.."\n- طاقة اللاعب : "..energyplayer3.."\n- الجنسية : "..cityplayer3.."\n\n"
else
nameplayer3done = ""
end
if nameplayer4 then
mrkzplayer4 = Redis:get(Tshak.."mrkzplayer".."4"..Remsg.sender_id.user_id)
cityplayer4 = Redis:get(Tshak.."cityplayer".."4"..Remsg.sender_id.user_id)
energyplayer4 = Redis:get(Tshak.."energyplayer".."4"..Remsg.sender_id.user_id)
nameplayer4done = "⌯ اسم اللاعب : "..nameplayer4.."\n- مركزه : "..mrkzplayer4.."\n- طاقة اللاعب : "..energyplayer4.."\n- الجنسية : "..cityplayer4.."\n\n"
else
nameplayer4done = ""
end
if nameplayer5 then
mrkzplayer5 = Redis:get(Tshak.."mrkzplayer".."5"..Remsg.sender_id.user_id)
cityplayer5 = Redis:get(Tshak.."cityplayer".."5"..Remsg.sender_id.user_id)
energyplayer5 = Redis:get(Tshak.."energyplayer".."5"..Remsg.sender_id.user_id)
nameplayer5done = "⌯ اسم اللاعب : "..nameplayer5.."\n- مركزه : "..mrkzplayer5.."\n- طاقة اللاعب : "..energyplayer5.."\n- الجنسية : "..cityplayer5.."\n\n"
else
nameplayer5done = ""
end
...
if Redis:ttl(Tshak.."matchode" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Tshak.."matchode" .. msg.sender_id.user_id))
...
namenade = Redis:get(Tshak.."namenade"..msg.sender_id.user_id)
energynade = Redis:get(Tshak.."energynade"..msg.sender_id.user_id)
energyplayer1 = Redis:get(Tshak.."energyplayer".."1"..msg.sender_id.user_id) or 0
energyplayer2 = Redis:get(Tshak.."energyplayer".."2"..msg.sender_id.user_id) or 0
energyplayer3 = Redis:get(Tshak.."energyplayer".."3"..msg.sender_id.user_id) or 0
energyplayer4 = Redis:get(Tshak.."energyplayer".."4"..msg.sender_id.user_id) or 0
energyplayer5 = Redis:get(Tshak.."energyplayer".."5"..msg.sender_id.user_id) or 0
...
Redis:set(Tshak.."boob"..msg.sender_id.user_id,cccallcc)
Redis:incrby(Tshak.."energynade"..msg.sender_id.user_id,1)
Redis:incrby(Tshak.."nokatnade"..msg.sender_id.user_id,1)
Redis:setex(Tshak.."matchode" .. msg.sender_id.user_id,1200, true)
send(msg.chat_id,msg.id, "⌯ لقد فزت بالمبارة "..news.." ⚽️\n⇜ اسم النادي : "..namenade.."\n⇜ نادي الخصم : "..nadebot.."\n⇜ النتيجة : "..result.."\n⇜ تم زيادة نقطة لطاقة ناديك\n✧","md",true)
elseif energymynade < tonumber(energybot) then
Redis:decrby(Tshak.."energynade"..msg.sender_id.user_id,1)
energynade = Redis:get(Tshak.."energynade"..msg.sender_id.user_id)
if tonumber(energynade) < 0 then
Redis:set(Tshak.."energynade"..msg.sender_id.user_id,0)
end
Redis:decrby(Tshak.."nokatnade"..msg.sender_id.user_id,1)
nokatnade = Redis:get(Tshak.."nokatnade"..msg.sender_id.user_id)
if tonumber(nokatnade) < 0 then
Redis:set(Tshak.."nokatnade"..msg.sender_id.user_id,0)
end
Redis:setex(Tshak.."matchode" .. msg.sender_id.user_id,1200, true)
...
if Redis:ttl(Tshak.."matchplayer" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Tshak.."matchplayer" .. msg.sender_id.user_id))
...
namenadevs = Redis:get(Tshak.."namenade"..Remsg.sender_id.user_id)
energynadevs = Redis:get(Tshak.."energynade"..Remsg.sender_id.user_id)
energyplayer1vs = Redis:get(Tshak.."energyplayer".."1"..Remsg.sender_id.user_id) or 0
energyplayer2vs = Redis:get(Tshak.."energyplayer".."2"..Remsg.sender_id.user_id) or 0
energyplayer3vs = Redis:get(Tshak.."energyplayer".."3"..Remsg.sender_id.user_id) or 0
energyplayer4vs = Redis:get(Tshak.."energyplayer".."4"..Remsg.sender_id.user_id) or 0
energyplayer5vs = Redis:get(Tshak.."energyplayer".."5"..Remsg.sender_id.user_id) or 0
...
Redis:decrby(Tshak.."energynade"..Remsg.sender_id.user_id,1)
energynadevs = Redis:get(Tshak.."energynade"..Remsg.sender_id.user_id)
if tonumber(energynadevs) < 0 then
Redis:set(Tshak.."energynade"..Remsg.sender_id.user_id,0)
end
if energyplayer1vs then
Redis:decrby(Tshak.."energyplayer".."1"..Remsg.sender_id.user_id,1)
end
energyplayer1vs = Redis:get(Tshak.."energyplayer".."1"..Remsg.sender_id.user_id)
if tonumber(energyplayer1vs) < 0 then
Redis:set(Tshak.."energyplayer".."1"..Remsg.sender_id.user_id,0)
end
if energyplayer2vs then
Redis:decrby(Tshak.."energyplayer".."2"..Remsg.sender_id.user_id,1)
end
energyplayer2vs = Redis:get(Tshak.."energyplayer".."2"..Remsg.sender_id.user_id)
if tonumber(energyplayer2vs) < 0 then
Redis:set(Tshak.."energyplayer".."2"..Remsg.sender_id.user_id,0)
end
if energyplayer3vs then
Redis:decrby(Tshak.."energyplayer".."3"..Remsg.sender_id.user_id,1)
end
energyplayer3vs = Redis:get(Tshak.."energyplayer".."3"..Remsg.sender_id.user_id)
if tonumber(energyplayer3vs) < 0 then
Redis:set(Tshak.."energyplayer".."3"..Remsg.sender_id.user_id,0)
end
if energyplayer4vs then
Redis:decrby(Tshak.."energyplayer".."4"..Remsg.sender_id.user_id,1)
end
energyplayer4vs = Redis:get(Tshak.."energyplayer".."4"..Remsg.sender_id.user_id)
if tonumber(energyplayer4vs) < 0 then
Redis:set(Tshak.."energyplayer".."4"..Remsg.sender_id.user_id,0)
end
if energyplayer5vs then
Redis:decrby(Tshak.."energyplayer".."5"..Remsg.sender_id.user_id,1)
end
energyplayer5vs = Redis:get(Tshak.."energyplayer".."5"..Remsg.sender_id.user_id)
if tonumber(energyplayer5vs) < 0 then
Redis:set(Tshak.."energyplayer".."5"..Remsg.sender_id.user_id,0)
end
Redis:decrby(Tshak.."nokatnade"..Remsg.sender_id.user_id,1)
nokatnadevs = Redis:get(Tshak.."nokatnade"..Remsg.sender_id.user_id)
if tonumber(nokatnadevs) < 0 then
Redis:set(Tshak.."nokatnade"..Remsg.sender_id.user_id,0)
end
Redis:setex(Tshak.."matchplayer" .. msg.sender_id.user_id,1200, true)
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
...
Redis:incrby(Tshak.."energynade"..Remsg.sender_id.user_id,1)
Redis:incrby(Tshak.."nokatnade"..Remsg.sender_id.user_id,1)
if energyplayer1vs then
Redis:incrby(Tshak.."energyplayer".."1"..Remsg.sender_id.user_id,1)
end
if energyplayer2vs then
Redis:incrby(Tshak.."energyplayer".."2"..Remsg.sender_id.user_id,1)
end
if energyplayer3vs then
Redis:incrby(Tshak.."energyplayer".."3"..Remsg.sender_id.user_id,1)
end
if energyplayer4vs then
Redis:incrby(Tshak.."energyplayer".."4"..Remsg.sender_id.user_id,1)
end
if energyplayer5vs then
Redis:incrby(Tshak.."energyplayer".."5"..Remsg.sender_id.user_id,1)
end
Redis:decrby(Tshak.."energynade"..msg.sender_id.user_id,1)
energynade = Redis:get(Tshak.."energynade"..msg.sender_id.user_id)
if tonumber(energynade) < 0 then
...
if energyplayer1 then
Redis:decrby(Tshak.."energyplayer".."1"..msg.sender_id.user_id,1)
end
energyplayer1 = Redis:get(Tshak.."energyplayer".."1"..msg.sender_id.user_id)
if tonumber(energyplayer1) < 0 then
Redis:set(Tshak.."energyplayer".."1"..msg.sender_id.user_id,0)
end
if energyplayer2 then
Redis:decrby(Tshak.."energyplayer".."2"..msg.sender_id.user_id,1)
end
energyplayer2 = Redis:get(Tshak.."energyplayer".."2"..msg.sender_id.user_id)
if tonumber(energyplayer2) < 0 then
Redis:set(Tshak.."energyplayer".."2"..msg.sender_id.user_id,0)
end
if energyplayer3 then
Redis:decrby(Tshak.."energyplayer".."3"..msg.sender_id.user_id,1)
end
energyplayer3 = Redis:get(Tshak.."energyplayer".."3"..msg.sender_id.user_id)
if tonumber(energyplayer3) < 0 then
Redis:set(Tshak.."energyplayer".."3"..msg.sender_id.user_id,0)
end
if energyplayer4 then
Redis:decrby(Tshak.."energyplayer".."4"..msg.sender_id.user_id,1)
end
energyplayer4 = Redis:get(Tshak.."energyplayer".."4"..msg.sender_id.user_id)
if tonumber(energyplayer4) < 0 then
Redis:set(Tshak.."energyplayer".."4"..msg.sender_id.user_id,0)
end
if energyplayer5 then
Redis:decrby(Tshak.."energyplayer".."5"..msg.sender_id.user_id,1)
end
energyplayer5 = Redis:get(Tshak.."energyplayer".."5"..msg.sender_id.user_id)
if tonumber(energyplayer5) < 0 then
Redis:set(Tshak.."energyplayer".."5"..msg.sender_id.user_id,0)
end
Redis:decrby(Tshak.."nokatnade"..msg.sender_id.user_id,1)
nokatnade = Redis:get(Tshak.."nokatnade"..msg.sender_id.user_id)
if tonumber(nokatnade) < 0 then
...
if Redis:sismember(Tshak.."booob",msg.sender_id.user_id) then
if Redis:get(Tshak.."mrkzplayer".."1"..msg.sender_id.user_id) and Redis:get(Tshak.."mrkzplayer".."2"..msg.sender_id.user_id) and Redis:get(Tshak.."mrkzplayer".."3"..msg.sender_id.user_id) and Redis:get(Tshak.."mrkzplayer".."4"..msg.sender_id.user_id) and Redis:get(Tshak.."mrkzplayer".."5"..msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ النادي الخاص بك مكتمل\n⇜ تستطيع بيع لاعب عن طريق الامر ( بيع لاعب )  ","md",true)
end
if Redis:ttl(Tshak.."buyplayer" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Tshak.."buyplayer" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ تستطيع شراء لاعب بعد "..time.." ","md",true)
end
Redis:setex(Tshak.."buyplayer" .. msg.sender_id.user_id,900, true)
...
if Redis:sismember(Tshak.."booob",msg.sender_id.user_id) then
ballanceed = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
namefram = Redis:get(Tshak.."namefram"..msg.sender_id.user_id)
if Redis:get(Tshak.."sizefram"..msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ لديك مزرعه مسبقاً ","md",true)
end
if Redis:sismember(Tshak.."farmarname", Cnamed) then
return send(msg.chat_id,msg.id, "⇜ اسم المزرعه موجود مسبقاً\n⇜ اختر اسم اخر\n✧","md",true)
end
Redis:set(Tshak.."namefram"..msg.sender_id.user_id, Cnamed)
...
local bank_users = Redis:smembers(Tshak.."ownerfram")
if #bank_users == 0 then
...
mony_listd = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(Tshak.."toplvfarm"..v) or 0
table.insert(mony_listd, {tonumber(mony) , v})
end
table.sort(mony_listd, function(a, b) return a[1] > b[1] end)
num = 1
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local kk = Redis:get(Tshak.."namefram"..v[2])
kk = kk:gsub("🇾🇪️",'')
kk = kk:gsub("🇹🇳",'')
kk = kk:gsub("🇸🇾",'')
kk = kk:gsub("🇸🇩",'')
...
if Redis:sismember(Tshak.."booob",msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⌯ اهلا فيك بمزرعة همس :\n\n⇜ المزروعات واسعارها :\n- بطاطا : 75 درهم 💵\n- بندوره : 100 درهم 💵\n- خس : 125 درهم 💵\n- خيار : 150 درهم 💵\n- جزر : 175 درهم 💵\n- فليفله : 200 درهم 💵\n- فريز : 300 درهم 💵\n- ذره : 400 درهم 💵\n- ثوم : 500 درهم 💵\n- فطر : 800 درهم 💵\n- شجره تفاح : 1000 درهم 💵\n- شجره عنب : 1250 درهم 💵\n-شجره زيتون : 1500 درهم 💵\n- شجره موز : 2000 درهم 💵\n- شجره مانجا : 3000 درهم 💵\n\n⇜ مثال طريقة الزراعه : \n- زراعه بطاطا 10\n- زراعه شجر موز 15\n✧","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(Tshak.."booob",msg.sender_id.user_id) then
if not Redis:get(Tshak.."sizefram" .. msg.sender_id.user_id) then
...
local namefram = Redis:get(Tshak.."namefram"..msg.sender_id.user_id)
local sizefram = Redis:get(Tshak.."sizefram"..msg.sender_id.user_id)
local mzroatsize = Redis:get(Tshak.."mzroatsize"..msg.sender_id.user_id) or 0
local mazofxbh = tonumber(sizefram) - tonumber(mzroatsize)
local btatahours = Redis:ttl(Tshak.."btatatime" .. msg.sender_id.user_id) / 60
local btatatime = Redis:get(Tshak.."btatatime" .. msg.sender_id.user_id)
local btataname = Redis:get(Tshak.."btataname"..msg.sender_id.user_id)
local btatanum = Redis:get(Tshak.."btatanum"..msg.sender_id.user_id) or 0
...
local lemonhours = Redis:ttl(Tshak.."lemontime" .. msg.sender_id.user_id) / 60
local lemontime = Redis:get(Tshak.."lemontime" .. msg.sender_id.user_id)
local lemonname = Redis:get(Tshak.."lemonname"..msg.sender_id.user_id)
local lemonnum = Redis:get(Tshak.."lemonnum"..msg.sender_id.user_id) or 0
...
local khesshours = Redis:ttl(Tshak.."khesstime" .. msg.sender_id.user_id) / 60
local khesstime = Redis:get(Tshak.."khesstime" .. msg.sender_id.user_id)
local khessname = Redis:get(Tshak.."khessname"..msg.sender_id.user_id)
local khessnum = Redis:get(Tshak.."khessnum"..msg.sender_id.user_id) or 0
...
local khearhours = Redis:ttl(Tshak.."kheartime" .. msg.sender_id.user_id) / 60
local kheartime = Redis:get(Tshak.."kheartime" .. msg.sender_id.user_id)
local khearname = Redis:get(Tshak.."khearname"..msg.sender_id.user_id)
local khearnum = Redis:get(Tshak.."khearnum"..msg.sender_id.user_id) or 0
...
local jzarhours = Redis:ttl(Tshak.."jzartime" .. msg.sender_id.user_id) / 60
local jzartime = Redis:get(Tshak.."jzartime" .. msg.sender_id.user_id)
local jzarname = Redis:get(Tshak.."jzarname"..msg.sender_id.user_id)
local jzarnum = Redis:get(Tshak.."jzarnum"..msg.sender_id.user_id) or 0
...
local fleflahours = Redis:ttl(Tshak.."fleflatime" .. msg.sender_id.user_id) / 60
local fleflatime = Redis:get(Tshak.."fleflatime" .. msg.sender_id.user_id)
local fleflaname = Redis:get(Tshak.."fleflaname"..msg.sender_id.user_id)
local fleflanum = Redis:get(Tshak.."fleflanum"..msg.sender_id.user_id) or 0
...
local freazhours = Redis:ttl(Tshak.."freaztime" .. msg.sender_id.user_id) / 60
local freaztime = Redis:get(Tshak.."freaztime" .. msg.sender_id.user_id)
local freazname = Redis:get(Tshak.."freazname"..msg.sender_id.user_id)
local freaznum = Redis:get(Tshak.."freaznum"..msg.sender_id.user_id) or 0
...
local dorahours = Redis:ttl(Tshak.."doratime" .. msg.sender_id.user_id) / 60
local doratime = Redis:get(Tshak.."doratime" .. msg.sender_id.user_id)
local doraname = Redis:get(Tshak.."doraname"..msg.sender_id.user_id)
local doranum = Redis:get(Tshak.."doranum"..msg.sender_id.user_id) or 0
...
local tomhours = Redis:ttl(Tshak.."tomtime" .. msg.sender_id.user_id) / 60
local tomtime = Redis:get(Tshak.."tomtime" .. msg.sender_id.user_id)
local tomname = Redis:get(Tshak.."tomname"..msg.sender_id.user_id)
local tomnum = Redis:get(Tshak.."tomnum"..msg.sender_id.user_id) or 0
...
local ftrhours = Redis:ttl(Tshak.."ftrtime" .. msg.sender_id.user_id) / 60
local ftrtime = Redis:get(Tshak.."ftrtime" .. msg.sender_id.user_id)
local ftrname = Redis:get(Tshak.."ftrname"..msg.sender_id.user_id)
local ftrnum = Redis:get(Tshak.."ftrnum"..msg.sender_id.user_id) or 0
...
local tfahhours = Redis:ttl(Tshak.."tfahtime" .. msg.sender_id.user_id) / 60
local tfahtime = Redis:get(Tshak.."tfahtime" .. msg.sender_id.user_id)
local tfahname = Redis:get(Tshak.."tfahname"..msg.sender_id.user_id)
local tfahnum = Redis:get(Tshak.."tfahnum"..msg.sender_id.user_id) or 0
...
local enabhours = Redis:ttl(Tshak.."enabtime" .. msg.sender_id.user_id) / 60
local enabtime = Redis:get(Tshak.."enabtime" .. msg.sender_id.user_id)
local enabname = Redis:get(Tshak.."enabname"..msg.sender_id.user_id)
local enabnum = Redis:get(Tshak.."enabnum"..msg.sender_id.user_id) or 0
...
local zetonhours = Redis:ttl(Tshak.."zetontime" .. msg.sender_id.user_id) / 60
local zetontime = Redis:get(Tshak.."zetontime" .. msg.sender_id.user_id)
local zetonname = Redis:get(Tshak.."zetonname"..msg.sender_id.user_id)
local zetonnum = Redis:get(Tshak.."zetonnum"..msg.sender_id.user_id) or 0
...
local mozzhours = Redis:ttl(Tshak.."mozztime" .. msg.sender_id.user_id) / 60
local mozztime = Redis:get(Tshak.."mozztime" .. msg.sender_id.user_id)
local mozzname = Redis:get(Tshak.."mozzname"..msg.sender_id.user_id)
local mozznum = Redis:get(Tshak.."mozznum"..msg.sender_id.user_id) or 0
...
local mangahours = Redis:ttl(Tshak.."mangatime" .. msg.sender_id.user_id) / 60
local mangatime = Redis:get(Tshak.."mangatime" .. msg.sender_id.user_id)
local manganame = Redis:get(Tshak.."manganame"..msg.sender_id.user_id)
local manganum = Redis:get(Tshak.."manganum"..msg.sender_id.user_id) or 0
...
if Redis:get(Tshak.."btatatime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Tshak.."btatatime" .. msg.sender_id.user_id) / 60
...
if Redis:get(Tshak.."btatanum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة بطاطا قبل 🥔\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد بطاطا`","md",true)
end
kajwha = tonumber(coniss) * 0.7
sizefram = Redis:get(Tshak.."sizefram"..msg.sender_id.user_id)
if tonumber(kajwha) > tonumber(sizefram) then
return send(msg.chat_id,msg.id, "⇜ مايمديك تشتري مساحة ارضك ماتكفي","md",true)
end
mzroatsize = Redis:get(Tshak.."mzroatsize"..msg.sender_id.user_id) or 0
...
Redis:set(Tshak.."btatanum"..msg.sender_id.user_id , coniss)
btataname = "بطاطا"
Redis:set(Tshak.."btataname"..msg.sender_id.user_id , btataname)
mzroatsize = Redis:get(Tshak.."mzroatsize"..msg.sender_id.user_id) or 0
btatasize = tonumber(coniss) * 0.7
btatasizee = btatasize + mzroatsize
Redis:set(Tshak.."mzroatsize"..msg.sender_id.user_id , math.floor(btatasizee))
totalypalice = tonumber(ballance) - tonumber(btata)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Tshak.."btatatime"..msg.sender_id.user_id,1220, true)
local convert_mony = string.format("%.0f",math.floor(btata))
toplvfarm = Redis:get(Tshak.."toplvfarm"..msg.sender_id.user_id) or 0
toplvfarmm = tonumber(toplvfarm) + tonumber(coniss)
Redis:set(Tshak.."toplvfarm"..msg.sender_id.user_id , toplvfarmm)
...
if Redis:get(Tshak.."lemontime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Tshak.."lemontime" .. msg.sender_id.user_id) / 60
...
if Redis:get(Tshak.."lemonnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة بندوره قبل 🍅\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد بندوره`","md",true)
end
...
Redis:set(Tshak.."lemonnum"..msg.sender_id.user_id , coniss)
lemonname = "بندوره"
Redis:set(Tshak.."lemonname"..msg.sender_id.user_id , lemonname)
mzroatsize = Redis:get(Tshak.."mzroatsize"..msg.sender_id.user_id) or 0
lemonsize = tonumber(coniss) * 1
lemonsizee = lemonsize + mzroatsize
Redis:set(Tshak.."mzroatsize"..msg.sender_id.user_id , math.floor(lemonsizee))
totalypalice = tonumber(ballance) - tonumber(lemon)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Tshak.."lemontime"..msg.sender_id.user_id,1520, true)
...
if Redis:get(Tshak.."khesstime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Tshak.."khesstime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة خس قبل 🥬\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصادها\n- طريقة الحصاد بالامر : `حصد خس`","md",true)
end
if Redis:get(Tshak.."khessnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة خس قبل 🥬\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد خس`","md",true)
end
...
Redis:set(Tshak.."khessnum"..msg.sender_id.user_id , coniss)
khessname = "خس"
Redis:set(Tshak.."khessname"..msg.sender_id.user_id , khessname)
mzroatsize = Redis:get(Tshak.."mzroatsize"..msg.sender_id.user_id) or 0
khesssize = tonumber(coniss) * 1.2
khesssizee = khesssize + mzroatsize
Redis:set(Tshak.."mzroatsize"..msg.sender_id.user_id , math.floor(khesssizee))
totalypalice = tonumber(ballance) - tonumber(khess)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Tshak.."khesstime"..msg.sender_id.user_id,1800, true)
...
if Redis:get(Tshak.."kheartime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Tshak.."kheartime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة خيار قبل 🥒\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد خيار`","md",true)
end
if Redis:get(Tshak.."khearnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة خيار قبل 🥒\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد خيار`","md",true)
end
...
Redis:set(Tshak.."khearnum"..msg.sender_id.user_id , coniss)
khearname = "خيار"
Redis:set(Tshak.."khearname"..msg.sender_id.user_id , khearname)
mzroatsize = Redis:get(Tshak.."mzroatsize"..msg.sender_id.user_id) or 0
khearsize = tonumber(coniss) * 1.5
khearsizee = khearsize + mzroatsize
Redis:set(Tshak.."mzroatsize"..msg.sender_id.user_id , math.floor(khearsizee))
totalypalice = tonumber(ballance) - tonumber(khear)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Tshak.."kheartime"..msg.sender_id.user_id,2120, true)
...
if Redis:get(Tshak.."jzartime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Tshak.."jzartime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة جزر قبل 🥕\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد جزر`","md",true)
end
if Redis:get(Tshak.."jzarnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة جزر قبل 🥕\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد جزر`","md",true)
end
...
Redis:set(Tshak.."jzarnum"..msg.sender_id.user_id , coniss)
jzarname = "جزر"
Redis:set(Tshak.."jzarname"..msg.sender_id.user_id , jzarname)
mzroatsize = Redis:get(Tshak.."mzroatsize"..msg.sender_id.user_id) or 0
jzarsize = tonumber(coniss) * 1.7
jzarsizee = jzarsize + mzroatsize
Redis:set(Tshak.."mzroatsize"..msg.sender_id.user_id , math.floor(jzarsizee))
totalypalice = tonumber(ballance) - tonumber(jzar)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Tshak.."jzartime"..msg.sender_id.user_id,2420, true)
...
if Redis:get(Tshak.."fleflatime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Tshak.."fleflatime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فليفله قبل 🫑\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصادها\n- طريقة الحصاد بالامر : `حصد فليفله`","md",true)
end
if Redis:get(Tshak.."fleflanum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فليفله قبل 🫑\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد فليفله`","md",true)
end
...
Redis:set(Tshak.."fleflanum"..msg.sender_id.user_id , coniss)
fleflaname = "فليفله"
Redis:set(Tshak.."fleflaname"..msg.sender_id.user_id , fleflaname)
mzroatsize = Redis:get(Tshak.."mzroatsize"..msg.sender_id.user_id) or 0
fleflasize = tonumber(coniss) * 2
fleflasizee = fleflasize + mzroatsize
Redis:set(Tshak.."mzroatsize"..msg.sender_id.user_id , math.floor(fleflasizee))
totalypalice = tonumber(ballance) - tonumber(flefla)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Tshak.."fleflatime"..msg.sender_id.user_id,2720, true)
...
if Redis:get(Tshak.."freaztime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Tshak.."freaztime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فريز قبل 🍓\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد فريز`","md",true)
end
if Redis:get(Tshak.."freaznum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فريز قبل 🍓\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد فريز`","md",true)
end
...
Redis:set(Tshak.."freaznum"..msg.sender_id.user_id , coniss)
freazname = "فريز"
Redis:set(Tshak.."freazname"..msg.sender_id.user_id , freazname)
mzroatsize = Redis:get(Tshak.."mzroatsize"..msg.sender_id.user_id) or 0
freazsize = tonumber(coniss) * 3
freazsizee = freazsize + mzroatsize
Redis:set(Tshak.."mzroatsize"..msg.sender_id.user_id , math.floor(freazsizee))
totalypalice = tonumber(ballance) - tonumber(freaz)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Tshak.."freaztime"..msg.sender_id.user_id,3020, true)
...
if Redis:get(Tshak.."doratime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Tshak.."doratime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة ذره قبل 🌽\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد ذره`","md",true)
end
if Redis:get(Tshak.."doranum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة ذره قبل 🌽\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد ذره`","md",true)
end
...
Redis:set(Tshak.."doranum"..msg.sender_id.user_id , coniss)
doraname = "ذره"
Redis:set(Tshak.."doraname"..msg.sender_id.user_id , doraname)
mzroatsize = Redis:get(Tshak.."mzroatsize"..msg.sender_id.user_id) or 0
dorasize = tonumber(coniss) * 4
dorasizee = dorasize + mzroatsize
Redis:set(Tshak.."mzroatsize"..msg.sender_id.user_id , math.floor(dorasizee))
totalypalice = tonumber(ballance) - tonumber(dora)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Tshak.."doratime"..msg.sender_id.user_id,3320, true)
...
if Redis:get(Tshak.."tomtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Tshak.."tomtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة ثوم قبل 🧄\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد ثوم`","md",true)
end
if Redis:get(Tshak.."tomnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة ثوم قبل 🧄\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد ثوم`","md",true)
end
...
Redis:set(Tshak.."tomnum"..msg.sender_id.user_id , coniss)
tomname = "ثوم"
Redis:set(Tshak.."tomname"..msg.sender_id.user_id , tomname)
mzroatsize = Redis:get(Tshak.."mzroatsize"..msg.sender_id.user_id) or 0
tomsize = tonumber(coniss) * 5
tomsizee = tomsize + mzroatsize
Redis:set(Tshak.."mzroatsize"..msg.sender_id.user_id , math.floor(tomsizee))
totalypalice = tonumber(ballance) - tonumber(tom)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Tshak.."tomtime"..msg.sender_id.user_id,3620, true)
...
if Redis:get(Tshak.."ftrtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Tshak.."ftrtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فطر قبل 🍄\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد فطر`","md",true)
end
if Redis:get(Tshak.."ftrnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فطر قبل 🍄\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد فطر`","md",true)
end
...
Redis:set(Tshak.."ftrnum"..msg.sender_id.user_id , coniss)
ftrname = "فطر"
Redis:set(Tshak.."ftrname"..msg.sender_id.user_id , ftrname)
mzroatsize = Redis:get(Tshak.."mzroatsize"..msg.sender_id.user_id) or 0
ftrsize = tonumber(coniss) * 6
ftrsizee = ftrsize + mzroatsize
Redis:set(Tshak.."mzroatsize"..msg.sender_id.user_id , math.floor(ftrsizee))
totalypalice = tonumber(ballance) - tonumber(ftr)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Tshak.."ftrtime"..msg.sender_id.user_id,4220, true)
...
if Redis:get(Tshak.."tfahtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Tshak.."tfahtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر تفاح قبل 🍏\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر تفاح`","md",true)
end
if Redis:get(Tshak.."tfahnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر تفاح قبل 🍏\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر تفاح`","md",true)
end
...
Redis:set(Tshak.."tfahnum"..msg.sender_id.user_id , coniss)
tfahname = "تفاح"
Redis:set(Tshak.."tfahname"..msg.sender_id.user_id , tfahname)
mzroatsize = Redis:get(Tshak.."mzroatsize"..msg.sender_id.user_id) or 0
tfahsize = tonumber(coniss) * 10
tfahsizee = tfahsize + mzroatsize
Redis:set(Tshak.."mzroatsize"..msg.sender_id.user_id , math.floor(tfahsizee))
totalypalice = tonumber(ballance) - tonumber(tfah)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Tshak.."tfahtime"..msg.sender_id.user_id,5420, true)
...
if Redis:get(Tshak.."enabtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Tshak.."enabtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر عنب قبل 🍇\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر عنب`","md",true)
end
if Redis:get(Tshak.."enabnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر عنب قبل 🍇\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر عنب`","md",true)
end
...
Redis:set(Tshak.."enabnum"..msg.sender_id.user_id , coniss)
enabname = "عنب"
Redis:set(Tshak.."enabname"..msg.sender_id.user_id , enabname)
mzroatsize = Redis:get(Tshak.."mzroatsize"..msg.sender_id.user_id) or 0
enabsize = tonumber(coniss) * 12.5
enabsizee = enabsize + mzroatsize
Redis:set(Tshak.."mzroatsize"..msg.sender_id.user_id , math.floor(enabsizee))
totalypalice = tonumber(ballance) - tonumber(enab)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Tshak.."enabtime"..msg.sender_id.user_id,6020, true)
...
if Redis:get(Tshak.."zetontime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Tshak.."zetontime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر زيتون قبل 🫒\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر زيتون`","md",true)
end
if Redis:get(Tshak.."zetonnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر زيتون قبل 🫒\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر زيتون`","md",true)
end
...
Redis:set(Tshak.."zetonnum"..msg.sender_id.user_id , coniss)
zetonname = "زيتون"
Redis:set(Tshak.."zetonname"..msg.sender_id.user_id , zetonname)
mzroatsize = Redis:get(Tshak.."mzroatsize"..msg.sender_id.user_id) or 0
zetonsize = tonumber(coniss) * 15
zetonsizee = zetonsize + mzroatsize
Redis:set(Tshak.."mzroatsize"..msg.sender_id.user_id , math.floor(zetonsizee))
totalypalice = tonumber(ballance) - tonumber(zeton)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Tshak.."zetontime"..msg.sender_id.user_id,7220, true)
...
if Redis:get(Tshak.."mozztime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Tshak.."mozztime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر موز قبل 🍌\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر موز`","md",true)
end
if Redis:get(Tshak.."mozznum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر موز قبل 🍌\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر موز`","md",true)
end
...
Redis:set(Tshak.."mozznum"..msg.sender_id.user_id , coniss)
mozzname = "موز"
Redis:set(Tshak.."mozzname"..msg.sender_id.user_id , mozzname)
mzroatsize = Redis:get(Tshak.."mzroatsize"..msg.sender_id.user_id) or 0
mozzsize = tonumber(coniss) * 20
mozzsizee = mozzsize + mzroatsize
Redis:set(Tshak.."mzroatsize"..msg.sender_id.user_id , math.floor(mozzsizee))
totalypalice = tonumber(ballance) - tonumber(mozz)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Tshak.."mozztime"..msg.sender_id.user_id,8420, true)
...
if Redis:get(Tshak.."mangatime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(Tshak.."mangatime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر مانجا قبل 🥭\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر مانجا`","md",true)
end
if Redis:get(Tshak.."manganum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر مانجا قبل 🥭\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر مانجا`","md",true)
end
...
Redis:set(Tshak.."manganum"..msg.sender_id.user_id , coniss)
manganame = "مانجا"
Redis:set(Tshak.."manganame"..msg.sender_id.user_id , manganame)
mzroatsize = Redis:get(Tshak.."mzroatsize"..msg.sender_id.user_id) or 0
mangasize = tonumber(coniss) * 30
mangasizee = mangasize + mzroatsize
Redis:set(Tshak.."mzroatsize"..msg.sender_id.user_id , math.floor(mangasizee))
totalypalice = tonumber(ballance) - tonumber(manga)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(Tshak.."mangatime"..msg.sender_id.user_id,10220, true)
...
if not Redis:get(Tshak.."btatanum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
btatanum = Redis:get(Tshak.."btatanum"..msg.sender_id.user_id)
btata = tonumber(btatanum) * 100
btataa = tonumber(ballance) + tonumber(btata)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(btataa))
local convert_mony = string.format("%.0f",math.floor(btata))
...
if not Redis:get(Tshak.."lemonnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
lemonnum = Redis:get(Tshak.."lemonnum"..msg.sender_id.user_id)
lemon = tonumber(lemonnum) * 150
lemona = tonumber(ballance) + tonumber(lemon)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(lemona))
local convert_mony = string.format("%.0f",math.floor(lemon))
...
if not Redis:get(Tshak.."khessnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
khessnum = Redis:get(Tshak.."khessnum"..msg.sender_id.user_id)
khess = tonumber(khessnum) * 200
khessa = tonumber(ballance) + tonumber(khess)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(khessa))
local convert_mony = string.format("%.0f",math.floor(khess))
...
if not Redis:get(Tshak.."khearnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
khearnum = Redis:get(Tshak.."khearnum"..msg.sender_id.user_id)
khear = tonumber(khearnum) * 250
kheara = tonumber(ballance) + tonumber(khear)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(kheara))
local convert_mony = string.format("%.0f",math.floor(khear))
...
if not Redis:get(Tshak.."jzarnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
jzarnum = Redis:get(Tshak.."jzarnum"..msg.sender_id.user_id)
jzar = tonumber(jzarnum) * 300
jzara = tonumber(ballance) + tonumber(jzar)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(jzara))
local convert_mony = string.format("%.0f",math.floor(jzar))
...
if not Redis:get(Tshak.."fleflanum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
fleflanum = Redis:get(Tshak.."fleflanum"..msg.sender_id.user_id)
flefla = tonumber(fleflanum) * 350
fleflaa = tonumber(ballance) + tonumber(flefla)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(fleflaa))
local convert_mony = string.format("%.0f",math.floor(flefla))
...
if not Redis:get(Tshak.."freaznum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
freaznum = Redis:get(Tshak.."freaznum"..msg.sender_id.user_id)
freaz = tonumber(freaznum) * 475
freaza = tonumber(ballance) + tonumber(freaz)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(freaza))
local convert_mony = string.format("%.0f",math.floor(freaz))
...
if not Redis:get(Tshak.."doranum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
doranum = Redis:get(Tshak.."doranum"..msg.sender_id.user_id)
dora = tonumber(doranum) * 600
doraa = tonumber(ballance) + tonumber(dora)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(doraa))
local convert_mony = string.format("%.0f",math.floor(dora))
...
if not Redis:get(Tshak.."tomnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
tomnum = Redis:get(Tshak.."tomnum"..msg.sender_id.user_id)
tom = tonumber(tomnum) * 725
toma = tonumber(ballance) + tonumber(tom)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(toma))
local convert_mony = string.format("%.0f",math.floor(tom))
...
if not Redis:get(Tshak.."ftrnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
ftrnum = Redis:get(Tshak.."ftrnum"..msg.sender_id.user_id)
ftr = tonumber(ftrnum) * 800
ftra = tonumber(ballance) + tonumber(ftr)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(ftra))
local convert_mony = string.format("%.0f",math.floor(ftr))
...
if not Redis:get(Tshak.."tfahnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
tfahnum = Redis:get(Tshak.."tfahnum"..msg.sender_id.user_id)
tfah = tonumber(tfahnum) * 1200
tfaha = tonumber(ballance) + tonumber(tfah)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(tfaha))
local convert_mony = string.format("%.0f",math.floor(tfah))
...
if not Redis:get(Tshak.."enabnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
enabnum = Redis:get(Tshak.."enabnum"..msg.sender_id.user_id)
enab = tonumber(enabnum) * 1500
enaba = tonumber(ballance) + tonumber(enab)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(enaba))
local convert_mony = string.format("%.0f",math.floor(enab))
...
if not Redis:get(Tshak.."zetonnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
zetonnum = Redis:get(Tshak.."zetonnum"..msg.sender_id.user_id)
zeton = tonumber(zetonnum) * 1800
zetona = tonumber(ballance) + tonumber(zeton)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(zetona))
local convert_mony = string.format("%.0f",math.floor(zeton))
...
if not Redis:get(Tshak.."mozznum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
mozznum = Redis:get(Tshak.."mozznum"..msg.sender_id.user_id)
mozz = tonumber(mozznum) * 2500
mozza = tonumber(ballance) + tonumber(mozz)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(mozza))
local convert_mony = string.format("%.0f",math.floor(mozz))
...
if not Redis:get(Tshak.."manganum"..msg.sender_id.user_id) then
...
ballance = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
manganum = Redis:get(Tshak.."manganum"..msg.sender_id.user_id)
manga = tonumber(manganum) * 3500
mangaa = tonumber(ballance) + tonumber(manga)
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(mangaa))
local convert_mony = string.format("%.0f",math.floor(manga))
...
if Redis:ttl(Tshak.."yiioooo" .. msg.sender_id.user_id) >=60 then
local hours = Redis:ttl(Tshak.."yiioooo" .. msg.sender_id.user_id) / 60
...
Redis:set(Tshak.."boob"..msg.sender_id.user_id , knez)
local ballancee = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
send(msg.chat_id,msg.id,""..neews.." لقد وجدت كنز\n⇜ الكنز : قطعة اثرية 🗳\n⇜ سعره : 40000 درهم 💵\n⇜ رصيدك الان : "..convert_mony.." درهم 💵\n✧","md",true)
Redis:setex(Tshak.."yiioooo" .. msg.sender_id.user_id,1800, true)
elseif Descriptioont == "2" then
...
bot.sendAudio(msg.chat_id,msg.id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@botatiiii")
sleep(1)
...
local coniss = coin(UserName)
if msg.ControllerBot then
Redis:set(Tshak.."bandid"..coniss,coniss)
...
local coniss = coin(UserName)
if msg.ControllerBot then
Redis:set(Tshak.."morakba"..coniss,coniss)
local ban = bot.getUser(coniss)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
local coniss = coin(UserName)
if msg.ControllerBot then
Redis:del(Tshak.."morakba"..coniss)
local ban = bot.getUser(coniss)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
Redis:set(Tshak.."cobonum"..numcobo,numcobo)
Redis:set(Tshak.."cobon"..numcobo,coniss)
...
cobnum = Redis:get(Tshak.."cobonum"..coniss)
if coniss == tonumber(cobnum) then
cobblc = Redis:get(Tshak.."cobon"..coniss)
ballancee = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
cobonplus = ballancee + cobblc
Redis:set(Tshak.."boob"..msg.sender_id.user_id , cobonplus)
local ballancee = Redis:get(Tshak.."boob"..msg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
Redis:del(Tshak.."cobon"..coniss)
Redis:del(Tshak.."cobonum"..coniss)
send(msg.chat_id,msg.id, "⌯ وصل كوبون \n\n⇜ المبلغ : "..cobblc.." درهم 💵\n⇜ رقم الكوبون : `"..coniss.."`\n⇜ رصيدك الان : `"..convert_mony.."` درهم 💵\n✧","md",true)
else
...
Redis:set(Tshak.."boob"..Remsg.sender_id.user_id , bajiop)
ccccc = Redis:get(Tshak.."boobb"..Remsg.sender_id.user_id)
uuuuu = Redis:get(Tshak.."bbobb"..Remsg.sender_id.user_id)
ppppp = Redis:get(Tshak.."rrfff"..Remsg.sender_id.user_id) or 0
ballanceed = Redis:get(Tshak.."boob"..Remsg.sender_id.user_id) or 0
...
Redis:set(Tshak.."tdbelballance"..msg.sender_id.user_id , coniss)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ همس ماعنده حساب بالبنك ","md",true)  
return false
end
if Redis:sismember(Tshak.."booob",Remsg.sender_id.user_id) then
ballanceed = Redis:get(Tshak.."boob"..Remsg.sender_id.user_id) or 0
...
if text == 'تبرع' then
if Redis:ttl(Tshak.."tabrotime" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(Tshak.."tabrotime" .. msg.sender_id.user_id))
...
local user_name = bot.getUser(winner_id).first_name or Redis:get(Tshak..winner_id.."first_name:") or "لا يوجد اسم"
tt =  "["..user_name.."]("..user_name..")"
...
Redis:set(Tshak.."boob"..msg.sender_id.user_id , math.floor(byre))
taeswq = Redis:get(Tshak.."tabbroat"..msg.sender_id.user_id) or 0
pokloo = tonumber(taeswq) + tonumber(coniss)
Redis:set(Tshak.."tabbroat"..msg.sender_id.user_id , math.floor(pokloo))
ballanceeed = Redis:get(Tshak.."boob"..winner_id) or 0
tekash = tonumber(ballanceeed) + tonumber(coniss)
Redis:set(Tshak.."boob"..winner_id , tonumber(tekash))
ballanceeed = Redis:get(Tshak.."boob"..winner_id) or 0
Redis:sadd(Tshak.."taza",msg.sender_id.user_id)
Redis:setex(Tshak.."tabrotime" .. msg.sender_id.user_id,600, true)
...
if Redis:sismember(Tshak.."booob",msg.sender_id.user_id) then
ballancee = Redis:get(Tshak.."tabbroat"..msg.sender_id.user_id) or 0
if tonumber(ballancee) < 1 then
...
ballancee = Redis:get(Tshak.."tabbroat"..msg.sender_id.user_id) or 0
local bank_users = Redis:smembers(Tshak.."taza")
if #bank_users == 0 then
return send(msg.chat_id,msg.id,"⇜ لا يوجد حسابات في البنك","md",true)
end
...
tabr_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(Tshak.."tabbroat"..v)
