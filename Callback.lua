...
if plugin and plugin.Tshak and msg then
results = plugin.Tshak(msg)
end
end
...
if data.actor_user_id == UserCheck and tonumber(Tshak) ~= UserCheck then
local Get_Chat = bot.getChat(data.chat_id)
local Info_Chats = bot.getSupergroupFullInfo(data.chat_id)
local UserInfo = bot.getUser(data.actor_user_id)
...
if not Redis:get(Tshak.."gdbye"..data.chat_id) then
if data.actor_user_id == UserCheck and tonumber(Tshak) ~= UserCheck then
local Get_Chat = bot.getChat(data.chat_id)
local Info_Chats = bot.getSupergroupFullInfo(data.chat_id)
local UserInfo = bot.getUser(data.actor_user_id)
...
if data.new_chat_member.member_id.user_id == tonumber(Tshak) or data.old_chat_member.member_id.user_id == tonumber(Tshak) then
...
--code start
if Redis:sismember(Tshak..'Black:listBan:',chat_id) then ---check if ban
...
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Tshak..'Tshak:Num:Add:Bot') or 0)) then
send(chat_id,0,'• عدد الاعضاء قليل لا يمكن تفعيل القروب\n يجب ان يكون اكثر من '..Redis:get(Tshak..'Tshak:Num:Add:Bot'),"md",true)
bot.leaveChat(chat_id)
end---end check if count is true
if not Redis:get(Tshak.."Tshak:BotFree") then
return send(chat_id,0,"\n⇜ الوضع الخدمي تم تعطيله من قبل مطور البوت ","md",true)  
end
if not Redis:sismember(Tshak.."Tshak:ChekBotAdd", chat_id) then ---done active
...
-----
Redis:set(Tshak.."Tshak:Alzwag:Chat"..chat_id,"true")
Redis:set(Tshak.."Tshak:Aldel:Chat"..chat_id,"true")
Redis:set(Tshak.."NSFW:"..chat_id,"true")
Redis:set(Tshak..'tagallgroup'..chat_id,'open') 
Redis:set(Tshak.."Tshak:Status:Link"..chat_id,true) 
Redis:set(Tshak.."Tshak:Status:Games"..chat_id,true) 
Redis:set(Tshak.."replayallbot"..chat_id,true)
Redis:set(Tshak.."rebomsg"..chat_id,true)
Redis:set(Tshak.."Tshak:AlThther:Chat"..chat_id,"true")
Redis:set(Tshak.."Tshak:Status:Welcome"..chat_id,true) 
Redis:set(Tshak.."Tshak:AlThther:Chat"..chat_id,"true")
Redis:set(Tshak..'tagall@all'..chat_id,'open') 
Redis:set(Tshak.."Tshak:Status:IdPhoto"..chat_id,true) 
Redis:del(Tshak.."spammkick"..chat_id)
Redis:set(Tshak.."Tshak:Lock:edit"..chat_id,true) 
Redis:sadd(Tshak.."Tshak:ChekBotAdd",chat_id)
Redis:set(Tshak.."Tshak:Status:Id"..chat_id,true)
Redis:set(Tshak.."Tshak:Status:Reply"..chat_id,true)
Redis:set(Tshak.."Tshak:Status:ReplySudo"..chat_id,true)
Redis:set(Tshak.."Tshak:Status:BanId"..chat_id,true)
Redis:set(Tshak.."Tshak:Status:SetId"..chat_id,true) 
-----
...
Redis:sadd(Tshak.."Tshak:TheBasicsQ:Group"..chat_id ,v.member_id.user_id) 
else
Redis:sadd(Tshak.."Tshak:Addictive:Group"..chat_id ,v.member_id.user_id) 
end
end
end
-----
...
local inget = Redis:get(Tshak..'hmsabots'..ramsesadd[3]..data.sender_user_id)
...
Redis:set(Tshak..'hmsabots'..idnum..UserId_Info.id,username[1])
Redis:set(Tshak..'hmsabots'..idnum..data.sender_user_id,username[1])
end
end
end
...
Redis:srem(Tshak.."Tshak:ChekBotAdd",'-100'..data.supergroup.id)
...
Redis:sadd(Tshak.."Tshak:all:sticker"..msg.chat_id, msg.id)
Redis:scard(Tshak.."Tshak:all:sticker"..msg.chat_id)  
end
if msg.content.video_note or msg.content.video then
Redis:sadd(Tshak.."Tshak:all:video"..msg.chat_id, msg.id)
Redis:scard(Tshak.."Tshak:all:video"..msg.chat_id)  
end
if msg.content.document then
Redis:sadd(Tshak.."Tshak:all:docu"..msg.chat_id, msg.id)
Redis:scard(Tshak.."Tshak:all:docu"..msg.chat_id)  
end
if msg.content.audio then
Redis:sadd(Tshak.."Tshak:all:audio"..msg.chat_id, msg.id)
Redis:scard(Tshak.."Tshak:all:audio"..msg.chat_id)  
end
if msg.content.voice_note then
Redis:sadd(Tshak.."Tshak:all:voice"..msg.chat_id, msg.id)
Redis:scard(Tshak.."Tshak:all:voice"..msg.chat_id)  
end
if msg.content.photo then
Redis:sadd(Tshak.."Tshak:all:photo"..msg.chat_id, msg.id)
Redis:scard(Tshak.."Tshak:all:photo"..msg.chat_id)  
end
if msg.content.animation then
Redis:sadd(Tshak.."Tshak:all:anim"..msg.chat_id, msg.id)
Redis:scard(Tshak.."Tshak:all:anim"..msg.chat_id)  
end
if msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
Redis:sadd(Tshak.."Tshak:allM"..msg.chat_id, msg.id)
if Redis:get(Tshak.."Tshak:Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(Tshak.."Tshak:allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(Tshak.."Tshak:allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(Tshak.."Tshak:allM"..msg.chat_id)
...
Redis:del(Tshak.."Tshak:allM"..msg.chat_id)
end
end
end
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(Tshak.."Tshak:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tshak.."Tshak:PinMsegees:"..msg.chat_id)
end
...
if idPhoto == Redis:get(Tshak.."Tshak:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tshak.."Tshak:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(Tshak.."Tshak:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tshak.."Tshak:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(Tshak.."Tshak:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tshak.."Tshak:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(Tshak.."Tshak:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tshak.."Tshak:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(Tshak.."Tshak:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tshak.."Tshak:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(Tshak.."Tshak:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tshak.."Tshak:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(Tshak.."Tshak:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tshak.."Tshak:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(Tshak.."Tshak:PinMsegees:"..msg.chat_id) then
bot.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Tshak.."Tshak:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(Tshak.."Tshak:Lock:tagservr"..data.message.chat_id) then
bot.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender_user_id) == tonumber(Tshak) then
return false
end
if chat_type(data.message.chat_id) == "GroupBot" and Redis:sismember(Tshak.."Tshak:ChekBotAdd",data.message.chat_id) then
 msg = data.message
...
if tonumber(msg.sender_id.user_id) == tonumber(Tshak) then
print('This is reply for Bot')
return false
end
if msg.sender_id.luatele == "messageSenderChat" then
if Redis:sismember(Tshak.."Tshak:SilentGroup:Group"..msg_chat_id,msg.sender_id.chat_id) then
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
end
if Redis:get(Tshak.."Tshak:Lock:SenderChat"..msg_chat_id) then
local m = Redis:get(Tshak.."chadmin"..msg_chat_id) 
...
elseif Redis:sismember(Tshak.."Tshak:DevelopersQ:Groups",msg.sender_id.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'Myth🎖️️'
elseif Redis:sismember(Tshak.."Tshak:Developers:Groups",msg.sender_id.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Tshak..'Tshak:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Tshak.."Tshak:Developer:Bot:Reply"..msg.chat_id) or 'Myth'
elseif Redis:sismember(Tshak.."Tshak:MalekAsase:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 444
msg.Name_Controller = Redis:get(Tshak..'Tshak:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Tshak.."Tshak:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(Tshak.."Tshak:TheBasicsQ:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(Tshak..'Tshak:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Tshak.."Tshak:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(Tshak.."Tshak:TheBasics:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Tshak..'Tshak:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Tshak.."Tshak:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(Tshak.."Tshak:Originators:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Tshak..'Tshak:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Tshak.."Tshak:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ'
elseif Redis:sismember(Tshak.."Tshak:Managers:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Tshak..'Tshak:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Tshak.."Tshak:Manager:Group:Reply"..msg.chat_id) or 'المدير'
elseif Redis:sismember(Tshak.."Tshak:Addictive:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Tshak..'Tshak:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Tshak.."Tshak:Admin:Group:Reply"..msg.chat_id) or 'الادمن'
elseif Redis:sismember(Tshak.."Tshak:Distinguished:Group"..msg.chat_id,msg.sender_id.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Tshak..'Tshak:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Tshak.."Tshak:Vip:Group:Reply"..msg.chat_id) or 'مميز'
elseif tonumber(msg.sender_id.user_id) == tonumber(Tshak) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Tshak..'Tshak:SetRt'..msg.chat_id..':'..msg.sender_id.user_id) or Redis:get(Tshak.."Tshak:Mempar:Group:Reply"..msg.chat_id) or 'عضو'
end  
...
if Message_Edit.sender_id.user_id == Tshak then
...
data.The_Controller = 1
elseif Redis:sismember(Tshak.."Tshak:DevelopersQ:Groups",Message_Edit.sender_id.user_id) == true then
data.The_Controller = 2
elseif Redis:sismember(Tshak.."Tshak:Developers:Groups",Message_Edit.sender_id.user_id) == true then
data.The_Controller = 3
elseif Redis:sismember(Tshak.."Tshak:TheBasicsQ:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 44
elseif Redis:sismember(Tshak.."Tshak:TheBasics:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 4
elseif Redis:sismember(Tshak.."Tshak:Originators:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 5
elseif Redis:sismember(Tshak.."Tshak:Managers:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 6
elseif Redis:sismember(Tshak.."Tshak:Addictive:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 7
elseif Redis:sismember(Tshak.."Tshak:Distinguished:Group"..data.chat_id,Message_Edit.sender_id.user_id) == true then
data.The_Controller = 8
elseif tonumber(Message_Edit.sender_id.user_id) == tonumber(Tshak) then
...
local monsha = Redis:smembers(Tshak.."Tshak:TheBasicsQ:Group"..data.chat_id) 
Redis:incr(Tshak..'Tshak:Num:Message:Edit'..data.chat_id..Message_Edit.sender_id.user_id)
if Message_Edit.content.luatele == "messageText" then
if Redis:get(Tshak.."Tshak:Lock:edittext"..data.chat_id) then
if not data.Distinguished then
bot.deleteMessages(data.chat_id,{[1]= data.message_id})
if Redis:get(Tshak..'Tshak:AlThther:Chat'..data.chat_id)  then
local UserInfo = bot.getUser(Message_Edit.sender_id.user_id)
...
if not data.Originators and Message_Edit.sender_id.user_id ~= tonumber(Tshak) then
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(Tshak.."Tshak:Lock:edit"..data.chat_id) then
if #monsha ~= 0 then 
...
data.The_Controller = 1
elseif Redis:sismember(Tshak.."Tshak:DevelopersQ:Groups",IdUser) == true then
data.The_Controller = 2
elseif Redis:sismember(Tshak.."Tshak:Developers:Groups",IdUser) == true then
data.The_Controller = 3
elseif Redis:sismember(Tshak.."Tshak:TheBasicsQ:Group"..ChatId,IdUser) == true then
data.The_Controller = 44
elseif Redis:sismember(Tshak.."Tshak:TheBasics:Group"..ChatId,IdUser) == true then
data.The_Controller = 4
elseif Redis:sismember(Tshak.."Tshak:Originators:Group"..ChatId,IdUser) == true then
data.The_Controller = 5
elseif Redis:sismember(Tshak.."Tshak:Managers:Group"..ChatId,IdUser) == true then
data.The_Controller = 6
elseif Redis:sismember(Tshak.."Tshak:Addictive:Group"..ChatId,IdUser) == true then
data.The_Controller = 7
elseif Redis:sismember(Tshak.."Tshak:Distinguished:Group"..ChatId,IdUser) == true then
data.The_Controller = 8
elseif tonumber(IdUser) == tonumber(Tshak) then
data.The_Controller = 9
else
data.The_Controller = 10
end  
...
local get = Redis:get(Tshak..IdUser..ChatId.."num")
if get then
tf = get 
else
tf = "" 
...
local txx = tf..num
Redis:set(Tshak..IdUser..ChatId.."num",txx)
...
if tonumber(IdUser) == tonumber(sendrr) then
local math = Redis:get(Tshak..IdUser..ChatId.."num")
if math then
...
Redis:del(Tshak..IdUser..ChatId.."num")
else
bot.answerCallbackQuery(data.id, "• الامر لا يخصك", true)
end
end
...
Redis:set(Tshak..IdUser..ChatId.."num",gxx)
...
local chat_id = Redis:get(Tshak.."hms:"..anubis[2].."chat_id")
local to_id = Redis:get(Tshak.."hms:"..anubis[2].."to")
local msg_id = Redis:get(Tshak.."hms:"..anubis[2].."msg_id")
...
Redis:del(Tshak.."hms:"..anubis[1])
end
end
if Text and Text:match('(.*)hms_no(.*)') then
local anubis = {Text:match('(.*)hms_no(.*)')}
if tonumber(IdUser) == tonumber(anubis[1]) then
Redis:del(Tshak.."hms:"..anubis[2].."chat_id")
Redis:del(Tshak.."hms:"..anubis[2].."to")
Redis:del(Tshak.."hms:"..anubis[2].."msg_id")
Redis:del(Tshak.."hms:"..anubis[1])
...
local hmsa = Redis:get(Tshak.."hms:"..anubis[3].."text:")
...
var(UserId)
Redis:set(Tshak.."zogte"..ChatId..UserId[1],UserId[2])
Redis:set(Tshak.."zogte"..ChatId..UserId[2],UserId[1])
Redis:sadd(Tshak.."zogatall"..ChatId,UserId[1])
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:del(Tshak.."zogte"..ChatId..UserId[1])
Redis:del(Tshak.."zogte"..ChatId..UserId[2])
Redis:srem(Tshak.."zogatall"..ChatId,UserId[1])
local UserInfo = bot.getUser(UserId[1])
...
Redis:srem(Tshak.."Tshak:Distinguished:Group"..ChatId,IdUser)
Redis:srem(Tshak.."Tshak:Addictive:Group"..ChatId,IdUser)
Redis:srem(Tshak.."Tshak:Managers:Group"..ChatId,IdUser)
Redis:srem(Tshak.."Tshak:Originators:Group"..ChatId,IdUser)
Redis:srem(Tshak.."Tshak:TheBasics:Group"..ChatId,IdUser)
Redis:srem(Tshak.."Tshak:Developers:Groups",IdUser) 
Redis:srem(Tshak.."Tshak:TheBasicsQ:Group"..ChatId,IdUser)
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Tshak.."Tshak:TheBasics:Group"..ChatId,UserId[2]) then
Redis:srem(Tshak.."Tshak:TheBasics:Group"..ChatId,UserId[2])
else
Redis:sadd(Tshak.."Tshak:TheBasics:Group"..ChatId,UserId[2])
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then 
if Redis:sismember(Tshak.."Tshak:Originators:Group"..ChatId,UserId[2]) then
Redis:srem(Tshak.."Tshak:Originators:Group"..ChatId,UserId[2])
else
Redis:sadd(Tshak.."Tshak:Originators:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Tshak.."Tshak:Managers:Group"..ChatId,UserId[2]) then
Redis:srem(Tshak.."Tshak:Managers:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(Tshak.."Tshak:Status:SetId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ تم تعطيل ( الرفع ) من قبل المنشئين",true)
end 
Redis:sadd(Tshak.."Tshak:Managers:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Tshak.."Tshak:Addictive:Group"..ChatId,UserId[2]) then
Redis:srem(Tshak.."Tshak:Addictive:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(Tshak.."Tshak:Status:SetId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ تم تعطيل ( الرفع ) من قبل المنشئين",true)
end 
Redis:sadd(Tshak.."Tshak:Addictive:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
if Redis:sismember(Tshak.."Tshak:Distinguished:Group"..ChatId,UserId[2]) then
Redis:srem(Tshak.."Tshak:Distinguished:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(Tshak.."Tshak:Status:SetId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ تم تعطيل ( الرفع ) من قبل المنشئين",true)
end 
Redis:sadd(Tshak.."Tshak:Distinguished:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
...
Redis:srem(Tshak.."Tshak:Originators:Group"..ChatId,UserId[2])
Redis:srem(Tshak.."Tshak:TheBasics:Group"..ChatId,UserId[2])
Redis:srem(Tshak.."Tshak:SilentGroup:Group"..ChatId,UserId[2])
Redis:srem(Tshak.."Tshak:BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(Tshak.."Tshak:BanGroup:Group"..ChatId,UserId[2]) then
Redis:srem(Tshak.."Tshak:BanGroup:Group"..ChatId,UserId[2])
bot.setChatMemberStatus(ChatId,UserId[2],'restricted',{1,1,1,1,1,1,1,1,1})
else
if not data.Originators and not Redis:get(Tshak.."Tshak:Status:BanId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ ( الحظر - الطرد - التقييد ) معطل من قبل المنشئين",true)
end 
Redis:sadd(Tshak.."Tshak:BanGroup:Group"..ChatId,UserId[2])
...
if Redis:sismember(Tshak.."Tshak:SilentGroup:Group"..ChatId,UserId[2]) then
Redis:srem(Tshak.."Tshak:SilentGroup:Group"..ChatId,UserId[2])
else
if not data.Originators and not Redis:get(Tshak.."Tshak:Status:BanId"..ChatId) then
return bot.answerCallbackQuery(data.id,"⇜ ( الحظر - الطرد - التقييد ) معطل من قبل المنشئين",true)
end 
Redis:sadd(Tshak.."Tshak:SilentGroup:Group"..ChatId,UserId[2])
end
return editrtp(ChatId,UserId[1],Msg_id,UserId[2])
end
end
if Text and Text:match('/keyhzr') then
local list = Redis:smembers(Tshak..'List_hzr'..ChatId) 
nameko = list[#list]
playerhzr = Redis:get(Tshak..'playerhzr'..ChatId)
klmahzr = Redis:get(Tshak..'klmahzr'..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Command:Reids:Group:Del"..ChatId..":"..IdUser)
Redis:del(Tshak.."Tshak:Command:Reids:Group"..ChatId..":"..IdUser)
Redis:del(Tshak.."Tshak:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Tshak.."Tshak:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Tshak.."Tshak:Set:Rd"..IdUser..":"..ChatId)
Redis:del(Tshak.."Tshak:Set:On"..IdUser..":"..ChatId)
Redis:del(Tshak.."Set:array:Ssd"..IdUser..":"..ChatId)
Redis:del(Tshak.."Set:array:rd"..IdUser..":"..ChatId)
Redis:del(Tshak.."Set:array"..IdUser..":"..ChatId)
Redis:del(Tshak.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Tshak.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Tshak.."Set:Rd"..IdUser..":"..ChatId)
Redis:del(Tshak.."Set:On"..IdUser..":"..ChatId)
Redis:del(Tshak.."Set:Manager:rd:inline"..IdUser..":"..ChatId)
Redis:del(Tshak.."Set:On:mz"..IdUser..":"..ChatId)
Redis:del(Tshak.."Set:Rd:mz"..IdUser..":"..ChatId)
Redis:del(Tshak.."Set:Onmzch"..IdUser..":"..ChatId)
Redis:del(Tshak.."Set:Rdmzch"..IdUser..":"..ChatId)
Redis:del(Tshak.."Set:Manager:rd:inline3am"..IdUser..":"..ChatId)
...
if Redis:get(Tshak..'Set:arrayy'..IdUser..':'..ChatId) == 'true1' then
Redis:del(Tshak..'Set:arrayy'..IdUser..':'..ChatId)
...
if Redis:get(Tshak..'Set:array'..IdUser..':'..ChatId) == 'true1' then
Redis:del(Tshak..'Set:array'..IdUser..':'..ChatId)
edit(ChatId,Msg_id,"⇜ تم حفظ الردود ", 'md', true, false, reply_markup)
else
edit(ChatId,Msg_id,"⇜ تم تنفيذ الامر سابقاًً", 'md', true, false, reply_markup)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."spammkick"..ChatId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."kadmeat"..ChatId)
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak..'lock_geamsAudio1'..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak..'lock_geamsAudio'..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak..'tagall@all'..ChatId,'open')
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak..'lock_chengname'..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."trfeh"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."spammkick"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."kadmeat"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."knele"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."brjj"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak..'lock_geamsAudio1'..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak..'lock_geamsAudio'..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak..'tagall@all'..ChatId,'close')
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak..'lock_chengname'..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
Redis:incrby(Tshak.."Tshak:Num:Add:Games"..ChatId..IdUser,3)  
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(Tshak.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(Tshak.."meza:type"..meza_name, "photo")
Redis:sadd(Tshak.."meza:names:", meza_name)
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(Tshak.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(Tshak.."meza:type"..meza_name, "video")
Redis:sadd(Tshak.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(Tshak.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(Tshak.."meza:type"..meza_name, "audio")
Redis:sadd(Tshak.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(Tshak.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(Tshak.."meza:type"..meza_name, "animation")
Redis:sadd(Tshak.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
...
if tonumber(IdUser) == tonumber(UserId) then
local meza_name = Redis:get(Tshak.."add_meza:name:"..ChatId..":"..IdUser)
Redis:set(Tshak.."meza:type"..meza_name, "sticker")
Redis:sadd(Tshak.."meza:names:", meza_name)
return edit(ChatId, Msg_id, "⇜ تم حفظ الميزة","md",false)
end end
if Text == '/joineloceagin' then
local list = Redis:smembers(Tshak..'loce:list'..ChatId) 
...
Redis:set(Tshak..'loce:listset1'..ChatId,xxffxx1)
Redis:srem(Tshak..'loce:list'..ChatId,name1)
Redis:incrby(Tshak.."Tshak:Num:Add:Games"..ChatId..name1,3)  
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local get1 = Redis:get(Tshak..'loce:listset'..ChatId)
local get2 = Redis:get(Tshak..'loce:listset1'..ChatId)

Redis:del(Tshak..'loce:list'..ChatId) 
Redis:del(Tshak..'loce:listset'..ChatId)
Redis:del(Tshak..'loce:listset1'..ChatId)
return edit(ChatId,Msg_id,get1..'\n'..get2..'\n'..xxffxx1..'\n', 'md', true)
end
if Text == '/joineloce' then
if not Redis:sismember(Tshak..'loce:list'..ChatId,IdUser) then 
Redis:sadd(Tshak..'loce:list'..ChatId,IdUser)
local list = Redis:smembers(Tshak..'loce:list'..ChatId) 
if #list == 3 then
name1 = list[math.random(#list)]
local UserInfo1 = bot.getUser(name1)
...
Redis:set(Tshak..'loce:listset'..ChatId,xxffxx1)
Redis:srem(Tshak..'loce:list'..ChatId,name1)
Redis:incrby(Tshak.."Tshak:Num:Add:Games"..ChatId..name1,5)  
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local list = Redis:smembers(Tshak..'rolet:list'..ChatId)
name = list[math.random(#list)]
local UserInfo = bot.getUser(name)
local Teext = '- ['..UserInfo.first_name..'](tg://user?id='..name..')'
Redis:srem(Tshak..'rolet:list'..ChatId,name)
if #list == 1 then
Redis:srem(Tshak..'rolet:list'..ChatId,name)
Redis:incrby(Tshak.."Tshak:Num:Add:Games"..ChatId..IdUser,10)  
...
if not Redis:sismember(Tshak..'rolet:list'..ChatId,IdUser) then 
Redis:sadd(Tshak..'rolet:list'..ChatId,IdUser)
local list = Redis:smembers(Tshak..'rolet:list'..ChatId) 
if #list == 3 then
...
Redis:sadd(Tshak.."Tshak:SilentGroup:Group"..ChatId,GetUserReply[1]) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local UserInfo = bot.getUser(GetUserReply[1])
local Teext = ' ['..UserInfo.first_name..'](tg://user?id='..GetUserReply[1]..')'
Redis:sadd(Tshak.."Tshak:BanGroup:Group"..ChatId,GetUserReply[1]) 
...
Redis:srem(Tshak.."Tshak:Distinguished:Group"..ChatId,GetUserReply[1]) 
...
Redis:srem(Tshak.."Tshak:BanGroup:Group"..ChatId,GetUserReply[1]) 
Redis:srem(Tshak.."Tshak:SilentGroup:Group"..ChatId,GetUserReply[1]) 
...
if Redis:sismember(Tshak.."Tshak:Num:okiktm"..ChatId, IdUser) then
return bot.answerCallbackQuery(data.id, "⇜ قمت بالتصويت مسبقاً", true)
end
Redis:sadd(Tshak.."Tshak:Num:okiktm"..ChatId, IdUser)  
local list = Redis:smembers(Tshak.."Tshak:Num:okiktm"..ChatId)
if #list >= tonumber(3) then
Redis:del(Tshak.."Tshak:Num:okiktm"..ChatId)
...
Redis:sadd(Tshak.."Tshak:SilentGroup:Group"..ChatId,GetUserReply) 
end
...
local UserInfo = bot.getUser(GetUserReply)
local Teext = ' ['..UserInfo.first_name..'](tg://user?id='..GetUserReply..')'
if Redis:sismember(Tshak.."Tshak:Num:noiktm"..ChatId, IdUser) then
return bot.answerCallbackQuery(data.id, "⇜ قمت بالتصويت مسبقاً", true)
end
Redis:sadd(Tshak.."Tshak:Num:noiktm"..ChatId, IdUser)  
local list = Redis:smembers(Tshak.."Tshak:Num:noiktm"..ChatId)
if #list >= tonumber(3) then
Redis:del(Tshak.."Tshak:Num:noiktm"..ChatId)
Redis:srem(Tshak.."Tshak:SilentGroup:Group"..ChatId,GetUserReply) 
...
⌔ ارسل ما تريد تحميله
*]]
Redis:set(Tshak.."youtube"..IdUser..ChatId,'mp3')
...
⌔ ارسل ما تريد تحميله
*]]
Redis:set(Tshak.."youtube"..IdUser..ChatId,'mp4')
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
if Text and Text:match('(.*)/yes_z/(.*)') then
  ...
  if tonumber(zwga_id) == tonumber(IdUser) then
    ...
    Redis:set(Tshak..ChatId..zwga_id.."mtzwga:", zwg_id)
    Redis:set(Tshak..ChatId..zwg_id.."mtzwga:", zwga_id)
...
if Text and Text:match('(%d+)/zeng') then
  ...
  if tonumber(UserId) == tonumber(IdUser) then
    Redis:set(Tshak..ChatId..IdUser.."zkrf:", "zeng")
...
if name == "✂" then
Redis:incrby(Tshak.."Tshak:Num:Add:Games"..ChatId..IdUser, 1)  
...
if Redis:get(Tshak.."zwag_request:"..Data[1]) then
...
ballancee = Redis:get(Tshak.."boob"..zwg_id) or 0
ballanceea = Redis:get(Tshak.."boob"..zwga_id) or 0
zogtea = ballanceea + ballanceekkk
zeugh = ballancee - tonumber(coniss)
Redis:set(Tshak.."boob"..zwg_id , math.floor(zeugh))
Redis:sadd(Tshak.."roogg1",zwg_id)
Redis:sadd(Tshak.."roogga1",zwga_id)
Redis:set(Tshak.."roog1"..zwg_id,zwg_id)
Redis:set(Tshak.."rooga1"..zwg_id,zwga_id)
Redis:set(Tshak.."roogte1"..zwga_id,zwga_id)
Redis:set(Tshak.."rahr1"..zwg_id,tonumber(coniss))
Redis:set(Tshak.."rahr1"..zwga_id,tonumber(coniss))
Redis:set(Tshak.."roog1"..zwga_id,zwg_id)
Redis:set(Tshak.."rahrr1"..zwg_id,math.floor(ballanceekkk))
Redis:set(Tshak.."rooga1"..zwga_id,zwga_id)
Redis:set(Tshak.."rahrr1"..zwga_id,math.floor(ballanceekkk))
...
Redis:del(Tshak.."zwag_request:"..UserId[1])
Redis:del(Tshak.."zwag_request:"..UserId[2])
...
Redis:set(Tshak..data.sender_user_id.."first_name:", F_Name)
...
ballancee = Redis:get(Tshak.."tabbroat"..data.sender_user_id) or 0
...
zrfee = Redis:get(Tshak.."rrfff"..data.sender_user_id) or 0
...
ballancee = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
doltebank = "🇸🇾"
Redis:set(Tshak.."doltebank"..data.sender_user_id,doltebank)
cccall = Redis:get(Tshak.."boobb"..data.sender_user_id)
ccctype = Redis:get(Tshak.."bbobb"..data.sender_user_id)
shakse = Redis:get(Tshak.."shkse"..data.sender_user_id)
if shakse == "طيبة" then
shakseshakse = "طيبة 😇"
else
shakseshakse = "شريرة 😈"
end
msalm = "⇜ وسوينا لك حساب في بنك همس\n⇜ وشحنالك ٥٠ درهم 💸 هديه\n\n⇜ رقم حسابك ↤ ❲ `"..cccall.."` ❳\n⇜ نوع البطاقة ↤ ❲ "..ccctype.." ❳\n⇜ فلوسك ↤ ❲ 50 ريال 💸 ❳\n⇜ شخصيتك ↤ "..shakseshakse.."\n⇜ دولتك ↤ ❲ 🇸🇾 ❳"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
Redis:del(Tshak..'SetChannelVip'..IdUser)
...
Redis:set(Tshak..'SetChannelVip'..IdUser,true)
...
if Redis:get(Tshak..'SetChannelVip'..IdUser) then 
if text =='الغاء' then 
...
Redis:del(Tshak..'SetChannelVip'..IdUser)
Redis:set(Tshak..'SOFI:Channel:Vip'..IdUser,text)
...
Redis:del(Tshak..'SOFI:Channel:Vip'..IdUser)
Text = "⇜ تم حذف قناتك"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
shakse = "طيبة"
Redis:set(Tshak.."shkse"..data.sender_user_id,shakse)
ttshakse = '⇜ اختر دولتك'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
Redis:set(Tshak.."bobna"..data.sender_user_id,news)
Redis:set(Tshak.."boob"..data.sender_user_id,balas)
Redis:set(Tshak.."boobb"..data.sender_user_id,creditcc)
Redis:set(Tshak.."bbobb"..data.sender_user_id,mast)
Redis:set(Tshak.."boballname"..creditcc,news)
Redis:set(Tshak.."boballbalc"..creditcc,balas)
Redis:set(Tshak.."boballcc"..creditcc,creditcc)
Redis:set(Tshak.."boballban"..creditcc,mast)
Redis:set(Tshak.."boballid"..creditcc,banid)
Redis:sadd(Tshak.."booob",data.sender_user_id)
...
Redis:set(Tshak.."bobna"..data.sender_user_id,news)
Redis:set(Tshak.."boob"..data.sender_user_id,balas)
Redis:set(Tshak.."boobb"..data.sender_user_id,creditvi)
Redis:set(Tshak.."bbobb"..data.sender_user_id,visssa)
Redis:set(Tshak.."boballname"..creditvi,news)
Redis:set(Tshak.."boballbalc"..creditvi,balas)
Redis:set(Tshak.."boballcc"..creditvi,creditvi)
Redis:set(Tshak.."boballban"..creditvi,visssa)
Redis:set(Tshak.."boballid"..creditvi,banid)
Redis:sadd(Tshak.."booob",data.sender_user_id)
ttshakse = '⇜ اختر شخصيتك في اللعبة'
local reply_markup = bot.replyMarkup{
type = 'inline',
...
Redis:set(Tshak.."bobna"..data.sender_user_id,news)
Redis:set(Tshak.."boob"..data.sender_user_id,balas)
Redis:set(Tshak.."boobb"..data.sender_user_id,creditex)
Redis:set(Tshak.."bbobb"..data.sender_user_id,exprs)
Redis:set(Tshak.."boballname"..creditex,news)
Redis:set(Tshak.."boballbalc"..creditex,balas)
Redis:set(Tshak.."boballcc"..creditex,creditex)
Redis:set(Tshak.."boballban"..creditex,exprs)
Redis:set(Tshak.."boballid"..creditex,banid)
Redis:sadd(Tshak.."booob",data.sender_user_id)
ttshakse = '⇜ اختر شخصيتك في اللعبة'
local reply_markup = bot.replyMarkup{
type = 'inline',
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
cccall = Redis:get(Tshak.."tdbelballance"..data.sender_user_id) or 0
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
if tonumber(ballance) < tonumber(cccall) then
return edit(ChatId,Msg_id, "⇜ فلوسك ماتكفي","md",true)
end
Redis:setex(Tshak.."iioood" .. data.sender_user_id,920, true)
local list = {"1", "2", "3"}
local rand = list[math.random(#list)]
if rand == "1" then -- 1 con
cccallcc = tonumber(ballance) + tonumber(cccall)
Redis:set(Tshak.."boob"..data.sender_user_id,cccallcc)
Redis:del(Tshak.."tdbelballance"..data.sender_user_id)
...
cccallcc = tonumber(ballance) - tonumber(cccall)
Redis:set(Tshak.."boob"..data.sender_user_id,cccallcc)
cccall = Redis:get(Tshak.."tdbelballance"..data.sender_user_id)
Redis:del(Tshak.."tdbelballance"..data.sender_user_id)
local convert_mony = string.format("%.0f",cccall)
local convert_monyy = string.format("%.0f",cccallcc)
msalm = "⌯ خسرت بالسحب ☹️\n\n⇜ المبلغ : "..convert_mony.."\nرصيدك الان : `"..convert_monyy.."`\n✧"
...
Redis:set(Tshak.."boob"..data.sender_user_id,cccallcc)
namefram = Redis:get(Tshak.."namefram"..data.sender_user_id)
Redis:sadd(Tshak.."farmarname", namefram)
Redis:set(Tshak.."sizefram"..data.sender_user_id,50000)
Redis:sadd(Tshak.."ownerfram",data.sender_user_id)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
...
namefram = Redis:get(Tshak.."namefram"..data.sender_user_id)
Redis:sadd(Tshak.."farmarname", namefram)
Redis:set(Tshak.."sizefram"..data.sender_user_id,100000)
Redis:sadd(Tshak.."ownerfram",data.sender_user_id)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 8×8\n⇜ السعر : 100000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(Tshak.."namefram"..data.sender_user_id)
Redis:sadd(Tshak.."farmarname", namefram)
Redis:set(Tshak.."sizefram"..data.sender_user_id,200000)
Redis:sadd(Tshak.."ownerfram",data.sender_user_id)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 12×12\n⇜ السعر : 1000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(Tshak.."namefram"..data.sender_user_id)
Redis:sadd(Tshak.."farmarname", namefram)
Redis:set(Tshak.."sizefram"..data.sender_user_id,300000)
Redis:sadd(Tshak.."ownerfram",data.sender_user_id)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 16×16\n⇜ السعر : 5000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
namefram = Redis:get(Tshak.."namefram"..data.sender_user_id)
Redis:sadd(Tshak.."farmarname", namefram)
Redis:set(Tshak.."sizefram"..data.sender_user_id,400000)
Redis:sadd(Tshak.."ownerfram",data.sender_user_id)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم بناء مزرعتك 🏕\n\n⇜ اسم المزرعة : '..namefram..'\n⇜ قياس المزرعة : 32×32\n⇜ السعر : 10000000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n✧'
...
if Redis:get(Tshak.."mrkzplayer".."1"..data.sender_user_id) then
return edit(ChatId,Msg_id, "⇜ لديك لاعب مركز هجوم\n⇜ ابحث عن لاعب اخر\n✧","md",true)
end
cccallcc = tonumber(ballance) - 39000
Redis:set(Tshak.."boob"..data.sender_user_id,cccallcc)
nameplayer = "همس سواريز"
energyplayer = "83"
mrkzplayer = "مهاجم"
cityplayer = "🇺🇦 اوكرانيا"
Redis:set(Tshak.."nameplayer".."1"..data.sender_user_id,nameplayer)
Redis:set(Tshak.."energyplayer".."1"..data.sender_user_id,energyplayer)
Redis:set(Tshak.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."1"..data.sender_user_id,39000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : همس سواريز\n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 83\n⇜ الجنسية : اوكرانيا 🇺🇦\n⇜ السعر : 39000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
end
end
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
edit(ChatId,Msg_id,"⇜ تم الغاء شراء اللاعب همس سواريز ", 'md', true)
end
end
...
if Redis:get(Tshak.."mrkzplayer".."4"..data.sender_user_id) then
...
mrkzplayer = "مدافع"
cityplayer = "البرازيل 🇧🇷"
Redis:set(Tshak.."nameplayer".."4"..data.sender_user_id,nameplayer)
Redis:set(Tshak.."energyplayer".."4"..data.sender_user_id,energyplayer)
Redis:set(Tshak.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."4"..data.sender_user_id,50000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
if Redis:get(Tshak.."mrkzplayer".."3"..data.sender_user_id) then
...
Redis:set(Tshak.."nameplayer".."3"..data.sender_user_id,nameplayer)
Redis:set(Tshak.."energyplayer".."3"..data.sender_user_id,energyplayer)
Redis:set(Tshak.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."3"..data.sender_user_id,70000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."4"..data.sender_user_id,40000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."3"..data.sender_user_id,20000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : خوان ماتا\n⇜ مركزه : وسط\n⇜ طاقة اللاعب : 81\n⇜ الجنسية : إسبانيا 🇪🇸 \n⇜ السعر : 20000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."4"..data.sender_user_id,15000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."1"..data.sender_user_id,100000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."4"..data.sender_user_id,20000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."4"..data.sender_user_id,30000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
if Redis:get(Tshak.."mrkzplayer".."5"..data.sender_user_id) then
...
mrkzplayer = "حارس"
cityplayer = "ألمانيا 🇩🇪 "
Redis:set(Tshak.."nameplayer".."5"..data.sender_user_id,nameplayer)
Redis:set(Tshak.."energyplayer".."5"..data.sender_user_id,energyplayer)
Redis:set(Tshak.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."5"..data.sender_user_id,110000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : تير شتيجن\n⇜ مركزه : حارس\n⇜ طاقة اللاعب : 91\n⇜ الجنسية : ألمانيا 🇩🇪 \n⇜ السعر : 110000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
if Redis:get(Tshak.."mrkzplayer".."2"..data.sender_user_id) then
...
mrkzplayer = "جناح"
cityplayer = "فرنسا 🇫🇷 "
Redis:set(Tshak.."nameplayer".."2"..data.sender_user_id,nameplayer)
Redis:set(Tshak.."energyplayer".."2"..data.sender_user_id,energyplayer)
Redis:set(Tshak.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."2"..data.sender_user_id,45000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."2"..data.sender_user_id,78000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : رودريغو\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : البرازيل 🇧🇷\n⇜ السعر : 78000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."4"..data.sender_user_id,65000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : ميليتاو\n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : البرازيل 🇧🇷\n⇜ السعر : 65000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."4"..data.sender_user_id,73000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : الابا\n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : النمسا 🇦🇹 \n⇜ السعر : 73000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."2"..data.sender_user_id,180000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : فينيسيوس \n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 94\n⇜ الجنسية : البرازيل 🇧🇷 \n⇜ السعر : 180000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."2"..data.sender_user_id,55000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دي ماريا \n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 85\n⇜ الجنسية : الأرجنتين 🇦🇷 \n⇜ السعر : 55000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."4"..data.sender_user_id,38000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دانييلي \n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 84\n⇜ الجنسية : إيطاليا 🇮🇹 \n⇜ السعر : 38000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."1"..data.sender_user_id,55000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."5"..data.sender_user_id,99000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : دوناروما \n⇜ مركزه : حارس\n⇜ طاقة اللاعب : 89\n⇜ الجنسية : إيطاليا 🇮🇹 \n⇜ السعر : 99000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."4"..data.sender_user_id,55000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."2"..data.sender_user_id,59000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."4"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."4"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."4"..data.sender_user_id,170000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : ايدن ازارد \n⇜ مركزه : مدافع\n⇜ طاقة اللاعب : 93\n⇜ الجنسية : اسبانيا 🇪🇸 \n⇜ السعر : 170000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."1"..data.sender_user_id,60000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : فرمينو \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 86\n⇜ الجنسية : البرازيل 🇧🇷 \n⇜ السعر : 60000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."1"..data.sender_user_id,19000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : جاك كلارك \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 81\n⇜ الجنسية : إنجلترا 🏴󠁧󠁢󠁥󠁮󠁧󠁿 \n⇜ السعر : 19000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."1"..data.sender_user_id,53000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."1"..data.sender_user_id,41000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : توريس \n⇜ مركزه : مهاجم\n⇜ طاقة اللاعب : 84\n⇜ الجنسية : اسبانيا 🇪🇸 \n⇜ السعر : 41000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."3"..data.sender_user_id,41000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."3"..data.sender_user_id,74000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."3"..data.sender_user_id,78000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : بول بوجبا \n⇜ مركزه : وسط\n⇜ طاقة اللاعب : 87\n⇜ الجنسية : فرنسا 🇫🇷 \n⇜ السعر : 78000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."mrkzplayer".."3"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."3"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."3"..data.sender_user_id,90000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."5"..data.sender_user_id,80000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."5"..data.sender_user_id,70000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."5"..data.sender_user_id,52000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."5"..data.sender_user_id,20000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."5"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."5"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."5"..data.sender_user_id,40000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."1"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."1"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."1"..data.sender_user_id,20000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."2"..data.sender_user_id,100000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : محمد صلاح\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 91\n⇜ الجنسية : مصر 🇪🇬 \n⇜ السعر : 100000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."2"..data.sender_user_id,90000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم شراء لاعب 🏃‍♂️️\n\n⇜ اسم الاعب : نيمار\n⇜ مركزه : جناح\n⇜ طاقة اللاعب : 90\n⇜ الجنسية : السنغال 🇸🇳 \n⇜ السعر : 90000 درهم 💵\n⇜ رصيدك الان : '..convert_mony..' درهم 💵\n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."mrkzplayer".."2"..data.sender_user_id,mrkzplayer)
Redis:set(Tshak.."cityplayer".."2"..data.sender_user_id,cityplayer)
Redis:set(Tshak.."priceplayer".."2"..data.sender_user_id,80000)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."boob"..data.sender_user_id,cccallcc)
lkbnade = Redis:get(Tshak.."lkbnade"..data.sender_user_id)
Redis:sadd(Tshak.."lkbnadesadd", lkbnade)
namenade = "ريال مدريد"
Redis:set(Tshak.."namenade"..data.sender_user_id,namenade)
Redis:set(Tshak.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Tshak.."ownernade",data.sender_user_id)
Redis:set(Tshak.."energynade"..data.sender_user_id,50)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Tshak.."ownernade",data.sender_user_id)
Redis:set(Tshak.."energynade"..data.sender_user_id,45)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : برشلونة\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 150000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Tshak.."ownernade",data.sender_user_id)
Redis:set(Tshak.."energynade"..data.sender_user_id,40)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : تشيلسي\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 90000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Tshak.."ownernade",data.sender_user_id)
Redis:set(Tshak.."energynade"..data.sender_user_id,35)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Tshak.."ownernade",data.sender_user_id)
Redis:set(Tshak.."energynade"..data.sender_user_id,30)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : ليفربول\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 120000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Tshak.."ownernade",data.sender_user_id)
Redis:set(Tshak.."energynade"..data.sender_user_id,25)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Tshak.."ownernade",data.sender_user_id)
Redis:set(Tshak.."energynade"..data.sender_user_id,20)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
...
Redis:set(Tshak.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Tshak.."ownernade",data.sender_user_id)
Redis:set(Tshak.."energynade"..data.sender_user_id,15)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : يوفنتوس\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 40000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
Redis:set(Tshak.."nokatnade"..data.sender_user_id,0)
Redis:sadd(Tshak.."ownernade",data.sender_user_id)
Redis:set(Tshak.."energynade"..data.sender_user_id,10)
ballance = Redis:get(Tshak.."boob"..data.sender_user_id) or 0
local convert_mony = string.format("%.0f",ballance)
ttshakse = '⌯ تم انشاء النادي ⚽️\n\n⇜ اسم النادي : ارسنال\n⇜ لقب النادي : '..lkbnade..'\n⇜ السعر : 20000 درهم 💵\n⇜ رصيدك الان : `'..convert_mony..'` درهم 💵\n\n⇜ اكتب ( `ناديي` ) لمعلومات اكثر \n✧'
edit(ChatId,Msg_id,ttshakse, 'md', true)
...
if Redis:get(Tshak.."hazrlock"..ChatId) == UserId then
if Redis:sismember(Tshak.."listhzerid"..ChatId, IdUser) then
return bot.answerCallbackQuery(data.id, "⇜ لقد انضممت الى اللعبة مسبقاً ", true)
end
if tonumber(Redis:get(Tshak.."hazrmalek"..ChatId)) == IdUser then
return bot.answerCallbackQuery(data.id, "⇜ انتا مالك اللعبة حاليا", true)
end
Redis:sadd(Tshak.."listhzerid"..ChatId, IdUser)
...
if Redis:get(Tshak.."soundidche"..ChatId..IdUser) == UserId[1] then
...
sleep(1)
os.remove(""..title..".mp3")
Redis:del(Tshak.."soundidche"..ChatId..IdUser)
else
Redis:del(Tshak.."soundidche"..ChatId..IdUser)
...
if Redis:get(Tshak.."youtidche"..ChatId..IdUser) == UserId[1] then
...
sleep(1)
os.remove(""..title..".mp3")
Redis:del(Tshak.."youtidche"..ChatId..IdUser)
else
Redis:del(Tshak.."youtidche"..ChatId..IdUser)
return edit(ChatId,Msg_id,'\n⇜ لا استطيع تحميل اكثر من 25 ميغا',"md",true)
end
...
local kk_id = Redis:get(Tshak.."kk_Akab"..ChatId)
if Redis:sismember(Tshak..'members_Ahkamm'..ChatId,IdUser) then
Redis:sadd(Tshak.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
local kk_id = Redis:get(Tshak.."kk_Akab"..ChatId)
if Redis:sismember(Tshak..'members_Ahkamm'..ChatId,IdUser) then
Redis:srem(Tshak.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{{text = '𝙷𝙼𝚂𓃠', url = 't.me/botatiiii'},},}}
...
local ff_id = Redis:get(Tshak.."ff_Ahkam"..ChatId)
local kk_id = Redis:get(Tshak.."kk_Ahkam"..ChatId)
...
local ff_id = Redis:get(Tshak.."ff_Ahkkam"..ChatId)
local kk_id = Redis:get(Tshak.."kk_Ahkkam"..ChatId)
if tonumber(IdUser) == tonumber(ff_id) then
Redis:sadd(Tshak.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
...
local kk_id = Redis:get(Tshak.."kk_koorsi"..ChatId)
if Redis:sismember(Tshak..'List_Koorsi'..ChatId,IdUser) then
Redis:sadd(Tshak.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
local ff_id = Redis:get(Tshak.."ff_saraha"..ChatId)
local kk_id = Redis:get(Tshak.."kk_saraha"..ChatId)
if tonumber(IdUser) == tonumber(ff_id) then
Redis:sadd(Tshak.."SilentGroup:Group"..ChatId,kk_id) 
local reply_markup = bot.replyMarkup{
type = 'inline',
...
if not Redis:sismember(Tshak..'List_Aktooh'..ChatId,IdUser) then 
Redis:sadd(Tshak..'List_Aktooh'..ChatId,IdUser)
Redis:setex(Tshak.."Witting_StartGameAk"..ChatId,1400,true)
local list = Redis:smembers(Tshak..'List_Aktooh'..ChatId) 
if #list == 2 then
for k,v in pairs(list) do
if k == 1 then
...
if k == #list then
local Ak_Tm = Redis:get(Tshak.."Ak_Tmooh"..ChatId)
local ban = bot.getUser(Ak_Tm)
local AkName = '['..ban.first_name..'](tg://user?id='..ban.id..')' or 'لا يوجد اسم'
local message = '*✦┊عـدد المصـوتين ⇜*'..#list..' \n*✦┊اسمـاء المصـوتين ⇩*\n'..name1..'\n'..name2..'\n'..name3..'\n\n*✦┊المستخـدم* '..AkName..'\n*✦┊تم كتمـه .. بنجـاح ✓*'
Redis:sadd(Tshak.."SilentGroup:Group"..ChatId,Ak_Tm) 
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
---------------------- Dev ZilZal ----------------------
if Text == '/Unaktmooh' and Redis:get(Tshak.."Witting_StartGameAk"..ChatId) then
local raeaktooh = Redis:get(Tshak.."raeaktooh"..ChatId)
...
Redis:srem(Tshak.."SilentGroup:Group"..ChatId,Ak_Tm)
Redis:srem(Tshak..'List_Aktooh'..ChatId,UserName) 
Redis:del(Tshak..'raeaktooh'..ChatId) 
Redis:del(Tshak..'List_Aktooh'..ChatId) 
Redis:del(Tshak.."Witting_StartGameAk"..ChatId)
Redis:del(Tshak.."Start_Aktmooh"..ChatId)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(Tshak..'List_Ahkkam'..ChatId,IdUser) then 
Redis:sadd(Tshak..'List_Ahkkam'..ChatId,IdUser)
Redis:setex(Tshak.."Witting_StartGameeh"..ChatId,1400,true)
local list = Redis:smembers(Tshak..'List_Ahkkam'..ChatId) 
if #list == 2 then
local UserInfo = bot.getUser(IdUser)
...
---------------------- Dev ZilZal ----------------------
if Text == '/startahkam' and Redis:get(Tshak.."Witting_StartGameeh"..ChatId) then
local rarahkam = Redis:get(Tshak.."raeahkkam"..ChatId)
...
Redis:set(Tshak.."kk_Ahkkam"..ChatId,UserId_Info.id)
Redis:srem(Tshak..'List_Ahkkam'..ChatId,UserName) 
local liiist = Redis:smembers(Tshak..'List_Ahkkam'..ChatId) 
...
Redis:set(Tshak.."ff_Ahkkam"..ChatId,UserId2_Info.id)
local GetLike = Redis:incrby(Tshak.."Num:Add:Ahkam"..ChatId..UserId2_Info.id, 5) 
Redis:hset(Tshak..':GroupUserCountAhkam:'..ChatId,UserId2_Info.id,GetLike)
...
NameLUser = NameLUser:gsub("[[]","")
Redis:hset(Tshak..':GroupAhkamNameUser:'..ChatId,UserrInfo.id,NameLUser)
Redis:del(Tshak..'raeahkkam'..ChatId) 
Redis:del(Tshak..'List_Ahkkam'..ChatId) 
Redis:del(Tshak.."Witting_StartGameeh"..ChatId)
Redis:del(Tshak.."Start_Ahkkam"..ChatId)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
---------------------- Dev ZilZal ----------------------
if Text == '/Koorsy' then
if not Redis:sismember(Tshak..'List_Koorsi'..ChatId,IdUser) then 
Redis:sadd(Tshak..'List_Koorsi'..ChatId,IdUser)
Redis:setex(Tshak.."Witting_StartGameek"..ChatId,1400,true)
local list = Redis:smembers(Tshak..'List_Koorsi'..ChatId) 
if #list == 2 then
local UserInfo = bot.getUser(IdUser)
local Teext = '- ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..IdUser..')'
...
---------------------- Dev ZilZal ----------------------
if Text == '/startkoorsi' and Redis:get(Tshak.."Witting_StartGameek"..ChatId) then
local rarahkam = Redis:get(Tshak.."raekoorsi"..ChatId)
if tonumber(IdUser) == tonumber(rarahkam) then
local list = Redis:smembers(Tshak..'List_Koorsi'..ChatId) 
local UserName = list[math.random(#list)]
local UserId_Info = bot.getUser(UserName)
...
Redis:set(Tshak.."koorsi:"..testkoorsi.."chat_id", ChatId)
Redis:set(Tshak.."koorsi:"..testkoorsi.."to", UserId_Info.id)
Redis:set(Tshak.."koorsi:"..testkoorsi.."msg_id",Msg_id)
if UserId_Info.username and UserId_Info.username ~= "" then
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
else
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
end
Redis:set(Tshak.."kk_koorsi"..ChatId,UserId_Info.id)
Redis:srem(Tshak..'List_Koorsi'..ChatId,UserName) 
Redis:del(Tshak..'raekoorsi'..ChatId) 
Redis:del(Tshak..'List_Koorsi'..ChatId) 
Redis:del(Tshak.."Witting_StartGameek"..ChatId)
Redis:del(Tshak.."Start_Koorsi"..ChatId)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(Tshak..'List_Saraha'..ChatId,IdUser) then 
Redis:sadd(Tshak..'List_Saraha'..ChatId,IdUser)
Redis:setex(Tshak.."Witting_StartGameS"..ChatId,1400,true)
local list = Redis:smembers(Tshak..'List_Saraha'..ChatId) 
if #list == 2 then
local UserInfo = bot.getUser(IdUser)
local Teext = '- ['..FlterBio(UserInfo.first_name)..'](tg://user?id='..IdUser..')'
local zzllzz = '*✦┊عـدد اللاعبيـن ⇜*'..#list..' \n*✦┊لقـد انضـم للعبـة كرسـي ⇩*\n'..Teext
...
---------------------- صراحه ----------------------
if Text == '/startsaraha' and Redis:get(Tshak.."Witting_StartGameS"..ChatId) then
local rarahkam = Redis:get(Tshak.."raesaraha"..ChatId)
if tonumber(IdUser) == tonumber(rarahkam) then
local list = Redis:smembers(Tshak..'List_Saraha'..ChatId) 
local UserName = list[math.random(#list)]
local UserId_Info = bot.getUser(UserName)
local testsaraha = math.random(1,9999999999999)
Redis:set(Tshak.."saraha:"..testsaraha.."chat_id", ChatId)
Redis:set(Tshak.."saraha:"..testsaraha.."to", UserId_Info.id)
Redis:set(Tshak.."saraha:"..testsaraha.."msg_id",Msg_id)
if UserId_Info.username and UserId_Info.username ~= "" then
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
else
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
end
Redis:set(Tshak.."kk_saraha"..ChatId,UserId_Info.id)
Redis:srem(Tshak..'List_Saraha'..ChatId,UserName) 
local liiiist = Redis:smembers(Tshak..'List_Saraha'..ChatId) 
local User2Name = liiiist[math.random(#liiiist)]
local UserId2_Info = bot.getUser(User2Name)
Redis:incrby(Tshak..'Num:Add:Games'..ChatId..UserId2_Info.id,5)
Redis:set(Tshak.."ff_saraha"..ChatId,UserId2_Info.id)
Redis:del(Tshak..'raesaraha'..ChatId) 
Redis:del(Tshak..'List_Saraha'..ChatId) 
Redis:del(Tshak.."Witting_StartGameS"..ChatId)
Redis:del(Tshak.."Start_Saraha"..ChatId)
local liiist = Redis:sismember(Tshak..'List_Saraha'..ChatId,IdUser)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:sismember(Tshak..'List_Ahkamm'..ChatId,IdUser) then
return bot.answerCallbackQuery(data.id, "✦┊انت منضـم مسبقـاً .. الـى اللعبـه", true)
end
bot.answerCallbackQuery(data.id, "✦ تم ضفتك للعبـة ⛓ ✓", true)
Redis:sadd(Tshak..'List_Ahkamm'..ChatId,IdUser)
Redis:sadd(Tshak..'members_Ahkamm'..ChatId,IdUser)
Redis:setex(Tshak.."Witting_StartGamehh"..ChatId,1400,true)
end
if Text and Text:match('/Ahkam(.*)') then
local UserId = Text:match('/Ahkam(.*)')
if Redis:sismember(Tshak..'List_Ahkam'..ChatId,IdUser) then
return bot.answerCallbackQuery(data.id, "✦┊انت منضـم مسبقـاً .. الـى اللعبـه", true)
end
bot.answerCallbackQuery(data.id, "✦ تم ضفتك للعبـة 👩🏻‍⚖⚖ ✓", true)
Redis:sadd(Tshak..'List_Ahkam'..ChatId,IdUser)
Redis:setex(Tshak.."Witting_StartGameh"..ChatId,1400,true)
end
if Text and Text:match('/Korsy(.*)') then
local UserId = Text:match('/Korsy(.*)')
if Redis:sismember(Tshak..'List_Korsi'..ChatId,IdUser) then
return bot.answerCallbackQuery(data.id, "✦┊انت منضـم مسبقـاً .. الـى اللعبـه", true)
end
bot.answerCallbackQuery(data.id, "✦ تم ضفتك للعبـة ⛓ ✓", true)
Redis:sadd(Tshak..'List_Korsi'..ChatId,IdUser)
Redis:setex(Tshak.."Witting_StartGamek"..ChatId,1400,true)
end
if Text and Text:match('/Sarahy(.*)') then
local UserId = Text:match('/Sarahy(.*)')
if Redis:sismember(Tshak..'List_Saraha'..ChatId,IdUser) then
return bot.answerCallbackQuery(data.id, "✦┊انت منضـم مسبقـاً .. الـى اللعبـه", true)
end
bot.answerCallbackQuery(data.id, "✦ تم ضفتك للعبـة ⛓ ✓", true)
Redis:sadd(Tshak..'List_Saraha'..ChatId,IdUser)
...
if Text and Text:match('(%d+)/startttahkam') and Redis:get(Tshak.."Witting_StartGameh"..ChatId) then
local UserId = Text:match('(%d+)/startttahkam')
local rarahkam = Redis:get(Tshak.."raeahkam"..ChatId)
if tonumber(IdUser) ~= tonumber(rarahkam) then
return bot.answerCallbackQuery(data.id, "✦┊الامـر للي بـدأ اللعبـه ...", true)
else
local list = Redis:smembers(Tshak..'List_Ahkam'..ChatId) 
local UserName = list[math.random(#list)]
local UserId_Info = bot.getUser(UserName)
if UserId_Info.username and UserId_Info.username ~= "" then
ls = '['..UserId_Info.first_name..'](tg://user?id='..UserName..')'
...
Redis:set(Tshak.."kk_Ahkam"..ChatId,UserId_Info.id)
Redis:srem(Tshak..'List_Ahkam'..ChatId,UserId_Info.id) 
...
Redis:set(Tshak.."ff_Ahkam"..ChatId,UserId2_Info.id)
Redis:incrby(Tshak..'Num:Add:Ahkam'..ChatId..UserId2_Info.id,5)
Redis:del(Tshak..'raeahkam'..ChatId) 
Redis:del(Tshak..'List_Ahkam'..ChatId) 
Redis:del(Tshak.."Witting_StartGameh"..ChatId)
Redis:del(Tshak.."Start_Ahkam"..ChatId)
local Tshak = '*⚖┊تم إختيار الشخـص ⇜* '..ls..'\n*👩🏻‍⚖┊ليتـم الحكـم عليـه من قبـل ⇜* '..Hs..'\n\n*🎁┊وتم اضـافـة 5 نقـاط للحـاكـم*'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹𓌗 قنـاة البـوت 𓌗.',url='http://t.me/'..chsource..''}},
}
local msg_idd = Msg_id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token..'/editMessageText?chat_id='..data.id..'&text='..URL.escape(Tshak)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Spam"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Keyboard"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:vico"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Animation"..ChatId,"del")
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Document"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:text"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Video"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Photo"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:User:Name"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:hashtak"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:forward"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Audio"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Sticker"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Contact"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Join"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Unsupported"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:lockpin"..ChatId,(bot.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:tagservr"..ChatId,true)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Markdaun"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:edit"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:geam"..ChatId,"del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Tshak.."Tshak:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Link"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Spam"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:vico"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Animation"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Document"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Video"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Photo"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:User:Name"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:hashtak"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:forward"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Audio"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Sticker"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Contact"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:geam"..ChatId,"ked")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Tshak.."Tshak:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Link"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Spam"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:vico"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Animation"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Document"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Video"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Photo"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:forward"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Audio"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Contact"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:geam"..ChatId,"ktm")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Tshak.."Tshak:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Link"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Spam"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:vico"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Animation"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Document"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Video"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Photo"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:User:Name"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:hashtak"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:forward"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Audio"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Sticker"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Contact"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:geam"..ChatId,"kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Tshak.."Tshak:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Status:Link"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Status:Welcome"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Status:Id"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Status:IdPhoto"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Status:Reply"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Status:ReplySudo"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Status:SetId"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Status:BanId"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Status:Games"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Status:KickMe"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Status:Link"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Status:Welcome"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Status:Id"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Status:IdPhoto"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Status:Reply"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Status:ReplySudo"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Status:SetId"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Status:BanId"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Status:Games"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Status:KickMe"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Tshak.."Tshak:TheBasicsQ:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Tshak.."Tshak:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Tshak.."Tshak:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Tshak..'Tshak:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'ا','ايدي')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'م','رفع مميز')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'اد', 'رفع ادمن')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'مد','رفع مدير')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'منش', 'رفع منشئ')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'اس', 'رفع منشئ اساسي')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'مط','رفع M')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'تن','تنزيل الكل')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'را','الرابط')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'رر','الردود')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'،،','مسح المكتومين')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'رد','اضف رد')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'غ','غنيلي')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'رس','رسائلي')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'ثانوي','رفع مطور ثانوي')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'مس','مسح تعديلاتي')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'ن','نقاطي')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'س','اسالني')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'ل','لغز')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'مع','معاني')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'ح','حزوره')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'رف','رفع القيود')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'الغ','الغاء حظر')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'ث','تثبيت')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'ك','كشف')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'تت','تاك')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'تك','تاك للكل')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'تغ','تغيير الايدي')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'تنز','تنزيل جميع الرتب')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'قق','قفل الاشعارات')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'فف','فتح الاشعارات')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'مر','مسح رد')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'امر','اضف امر')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'ش','شعر')
Redis:set(Tshak.."Tshak:Get:Reides:Commands:Group"..UserId[2]..":"..'غغ','اغنيه')
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:Link"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:farsia"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:tphlesh"..ChatId)  
Redis:del(Tshak.."Tshak:Status:IdPhoto"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:phshar"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:farsia"..ChatId,true)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:tphlesh"..ChatId,true)
Redis:set(Tshak.."Tshak:Status:IdPhoto"..ChatId,true)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Tshak.."Tshak:Lock:phshar"..ChatId,true)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:Spam"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:Keyboard"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:vico"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:Animation"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:Document"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:text"..ChatId,true) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:Video"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:Photo"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:User:Name"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:hashtak"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:Bot:kick"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:forward"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:Audio"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:Sticker"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:Contact"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:Join"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:AddMempar"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:Unsupported"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:lockpin"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:tagservr"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:Markdaun"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:edit"..ChatId) 
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Lock:geam"..ChatId)  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(Tshak.."Tshak:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:DevelopersQ:Groups") 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Developers:Groups") 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:ControlAll:Groups") 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:TheBasicsQ:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:MalekAsase:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:TheBasics:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Originators:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Managers:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Addictive:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:Distinguished:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:KtmAll:Groups") 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:BanAll:Groups") 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:BanGroup:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Tshak.."Tshak:SilentGroup:Group"..ChatId) 
local reply_markup = bot.replyMarkup{
type = "inline",
data = {
{
